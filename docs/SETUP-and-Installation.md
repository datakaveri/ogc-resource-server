...
A client SDK generated using [OpenAPI Generator](https://github.com/OpenAPITools/openapi-generator) is located at [client-sdk](./client-sdk). To generate a version of the SDK derived from the latest version of the OpenAPI spec at https://geoserver.dx.gsx.org.in, download the [OpenAPI Generator JAR file](https://github.com/OpenAPITools/openapi-generator?tab=readme-ov-file#13---download-jar) and run:
...
where `<URL>` can be:
- `https://geoserver.dx.gsx.org.in/api` for OGC APIs
- `https://geoserver.dx.gsx.org.in/stac/api` for STAC APIs
- `https://geoserver.dx.gsx.org.in/metering/api` for metering/auditing APIs
