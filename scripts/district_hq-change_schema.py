...
def main():
    try: 
        ...
        cursor.execute("select fid, hq, area, town, state, taluk, district, objectid, indiadpt_, perimeter, indiadpt_i from public.district_hq")
        ...
        for row in rows:
            ...
            sql_str = '''update public.district_hq set properties = %s::json where fid=%s'''
