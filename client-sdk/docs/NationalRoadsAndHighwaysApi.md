# openapi_client.NationalRoadsAndHighwaysApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](NationalRoadsAndHighwaysApi.md#get_features) | **GET** /collections/48141222-b801-4c7b-a94b-ec01583ddc92/items | Get features from National Roads and Highways
[**get_specific_collection**](NationalRoadsAndHighwaysApi.md#get_specific_collection) | **GET** /collections/48141222-b801-4c7b-a94b-ec01583ddc92 | Metadata about National Roads and Highways
[**get_specific_feature**](NationalRoadsAndHighwaysApi.md#get_specific_feature) | **GET** /collections/48141222-b801-4c7b-a94b-ec01583ddc92/items/{featureId} | Get single feature from National Roads and Highways


# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, nh_name=nh_name, descriptio=descriptio, level_=level_)

Get features from National Roads and Highways
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.NationalRoadsAndHighwaysApi(api_client)
    ...
    nh_name = 'nh_name_example' # str |  (optional)
    descriptio = 'descriptio_example' # str |  (optional)
    level_ = 56 # int |  (optional)

    try:
        # Get features from National Roads and Highways
        api_response = api_instance.get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, nh_name=nh_name, descriptio=descriptio, level_=level_)
        print("The response of NationalRoadsAndHighwaysApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NationalRoadsAndHighwaysApi->get_features: %s\n" % e)
```
...
Metadata about National Roads and Highways
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NationalRoadsAndHighwaysApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NationalRoadsAndHighwaysApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from National Roads and Highways
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NationalRoadsAndHighwaysApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NationalRoadsAndHighwaysApi->get_specific_feature: %s\n" % e)
```
