...
# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, descriptio=descriptio, use_descri=use_descri, name_of_ai=name_of_ai, name=name)
