# openapi_client.RailwayLinesApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RailwayLinesApi.md#get_features) | **GET** /collections/9b9db24b-120c-46a3-9a47-776a8c3f1680/items | Get features from Railway Lines Data
[**get_specific_collection**](RailwayLinesApi.md#get_specific_collection) | **GET** /collections/9b9db24b-120c-46a3-9a47-776a8c3f1680 | Metadata about Railway Lines Data
[**get_specific_feature**](RailwayLinesApi.md#get_specific_feature) | **GET** /collections/9b9db24b-120c-46a3-9a47-776a8c3f1680/items/{featureId} | Get single feature from Railway Lines Data


# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, railway_br=railway_br, status=status, descriptio=descriptio, electrifie=electrifie, zone_=zone_, gauge=gauge, division=division)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.RailwayLinesApi(api_client)
    ...
    railway_br = 'railway_br_example' # str |  (optional)
    status = 'status_example' # str |  (optional)
    descriptio = 'descriptio_example' # str |  (optional)
    electrifie = 'electrifie_example' # str |  (optional)
    zone_ = 'zone__example' # str |  (optional)
    gauge = 'gauge_example' # str |  (optional)
    division = 'division_example' # str |  (optional)

    try:
        # Get features from Railway Lines Data
        api_response = api_instance.get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, railway_br=railway_br, status=status, descriptio=descriptio, electrifie=electrifie, zone_=zone_, gauge=gauge, division=division)
        print("The response of RailwayLinesApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayLinesApi->get_features: %s\n" % e)
```
 ...
 **railway_br** | **str**|  | [optional] 
 **status** | **str**|  | [optional] 
 **descriptio** | **str**|  | [optional] 
 **electrifie** | **str**|  | [optional] 
 **zone_** | **str**|  | [optional] 
 **gauge** | **str**|  | [optional] 
...
Metadata about Railway Lines Data
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayLinesApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayLinesApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from Railway Lines Data
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayLinesApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayLinesApi->get_specific_feature: %s\n" % e)
```
