...
------------- | ------------- | -------------
[**get_features**](OtherSiteLocationsInIndiaApi.md#get_features) | **GET** /collections/6d9c471a-1613-4d13-b3e3-835dceccc2e3/items | Get features from Location information of other miscellaneous places of interest.
[**get_specific_collection**](OtherSiteLocationsInIndiaApi.md#get_specific_collection) | **GET** /collections/6d9c471a-1613-4d13-b3e3-835dceccc2e3 | Metadata about Location information of other miscellaneous places of interest.
[**get_specific_feature**](OtherSiteLocationsInIndiaApi.md#get_specific_feature) | **GET** /collections/6d9c471a-1613-4d13-b3e3-835dceccc2e3/items/{featureId} | Get single feature from Location information of other miscellaneous places of interest.


# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, place_name=place_name, remark=remark)

Get features from Location information of other miscellaneous places of interest.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    place_name = 'place_name_example' # str |  (optional)
    remark = 'remark_example' # str |  (optional)

    try:
        # Get features from Location information of other miscellaneous places of interest.
        api_response = api_instance.get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, place_name=place_name, remark=remark)
        print("The response of OtherSiteLocationsInIndiaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherSiteLocationsInIndiaApi->get_features: %s\n" % e)
```
...
Get single feature from Location information of other miscellaneous places of interest.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OtherSiteLocationsInIndiaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherSiteLocationsInIndiaApi->get_specific_feature: %s\n" % e)
```
