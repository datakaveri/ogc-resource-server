...
------------- | ------------- | -------------
[**get_features**](RailwayStationPointsApi.md#get_features) | **GET** /collections/706ee3ed-04d6-4131-a75c-a9fa2c82c5e2/items | Get features from Railway Station Points Data
[**get_specific_collection**](RailwayStationPointsApi.md#get_specific_collection) | **GET** /collections/706ee3ed-04d6-4131-a75c-a9fa2c82c5e2 | Metadata about Railway Station Points Data
[**get_specific_feature**](RailwayStationPointsApi.md#get_specific_feature) | **GET** /collections/706ee3ed-04d6-4131-a75c-a9fa2c82c5e2/items/{featureId} | Get single feature from Railway Station Points Data


# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, station_na=station_na, railway_na=railway_na)

Get features from Railway Station Points Data
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    station_na = 'station_na_example' # str |  (optional)
    railway_na = 'railway_na_example' # str |  (optional)

    try:
        # Get features from Railway Station Points Data
        api_response = api_instance.get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, station_na=station_na, railway_na=railway_na)
        print("The response of RailwayStationPointsApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayStationPointsApi->get_features: %s\n" % e)
```
 ...
 **station_na** | **str**|  | [optional] 
 **railway_na** | **str**|  | [optional] 
...
Get single feature from Railway Station Points Data
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayStationPointsApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayStationPointsApi->get_specific_feature: %s\n" % e)
```
