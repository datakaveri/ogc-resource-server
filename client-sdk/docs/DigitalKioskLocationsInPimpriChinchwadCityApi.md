# openapi_client.DigitalKioskLocationsInPimpriChinchwadCityApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DigitalKioskLocationsInPimpriChinchwadCityApi.md#get_features) | **GET** /collections/9d2dd5f2-99c3-4233-81f0-3ecc62318266/items | Get features from The physical coordinates of Digital Kiosk System locations in Pimpri-Chinchwad city.
[**get_specific_collection**](DigitalKioskLocationsInPimpriChinchwadCityApi.md#get_specific_collection) | **GET** /collections/9d2dd5f2-99c3-4233-81f0-3ecc62318266 | Metadata about The physical coordinates of Digital Kiosk System locations in Pimpri-Chinchwad city.
[**get_specific_feature**](DigitalKioskLocationsInPimpriChinchwadCityApi.md#get_specific_feature) | **GET** /collections/9d2dd5f2-99c3-4233-81f0-3ecc62318266/items/{featureId} | Get single feature from The physical coordinates of Digital Kiosk System locations in Pimpri-Chinchwad city.


# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, ward_name=ward_name, address=address, name=name, zone_name=zone_name)

Get features from The physical coordinates of Digital Kiosk System locations in Pimpri-Chinchwad city.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    zone_name = 'zone_name_example' # str |  (optional)

    try:
        # Get features from The physical coordinates of Digital Kiosk System locations in Pimpri-Chinchwad city.
        api_response = api_instance.get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, ward_name=ward_name, address=address, name=name, zone_name=zone_name)
        print("The response of DigitalKioskLocationsInPimpriChinchwadCityApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DigitalKioskLocationsInPimpriChinchwadCityApi->get_features: %s\n" % e)
```
...
Get single feature from The physical coordinates of Digital Kiosk System locations in Pimpri-Chinchwad city.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DigitalKioskLocationsInPimpriChinchwadCityApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DigitalKioskLocationsInPimpriChinchwadCityApi->get_specific_feature: %s\n" % e)
```
