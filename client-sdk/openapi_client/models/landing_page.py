...
class LandingPage(BaseModel):
    ...
    links: List[LandingPageLinksInner]
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["title", "links", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "links": [LandingPageLinksInner.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
