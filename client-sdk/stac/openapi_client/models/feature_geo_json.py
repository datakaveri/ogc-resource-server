...
class FeatureGeoJSON(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "geometry": GeometryGeoJSON.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None,
            "properties": obj.get("properties"),
            "id": FeatureGeoJSONId.from_dict(obj["id"]) if obj.get("id") is not None else None,
