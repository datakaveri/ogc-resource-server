...
class StacCollectionExtent(BaseModel):
    """
    ...
    temporal: StacCollectionExtentTemporal
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spatial": StacCollectionExtentSpatial.from_dict(obj["spatial"]) if obj.get("spatial") is not None else None,
            "temporal": StacCollectionExtentTemporal.from_dict(obj["temporal"]) if obj.get("temporal") is not None else None
        })
        return _obj
