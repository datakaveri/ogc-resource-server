...
class FlowControlPointsVaranasiUPApi:
    ...
    def get_features(
        ...
        perinlty1: Optional[StrictStr] = None,
        c_mtrl_1: Optional[StrictStr] = None,
        cat: Optional[StrictStr] = None,
        ftr_on1: Optional[StrictStr] = None,
    ...
    def _get_features_serialize(
        ...
        if perinlty1 is not None:
            
            _query_params.append(('PERINLTY1', perinlty1))
            
        if c_mtrl_1 is not None:
            
            _query_params.append(('C_MTRL_1', c_mtrl_1))
            
        if cat is not None:
            
            _query_params.append(('CAT', cat))
            
        if ftr_on1 is not None:
            
            _query_params.append(('FTR_ON1', ftr_on1))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/30d349fb-dc57-4e04-ac64-cf7134b9618a/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/30d349fb-dc57-4e04-ac64-cf7134b9618a',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/30d349fb-dc57-4e04-ac64-cf7134b9618a/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
