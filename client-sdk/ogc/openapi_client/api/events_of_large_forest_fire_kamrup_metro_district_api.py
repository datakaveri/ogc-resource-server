...
class EventsOfLargeForestFireKamrupMetroDistrictApi:
    ...
    def get_features(
        ...
        l_t_dic: Optional[StrictStr] = None,
        first_rang: Optional[StrictStr] = None,
        f_s_time: Optional[StrictStr] = None,
        fire_name: Optional[StrictStr] = None,
        first_stat: Optional[StrictStr] = None,
        first_divi: Optional[StrictStr] = None,
        first_circ: Optional[StrictStr] = None,
        first_dist: Optional[StrictStr] = None,
        ...
        _param = self._get_features_serialize(
            ...
            offset=offset,
            l_t_dic=l_t_dic,
            first_rang=first_rang,
            f_s_time=f_s_time,
            fire_name=fire_name,
            first_stat=first_stat,
            first_divi=first_divi,
            first_circ=first_circ,
    ...
    def _get_features_serialize(
        ...
        if l_t_dic is not None:
            
            _query_params.append(('L_T_Dic', l_t_dic))
            
        if first_rang is not None:
            
            _query_params.append(('FIRST_RANG', first_rang))
            
        if f_s_time is not None:
            
            _query_params.append(('F_S_Time', f_s_time))
            
        if fire_name is not None:
            
            _query_params.append(('Fire_Name', fire_name))
            
        if first_stat is not None:
            
            _query_params.append(('FIRST_STAT', first_stat))
            
        if first_divi is not None:
            
            _query_params.append(('FIRST_DIVI', first_divi))
            
        if first_circ is not None:
            
            _query_params.append(('FIRST_CIRC', first_circ))
            
        if first_dist is not None:
            
            _query_params.append(('FIRST_DIST', first_dist))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/a215170c-25d5-44d4-a801-ef7065ade1ae/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/a215170c-25d5-44d4-a801-ef7065ade1ae',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/a215170c-25d5-44d4-a801-ef7065ade1ae/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
