...
class BankBranchLocationsVizianagaramAPApi:
    ...
    def get_features(
        ...
        br_ifsc_cd: Optional[StrictStr] = None,
        br_name: Optional[StrictStr] = None,
        district_n: Optional[StrictStr] = None,
        ...
        br_lat: Optional[Union[StrictFloat, StrictInt]] = None,
    ...
    def _get_features_serialize(
        ...
        if br_ifsc_cd is not None:
            
            _query_params.append(('br_ifsc_cd', br_ifsc_cd))
            
        if br_name is not None:
            
            _query_params.append(('br_name', br_name))
            
        if district_n is not None:
            
            _query_params.append(('district_n', district_n))
            
        if state_lgd is not None:
            
            _query_params.append(('state_lgd', state_lgd))
            
        if bank_cd is not None:
            
            _query_params.append(('bank_cd', bank_cd))
            
        if br_city is not None:
            
            _query_params.append(('br_city', br_city))
            
        if br_bsr_cod is not None:
        ...
        if br_add is not None:
            
            _query_params.append(('br_add', br_add))
            
        if br_lat is not None:
            
            _query_params.append(('br_lat', br_lat))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/ec51bddb-8106-4f00-949f-897444401310/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/ec51bddb-8106-4f00-949f-897444401310',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/ec51bddb-8106-4f00-949f-897444401310/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
