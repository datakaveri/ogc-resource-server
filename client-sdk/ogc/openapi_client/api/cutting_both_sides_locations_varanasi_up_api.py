...
class CuttingBothSidesLocationsVaranasiUPApi:
    ...
    def get_features(
        ...
        svy_date: Optional[StrictStr] = None,
        addl_info: Optional[StrictStr] = None,
        cutg_place: Optional[StrictStr] = None,
        shape_le_1: Optional[Union[StrictFloat, StrictInt]] = None,
        height_m: Optional[Union[StrictFloat, StrictInt]] = None,
        shape_length: Optional[Union[StrictFloat, StrictInt]] = None,
        unique_id: Optional[StrictStr] = None,
        entity_on: Optional[StrictStr] = None,
        type1: Optional[StrictStr] = None,
        ...
        :type cutg_place: str
        :param shape_le_1:
        :type shape_le_1: float
        :param height_m:
        :type height_m: float
        :param shape_length:
        :type shape_length: float
        :param unique_id:
        :type unique_id: str
        :param entity_on:
        :type entity_on: str
    ...
    def _get_features_serialize(
        ...
        if shape_leng is not None:
            
            _query_params.append(('Shape_Leng', shape_leng))
            
        if svy_date is not None:
            
            _query_params.append(('SVY_DATE', svy_date))
            
        if addl_info is not None:
            
            _query_params.append(('ADDL_INFO', addl_info))
            
        if cutg_place is not None:
            
            _query_params.append(('CUTG_PLACE', cutg_place))
            
        if shape_le_1 is not None:
            
            _query_params.append(('Shape_Le_1', shape_le_1))
            
        if height_m is not None:
            
            _query_params.append(('HEIGHT_M', height_m))
            
        if shape_length is not None:
            
            _query_params.append(('Shape_Length', shape_length))
        ...
        if entity_on is not None:
            ...
            _query_params.append(('ENTITY_ON', entity_on))
            
        if type1 is not None:
            
            _query_params.append(('Type1', type1))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/7acb9a4f-ead4-4f33-8a3a-7e512d62f3b8/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/7acb9a4f-ead4-4f33-8a3a-7e512d62f3b8',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/7acb9a4f-ead4-4f33-8a3a-7e512d62f3b8/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
