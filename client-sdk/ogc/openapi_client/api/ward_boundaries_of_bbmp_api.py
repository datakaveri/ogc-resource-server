...
class WardBoundariesOfBBMPApi:
    ...
    def get_features(
        ...
        ass_const_: Optional[StrictStr] = None,
        pop_m: Optional[Union[StrictFloat, StrictInt]] = None,
        pop_f: Optional[Union[StrictFloat, StrictInt]] = None,
    ...
    def _get_features_serialize(
        ...
        if ass_const_ is not None:
            
            _query_params.append(('ASS_CONST_', ass_const_))
            
        if pop_m is not None:
            
            _query_params.append(('POP_M', pop_m))
            
        if pop_f is not None:
            
            _query_params.append(('POP_F', pop_f))
            
        if pop_total is not None:
            
            _query_params.append(('POP_TOTAL', pop_total))
            
        if ass_const1 is not None:
            
            _query_params.append(('ASS_CONST1', ass_const1))
        ...
        if ward_name is not None:
            ...
            _query_params.append(('WARD_NAME', ward_name))
            
        if pop_sc is not None:
            
            _query_params.append(('POP_SC', pop_sc))
            
        if pop_st is not None:
            
            _query_params.append(('POP_ST', pop_st))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/1e4b8698-a880-4a2e-a4a0-d692bc4a5988/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/1e4b8698-a880-4a2e-a4a0-d692bc4a5988',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/1e4b8698-a880-4a2e-a4a0-d692bc4a5988/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
