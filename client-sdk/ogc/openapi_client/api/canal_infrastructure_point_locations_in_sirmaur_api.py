...
class CanalInfrastructurePointLocationsInSirmaurApi:
    ...
    def get_features(
        ...
        af_prnlt: Optional[StrictStr] = None,
        category: Optional[StrictStr] = None,
        af_cat: Optional[StrictStr] = None,
        blt_acrs: Optional[StrictStr] = None,
    ...
    def _get_features_serialize(
        ...
        if af_prnlt is not None:
            
            _query_params.append(('AF_PRNLT', af_prnlt))
            
        if category is not None:
            
            _query_params.append(('CATEGORY', category))
            
        if af_cat is not None:
            
            _query_params.append(('AF_CAT', af_cat))
            
        if blt_acrs is not None:
            
            _query_params.append(('BLT_ACRS', blt_acrs))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/6ac2ba97-83f9-4ccd-ae24-73fadb431c84/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/6ac2ba97-83f9-4ccd-ae24-73fadb431c84',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/6ac2ba97-83f9-4ccd-ae24-73fadb431c84/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
