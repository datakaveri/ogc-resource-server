...
class NiruthisGranularWeatherInsightsForTelanganaApi:
    ...
    def get_features(
        ...
        avgwind: Optional[Union[StrictFloat, StrictInt]] = None,
    ...
    def _get_features_serialize(
        ...
        if avgwind is not None:
            ...
            _query_params.append(('avgwind', avgwind))
            
        if tmax is not None:
            
            _query_params.append(('tmax', tmax))
            
        if tmin is not None:
            
            _query_params.append(('tmin', tmin))
        ...
        if daylength is not None:
            ...
            _query_params.append(('daylength', daylength))
            
        if tdew is not None:
            
            _query_params.append(('tdew', tdew))
        ...
        if rhmax is not None:
            ...
            _query_params.append(('rhmax', rhmax))
            
        if prcp is not None:
            
            _query_params.append(('prcp', prcp))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/96cce67c-19af-4192-ad29-a5e61f2d81cb/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/96cce67c-19af-4192-ad29-a5e61f2d81cb',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/96cce67c-19af-4192-ad29-a5e61f2d81cb/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
