...
class NationalRoadsAndHighwaysApi:
    ...
    def get_features(
        ...
        nh_name: Optional[StrictStr] = None,
        descriptio: Optional[StrictStr] = None,
        level_: Optional[StrictInt] = None,
    ...
    def _get_features_serialize(
        ...
        if nh_name is not None:
            ...
            _query_params.append(('NH_NAME', nh_name))
            
        if descriptio is not None:
            
            _query_params.append(('DESCRIPTIO', descriptio))
            
        if level_ is not None:
            
            _query_params.append(('Level_', level_))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/48141222-b801-4c7b-a94b-ec01583ddc92/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/48141222-b801-4c7b-a94b-ec01583ddc92',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/48141222-b801-4c7b-a94b-ec01583ddc92/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
