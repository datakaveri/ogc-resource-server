...
class RevenuePointFeaturesVaranasiUPApi:
    ...
    def get_features(
        ...
        dist_twn_c: Optional[StrictStr] = None,
        district: Optional[StrictStr] = None,
        refname: Optional[StrictStr] = None,
        dist_sub_c: Optional[StrictStr] = None,
        block_name: Optional[StrictStr] = None,
        tahsil: Optional[StrictStr] = None,
        village_co: Optional[StrictStr] = None,
        devlopment: Optional[StrictStr] = None,
        pargana: Optional[StrictStr] = None,
        ...
        _param = self._get_features_serialize(
            ...
            offset=offset,
            village=village,
            dist_twn_c=dist_twn_c,
            district=district,
            refname=refname,
            dist_sub_c=dist_sub_c,
    ...
    def _get_features_serialize(
        ...
        if dist_twn_c is not None:
            
            _query_params.append(('DIST_TWN_C', dist_twn_c))
        ...
        if refname is not None:
            ...
            _query_params.append(('REFNAME', refname))
            
        if dist_sub_c is not None:
            
            _query_params.append(('DIST_SUB_C', dist_sub_c))
            
        if block_name is not None:
            
            _query_params.append(('BLOCK_NAME', block_name))
            
        if tahsil is not None:
            
            _query_params.append(('TAHSIL', tahsil))
            
        if village_co is not None:
            
            _query_params.append(('VILLAGE_CO', village_co))
            
        if devlopment is not None:
            
            _query_params.append(('DEVLOPMENT', devlopment))
            
        if pargana is not None:
            
            _query_params.append(('PARGANA', pargana))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/813e6e52-c334-407c-b316-8d667b549394/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/813e6e52-c334-407c-b316-8d667b549394',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/813e6e52-c334-407c-b316-8d667b549394/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
