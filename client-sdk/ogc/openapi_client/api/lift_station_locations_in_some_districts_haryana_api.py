...
class LiftStationLocationsInSomeDistrictsHaryanaApi:
    ...
    def get_features(
        ...
        lft_ph_lat: Optional[Union[StrictFloat, StrictInt]] = None,
        lft_opt: Optional[StrictStr] = None,
        lift_ht: Optional[StrictStr] = None,
        lft_ph_lon: Optional[Union[StrictFloat, StrictInt]] = None,
        lft_name_a: Optional[StrictStr] = None,
        lftcode: Optional[StrictStr] = None,
        lft_name: Optional[StrictStr] = None,
        bacode: Optional[StrictStr] = None,
        lft_disc: Optional[StrictStr] = None,
        ...
        :type stcode: str
        :param lft_ph_lat:
        :type lft_ph_lat: float
        :param lft_opt:
        :type lft_opt: str
        :param lift_ht:
        :type lift_ht: str
        :param lft_ph_lon:
        :type lft_ph_lon: float
        :param lft_name_a:
        :type lft_name_a: str
        :param lftcode:
        :type lftcode: str
        ...
        _param = self._get_features_serialize(
            ...
            offset=offset,
            stcode=stcode,
            lft_ph_lat=lft_ph_lat,
            lft_opt=lft_opt,
            lift_ht=lift_ht,
            lft_ph_lon=lft_ph_lon,
            lft_name_a=lft_name_a,
            lftcode=lftcode,
            lft_name=lft_name,
            bacode=bacode,
            lft_disc=lft_disc,
    ...
    def _get_features_serialize(
        ...
        if lft_ph_lat is not None:
            
            _query_params.append(('lft_ph_lat', lft_ph_lat))
            
        if lft_opt is not None:
            
            _query_params.append(('lft_opt', lft_opt))
            
        if lift_ht is not None:
            
            _query_params.append(('lift_ht', lift_ht))
            
        if lft_ph_lon is not None:
            
            _query_params.append(('lft_ph_lon', lft_ph_lon))
            
        if lft_name_a is not None:
            
            _query_params.append(('lft_name_a', lft_name_a))
            
        if lftcode is not None:
            
            _query_params.append(('lftcode', lftcode))
            
        if lft_name is not None:
            
            _query_params.append(('lft_name', lft_name))
            
        if bacode is not None:
            
            _query_params.append(('bacode', bacode))
            
        if lft_disc is not None:
            
            _query_params.append(('lft_disc', lft_disc))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/75377c4c-e0be-432a-8d29-4787d1a6d175/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/75377c4c-e0be-432a-8d29-4787d1a6d175',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/75377c4c-e0be-432a-8d29-4787d1a6d175/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
