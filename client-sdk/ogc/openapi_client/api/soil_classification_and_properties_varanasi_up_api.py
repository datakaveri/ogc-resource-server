...
class SoilClassificationAndPropertiesVaranasiUPApi:
    ...
    def get_features(
        ...
        order_: Optional[StrictStr] = None,
        series: Optional[StrictStr] = None,
        family_tex: Optional[StrictStr] = None,
        sb_order: Optional[StrictStr] = None,
        gr_group: Optional[StrictStr] = None,
        sb_group: Optional[StrictStr] = None,
        family_tem: Optional[StrictStr] = None,
        family_min: Optional[StrictStr] = None,
        ...
        _param = self._get_features_serialize(
            ...
            order_=order_,
            series=series,
            family_tex=family_tex,
            sb_order=sb_order,
            gr_group=gr_group,
            sb_group=sb_group,
            family_tem=family_tem,
    ...
    def _get_features_serialize(
        ...
        if order_ is not None:
            ...
            _query_params.append(('ORDER_', order_))
            
        if series is not None:
            
            _query_params.append(('SERIES', series))
            
        if family_tex is not None:
            
            _query_params.append(('FAMILY_TEX', family_tex))
            
        if sb_order is not None:
            
            _query_params.append(('SB_ORDER', sb_order))
            
        if gr_group is not None:
            
            _query_params.append(('GR_GROUP', gr_group))
            
        if sb_group is not None:
            
            _query_params.append(('SB_GROUP', sb_group))
            
        if family_tem is not None:
            
            _query_params.append(('FAMILY_TEM', family_tem))
            
        if family_min is not None:
            
            _query_params.append(('FAMILY_MIN', family_min))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/159c3e61-8a8d-4193-904b-327fc60ea1b7/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/159c3e61-8a8d-4193-904b-327fc60ea1b7',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/159c3e61-8a8d-4193-904b-327fc60ea1b7/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
