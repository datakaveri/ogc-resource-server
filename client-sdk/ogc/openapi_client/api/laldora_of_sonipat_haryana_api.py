...
class LaldoraOfSonipatHaryanaApi:
    ...
    def get_features(
        ...
        limit: Optional[Annotated[int, Field(le=5, strict=True, ge=1)]] = None,
        ...
        village_co: Optional[StrictStr] = None,
        tehsil_cod: Optional[StrictStr] = None,
        block_code: Optional[StrictStr] = None,
        village_na: Optional[StrictStr] = None,
        area_geode: Optional[Union[StrictFloat, StrictInt]] = None,
        lgd_code: Optional[StrictStr] = None,
        shape_area: Optional[Union[StrictFloat, StrictInt]] = None,
        district_c: Optional[StrictStr] = None,
        ...
        _param = self._get_features_serialize(
            ...
            village_co=village_co,
            tehsil_cod=tehsil_cod,
            block_code=block_code,
            village_na=village_na,
            area_geode=area_geode,
            lgd_code=lgd_code,
    ...
    def _get_features_serialize(
        ...
        if village_co is not None:
            
            _query_params.append(('Village_Co', village_co))
            
        if tehsil_cod is not None:
            
            _query_params.append(('Tehsil_Cod', tehsil_cod))
        ...
        if area_geode is not None:
            
            _query_params.append(('Area_geode', area_geode))
            
        if lgd_code is not None:
            
            _query_params.append(('LGD_Code', lgd_code))
            
        if shape_area is not None:
            
            _query_params.append(('ShapeArea', shape_area))
            
        if district_c is not None:
            
            _query_params.append(('District_C', district_c))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/e05984a3-41a0-4ecb-9498-0be5b83ed574/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/e05984a3-41a0-4ecb-9498-0be5b83ed574',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/e05984a3-41a0-4ecb-9498-0be5b83ed574/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
