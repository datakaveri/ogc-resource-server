...
class BarragesWeirsAnicutsVizianagaramAPApi:
    ...
    def get_features(
        ...
        bwa_gate_s: Optional[StrictStr] = None,
        bwa_spil_c: Optional[Union[StrictFloat, StrictInt]] = None,
        bwa_gate_n: Optional[StrictInt] = None,
        bwa_name: Optional[StrictStr] = None,
        ...
        _param = self._get_features_serialize(
            ...
            bwa_gate_s=bwa_gate_s,
            bwa_spil_c=bwa_spil_c,
            bwa_gate_n=bwa_gate_n,
            bwa_name=bwa_name,
    ...
    def _get_features_serialize(
        ...
        if bwa_long is not None:
            ...
            _query_params.append(('bwa_long', bwa_long))
            
        if dtcode is not None:
            
            _query_params.append(('dtcode', dtcode))
            
        if bwa_pond_l is not None:
            
            _query_params.append(('bwa_pond_l', bwa_pond_l))
            
        if bwa_gate_s is not None:
            
            _query_params.append(('bwa_gate_s', bwa_gate_s))
            
        if bwa_spil_c is not None:
            
            _query_params.append(('bwa_spil_c', bwa_spil_c))
            
        if bwa_gate_n is not None:
            
            _query_params.append(('bwa_gate_n', bwa_gate_n))
            
        if bwa_name is not None:
            
            _query_params.append(('bwa_name', bwa_name))
            
        if bwa_status is not None:
            
            _query_params.append(('bwa_status', bwa_status))
            
        if var_class is not None:
            
            _query_params.append(('class', var_class))
            
        if bwa_cn_gat is not None:
        ...
        if bwa_spil_t is not None:
            ...
            _query_params.append(('bwa_spil_t', bwa_spil_t))
            
        if strucode is not None:
            
            _query_params.append(('strucode', strucode))
            
        if bwa_size_h is not None:
        ...
        if bwa_cmp_yr is not None:
            ...
            _query_params.append(('bwa_cmp_yr', bwa_cmp_yr))
            
        if bwa_ses_zo is not None:
            
            _query_params.append(('bwa_ses_zo', bwa_ses_zo))
            
        if bwa_lat is not None:
        ...
        if bwa_disc_d is not None:
            ...
            _query_params.append(('bwa_disc_d', bwa_disc_d))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/f07505d2-aaf6-4850-8545-5c2c30ed9dc7/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/f07505d2-aaf6-4850-8545-5c2c30ed9dc7',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/f07505d2-aaf6-4850-8545-5c2c30ed9dc7/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
