...
class MajorTownsVaranasiUPApi:
    ...
    def get_features(
        ...
        lgd_state_code: Optional[StrictInt] = None,
        name_of_to: Optional[StrictStr] = None,
        lgd_sub_dist_code: Optional[StrictInt] = None,
        district: Optional[StrictStr] = None,
        state: Optional[StrictStr] = None,
        lgd_district_code: Optional[StrictInt] = None,
        soi_code: Optional[StrictStr] = None,
        ...
        :param lgd_state_code:
        :type lgd_state_code: int
        :param name_of_to:
        :type name_of_to: str
        :param lgd_sub_dist_code:
        :type lgd_sub_dist_code: int
        :param district:
        :type district: str
        :param state:
        :type state: str
        :param lgd_district_code:
        :type lgd_district_code: int
        :param soi_code:
        :type soi_code: str
        ...
        _param = self._get_features_serialize(
            ...
            name_of_to=name_of_to,
            lgd_sub_dist_code=lgd_sub_dist_code,
            district=district,
            state=state,
    ...
    def _get_features_serialize(
        ...
        if lgd_state_code is not None:
            
            _query_params.append(('lgd_state_code', lgd_state_code))
            
        if name_of_to is not None:
            
            _query_params.append(('name_of_to', name_of_to))
            
        if lgd_sub_dist_code is not None:
            
            _query_params.append(('lgd_sub_dist_code', lgd_sub_dist_code))
        ...
        if lgd_district_code is not None:
            
            _query_params.append(('lgd_district_code', lgd_district_code))
            
        if soi_code is not None:
            
            _query_params.append(('soi_code', soi_code))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/bf2f6d45-0780-4f1d-a4b8-481d97425bb9/items',
    ...
    def _get_specific_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/bf2f6d45-0780-4f1d-a4b8-481d97425bb9',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_specific_feature_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/collections/bf2f6d45-0780-4f1d-a4b8-481d97425bb9/items/{featureId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
