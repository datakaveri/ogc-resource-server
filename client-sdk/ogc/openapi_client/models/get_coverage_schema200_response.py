...
class GetCoverageSchema200Response(BaseModel):
    """
    GetCoverageSchema200Response
    """ # noqa: E501
    var_schema: Optional[Dict[str, Any]] = Field(default=None, description="The JSON schema of the coverage.", alias="schema")
