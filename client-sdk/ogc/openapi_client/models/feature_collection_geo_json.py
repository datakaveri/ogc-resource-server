...
class FeatureCollectionGeoJSON(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "features", "links", "numberMatched", "numberReturned"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "features": [FeatureGeoJSON.from_dict(_item) for _item in obj["features"]] if obj.get("features") is not None else None,
