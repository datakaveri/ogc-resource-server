...
class TileMatrixSetItemCrs(BaseModel):
    """
    TileMatrixSetItemCrs
    """ # noqa: E501
    uri: StrictStr = Field(description="Reference to one coordinate reference system (CRS)")
    wkt: Any
    reference_system: Dict[str, Any] = Field(description="A reference system data structure as defined in the MD_ReferenceSystem of the ISO 19115", alias="referenceSystem")
    __properties: ClassVar[List[str]] = ["uri", "wkt", "referenceSystem"]
