# openapi_client.IslandLocationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](IslandLocationsVaranasiUPApi.md#get_features) | **GET** /collections/acb0601c-d68f-4e06-a631-fe799695c468/items | Get features from Geographical extent of islands with attributes in Varanasi, UP
[**get_specific_collection**](IslandLocationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/acb0601c-d68f-4e06-a631-fe799695c468 | Metadata about Geographical extent of islands with attributes in Varanasi, UP
[**get_specific_feature**](IslandLocationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/acb0601c-d68f-4e06-a631-fe799695c468/items/{featureId} | Get single feature from Geographical extent of islands with attributes in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, cat=cat, name=name)

Get features from Geographical extent of islands with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Geographical extent of islands with attributes in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, cat=cat, name=name)
        print("The response of IslandLocationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IslandLocationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Geographical extent of islands with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IslandLocationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IslandLocationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
