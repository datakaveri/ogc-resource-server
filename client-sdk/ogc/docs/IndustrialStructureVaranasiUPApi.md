# openapi_client.IndustrialStructureVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](IndustrialStructureVaranasiUPApi.md#get_features) | **GET** /collections/8d1c62d7-80d0-4868-96f9-663d324c1e20/items | Get features from Point locations of industrial structures in Varanasi, UP
[**get_specific_collection**](IndustrialStructureVaranasiUPApi.md#get_specific_collection) | **GET** /collections/8d1c62d7-80d0-4868-96f9-663d324c1e20 | Metadata about Point locations of industrial structures in Varanasi, UP
[**get_specific_feature**](IndustrialStructureVaranasiUPApi.md#get_specific_feature) | **GET** /collections/8d1c62d7-80d0-4868-96f9-663d324c1e20/items/{featureId} | Get single feature from Point locations of industrial structures in Varanasi, UP
...
Get features from Point locations of industrial structures in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IndustrialStructureVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IndustrialStructureVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of industrial structures in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IndustrialStructureVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IndustrialStructureVaranasiUPApi->get_specific_feature: %s\n" % e)
```
