...
------------- | ------------- | -------------
[**get_features**](PowerSubstationsVaranasiUPApi.md#get_features) | **GET** /collections/1fc5ab08-f17b-469c-9294-ec1407ba879b/items | Get features from Point locations of power substations in Varanasi, UP
[**get_specific_collection**](PowerSubstationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/1fc5ab08-f17b-469c-9294-ec1407ba879b | Metadata about Point locations of power substations in Varanasi, UP
[**get_specific_feature**](PowerSubstationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/1fc5ab08-f17b-469c-9294-ec1407ba879b/items/{featureId} | Get single feature from Point locations of power substations in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)

Get features from Point locations of power substations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PowerSubstationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PowerSubstationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of power substations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PowerSubstationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PowerSubstationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
