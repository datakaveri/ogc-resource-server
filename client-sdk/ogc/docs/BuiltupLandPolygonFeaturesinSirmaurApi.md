# openapi_client.BuiltupLandPolygonFeaturesinSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](BuiltupLandPolygonFeaturesinSirmaurApi.md#get_features) | **GET** /collections/04c85a1d-585e-498d-ad70-468e5284fa27/items | Get features from Polygon features of coasrsely mapped builtup land extent
[**get_specific_collection**](BuiltupLandPolygonFeaturesinSirmaurApi.md#get_specific_collection) | **GET** /collections/04c85a1d-585e-498d-ad70-468e5284fa27 | Metadata about Polygon features of coasrsely mapped builtup land extent
[**get_specific_feature**](BuiltupLandPolygonFeaturesinSirmaurApi.md#get_specific_feature) | **GET** /collections/04c85a1d-585e-498d-ad70-468e5284fa27/items/{featureId} | Get single feature from Polygon features of coasrsely mapped builtup land extent
...
Get features from Polygon features of coasrsely mapped builtup land extent
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BuiltupLandPolygonFeaturesinSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BuiltupLandPolygonFeaturesinSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of coasrsely mapped builtup land extent
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BuiltupLandPolygonFeaturesinSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BuiltupLandPolygonFeaturesinSirmaurApi->get_specific_feature: %s\n" % e)
```
