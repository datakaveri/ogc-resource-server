# openapi_client.SeasonalCanalsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SeasonalCanalsVaranasiUPApi.md#get_features) | **GET** /collections/918c56f8-3cd1-41eb-a3aa-8f0b5590b617/items | Get features from Line features representing seasonal canals in in Varanasi, UP
[**get_specific_collection**](SeasonalCanalsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/918c56f8-3cd1-41eb-a3aa-8f0b5590b617 | Metadata about Line features representing seasonal canals in in Varanasi, UP
[**get_specific_feature**](SeasonalCanalsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/918c56f8-3cd1-41eb-a3aa-8f0b5590b617/items/{featureId} | Get single feature from Line features representing seasonal canals in in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type)

Get features from Line features representing seasonal canals in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Line features representing seasonal canals in in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type)
        print("The response of SeasonalCanalsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SeasonalCanalsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing seasonal canals in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SeasonalCanalsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SeasonalCanalsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
