# openapi_client.ReservoirsInAndAroundVizianagaramAPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ReservoirsInAndAroundVizianagaramAPApi.md#get_features) | **GET** /collections/274c38b0-d11c-420d-b179-edbb4fa294e8/items | Get features from Polygon features of reservoirs in and around Vizianagaram district, Andhra Pradesh
[**get_specific_collection**](ReservoirsInAndAroundVizianagaramAPApi.md#get_specific_collection) | **GET** /collections/274c38b0-d11c-420d-b179-edbb4fa294e8 | Metadata about Polygon features of reservoirs in and around Vizianagaram district, Andhra Pradesh
[**get_specific_feature**](ReservoirsInAndAroundVizianagaramAPApi.md#get_specific_feature) | **GET** /collections/274c38b0-d11c-420d-b179-edbb4fa294e8/items/{featureId} | Get single feature from Polygon features of reservoirs in and around Vizianagaram district, Andhra Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    wbname = 'wbname_example' # str |  (optional)
    ...
    try:
        ...
        print("Exception when calling ReservoirsInAndAroundVizianagaramAPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of reservoirs in and around Vizianagaram district, Andhra Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ReservoirsInAndAroundVizianagaramAPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ReservoirsInAndAroundVizianagaramAPApi->get_specific_feature: %s\n" % e)
```
