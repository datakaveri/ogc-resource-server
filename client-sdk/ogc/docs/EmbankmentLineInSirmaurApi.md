...
------------- | ------------- | -------------
[**get_features**](EmbankmentLineInSirmaurApi.md#get_features) | **GET** /collections/3140bc9f-9cd7-4620-87b5-4e8a28658043/items | Get features from Embankment line features in Sirmaur
[**get_specific_collection**](EmbankmentLineInSirmaurApi.md#get_specific_collection) | **GET** /collections/3140bc9f-9cd7-4620-87b5-4e8a28658043 | Metadata about Embankment line features in Sirmaur
[**get_specific_feature**](EmbankmentLineInSirmaurApi.md#get_specific_feature) | **GET** /collections/3140bc9f-9cd7-4620-87b5-4e8a28658043/items/{featureId} | Get single feature from Embankment line features in Sirmaur
...
Get features from Embankment line features in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EmbankmentLineInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentLineInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Embankment line features in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EmbankmentLineInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentLineInSirmaurApi->get_specific_feature: %s\n" % e)
```
