# openapi_client.ReligiousBuildingsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ReligiousBuildingsVaranasiUPApi.md#get_features) | **GET** /collections/84560bc1-e92e-47be-ad35-93fa9d8d543a/items | Get features from Point locations of religious buildings in Varanasi, UP
[**get_specific_collection**](ReligiousBuildingsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/84560bc1-e92e-47be-ad35-93fa9d8d543a | Metadata about Point locations of religious buildings in Varanasi, UP
[**get_specific_feature**](ReligiousBuildingsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/84560bc1-e92e-47be-ad35-93fa9d8d543a/items/{featureId} | Get single feature from Point locations of religious buildings in Varanasi, UP
...
Get features from Point locations of religious buildings in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ReligiousBuildingsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ReligiousBuildingsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of religious buildings in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ReligiousBuildingsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ReligiousBuildingsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
