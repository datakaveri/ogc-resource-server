...
------------- | ------------- | -------------
[**get_features**](ExtentOfSandyAreasInSirmaurApi.md#get_features) | **GET** /collections/52eee6f8-c220-4721-b2d0-f41bdfd3b399/items | Get features from Geographical extent of sandy areas as polygon features with attributes
[**get_specific_collection**](ExtentOfSandyAreasInSirmaurApi.md#get_specific_collection) | **GET** /collections/52eee6f8-c220-4721-b2d0-f41bdfd3b399 | Metadata about Geographical extent of sandy areas as polygon features with attributes
[**get_specific_feature**](ExtentOfSandyAreasInSirmaurApi.md#get_specific_feature) | **GET** /collections/52eee6f8-c220-4721-b2d0-f41bdfd3b399/items/{featureId} | Get single feature from Geographical extent of sandy areas as polygon features with attributes


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, category=category, asso_f=asso_f)

Get features from Geographical extent of sandy areas as polygon features with attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    asso_f = 'asso_f_example' # str |  (optional)

    try:
        # Get features from Geographical extent of sandy areas as polygon features with attributes
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, category=category, asso_f=asso_f)
        print("The response of ExtentOfSandyAreasInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExtentOfSandyAreasInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Geographical extent of sandy areas as polygon features with attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ExtentOfSandyAreasInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExtentOfSandyAreasInSirmaurApi->get_specific_feature: %s\n" % e)
```
