...
------------- | ------------- | -------------
[**get_features**](HospitalsVaranasiUPApi.md#get_features) | **GET** /collections/7a3bd150-da65-47f1-b9ff-830f5b90eeb1/items | Get features from Point locations of hospitals in Varanasi, UP
[**get_features_0**](HospitalsVaranasiUPApi.md#get_features_0) | **GET** /collections/883faa90-ad3d-4085-9a86-380463239751/items | Get features from Locations of hospitals in Varanasi, UP
[**get_specific_collection**](HospitalsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/7a3bd150-da65-47f1-b9ff-830f5b90eeb1 | Metadata about Point locations of hospitals in Varanasi, UP
[**get_specific_collection_0**](HospitalsVaranasiUPApi.md#get_specific_collection_0) | **GET** /collections/883faa90-ad3d-4085-9a86-380463239751 | Metadata about Locations of hospitals in Varanasi, UP
[**get_specific_feature**](HospitalsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/7a3bd150-da65-47f1-b9ff-830f5b90eeb1/items/{featureId} | Get single feature from Point locations of hospitals in Varanasi, UP
[**get_specific_feature_0**](HospitalsVaranasiUPApi.md#get_specific_feature_0) | **GET** /collections/883faa90-ad3d-4085-9a86-380463239751/items/{featureId} | Get single feature from Locations of hospitals in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, s_code=s_code)

Get features from Point locations of hospitals in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    s_code = 's_code_example' # str |  (optional)

    try:
        # Get features from Point locations of hospitals in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, s_code=s_code)
        print("The response of HospitalsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HospitalsVaranasiUPApi->get_features: %s\n" % e)
```
...
# **get_features_0**
> FeatureCollectionGeoJSON get_features_0(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, addl_info=addl_info, type_1=type_1, unique_id=unique_id)

Get features from Locations of hospitals in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    limit = 5000 # int |  (optional) (default to 5000)
    offset = 1 # int | OGC Resource server also offers way to paginate the result for queries.  If a query returns large number of records then user can use additional parameters in query parameters to limit numbers of records  to be returned.  Minimum = 0. Maximum = 1000. Default = 10. (optional) (default to 1)
    addl_info = 'addl_info_example' # str |  (optional)
    type_1 = 'type_1_example' # str |  (optional)
    unique_id = 'unique_id_example' # str |  (optional)

    try:
        # Get features from Locations of hospitals in Varanasi, UP
        api_response = api_instance.get_features_0(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, addl_info=addl_info, type_1=type_1, unique_id=unique_id)
        print("The response of HospitalsVaranasiUPApi->get_features_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HospitalsVaranasiUPApi->get_features_0: %s\n" % e)
```
...
Get single feature from Point locations of hospitals in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HospitalsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HospitalsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
...
Get single feature from Locations of hospitals in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HospitalsVaranasiUPApi->get_specific_feature_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HospitalsVaranasiUPApi->get_specific_feature_0: %s\n" % e)
```
