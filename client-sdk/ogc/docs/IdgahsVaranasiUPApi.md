# openapi_client.IdgahsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](IdgahsVaranasiUPApi.md#get_features) | **GET** /collections/7b0bb04e-2030-4c68-9b4a-bf503a86b32b/items | Get features from Locations of idgahs in Varanasi, UP
[**get_specific_collection**](IdgahsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/7b0bb04e-2030-4c68-9b4a-bf503a86b32b | Metadata about Locations of idgahs in Varanasi, UP
[**get_specific_feature**](IdgahsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/7b0bb04e-2030-4c68-9b4a-bf503a86b32b/items/{featureId} | Get single feature from Locations of idgahs in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, type=type, photograph=photograph, svy_date=svy_date, gmrotation=gmrotation, addl_info=addl_info, unique_id=unique_id, name=name)

Get features from Locations of idgahs in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Locations of idgahs in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, type=type, photograph=photograph, svy_date=svy_date, gmrotation=gmrotation, addl_info=addl_info, unique_id=unique_id, name=name)
        print("The response of IdgahsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IdgahsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of idgahs in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IdgahsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IdgahsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
