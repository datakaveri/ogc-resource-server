# openapi_client.RoadNetworksVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RoadNetworksVaranasiUPApi.md#get_features) | **GET** /collections/1800643c-c6cd-4722-9e57-1da4d9166c9f/items | Get features from Line features representing road networks in Varanasi, UP
[**get_specific_collection**](RoadNetworksVaranasiUPApi.md#get_specific_collection) | **GET** /collections/1800643c-c6cd-4722-9e57-1da4d9166c9f | Metadata about Line features representing road networks in Varanasi, UP
[**get_specific_feature**](RoadNetworksVaranasiUPApi.md#get_specific_feature) | **GET** /collections/1800643c-c6cd-4722-9e57-1da4d9166c9f/items/{featureId} | Get single feature from Line features representing road networks in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, road_type=road_type, addl_info=addl_info, surface=surface, road_name=road_name)

Get features from Line features representing road networks in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    road_type = 'road_type_example' # str |  (optional)
    addl_info = 'addl_info_example' # str |  (optional)
    surface = 'surface_example' # str |  (optional)
    road_name = 'road_name_example' # str |  (optional)

    try:
        # Get features from Line features representing road networks in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, road_type=road_type, addl_info=addl_info, surface=surface, road_name=road_name)
        print("The response of RoadNetworksVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadNetworksVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing road networks in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadNetworksVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadNetworksVaranasiUPApi->get_specific_feature: %s\n" % e)
```
