# openapi_client.IslandLocationsInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](IslandLocationsInSirmaurApi.md#get_features) | **GET** /collections/cc47a10a-4c10-443d-ad3b-7c8b982fc2dc/items | Get features from Geographical extent of island with attributes
[**get_specific_collection**](IslandLocationsInSirmaurApi.md#get_specific_collection) | **GET** /collections/cc47a10a-4c10-443d-ad3b-7c8b982fc2dc | Metadata about Geographical extent of island with attributes
[**get_specific_feature**](IslandLocationsInSirmaurApi.md#get_specific_feature) | **GET** /collections/cc47a10a-4c10-443d-ad3b-7c8b982fc2dc/items/{featureId} | Get single feature from Geographical extent of island with attributes
...
Get features from Geographical extent of island with attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.IslandLocationsInSirmaurApi(api_client)
    ...
    try:
        ...
        print("The response of IslandLocationsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IslandLocationsInSirmaurApi->get_features: %s\n" % e)
```
...
Metadata about Geographical extent of island with attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IslandLocationsInSirmaurApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IslandLocationsInSirmaurApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from Geographical extent of island with attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IslandLocationsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IslandLocationsInSirmaurApi->get_specific_feature: %s\n" % e)
```
