# openapi_client.FloodInundatedAreas2020KamrupMetroDistrictApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](FloodInundatedAreas2020KamrupMetroDistrictApi.md#get_features) | **GET** /collections/b7cdc784-a5ec-4b42-9d33-38a030d8c793/items | Get features from Boundaries of flood inundated area for Kamrup Metropolitan district, Assam in 2020
[**get_specific_collection**](FloodInundatedAreas2020KamrupMetroDistrictApi.md#get_specific_collection) | **GET** /collections/b7cdc784-a5ec-4b42-9d33-38a030d8c793 | Metadata about Boundaries of flood inundated area for Kamrup Metropolitan district, Assam in 2020
[**get_specific_feature**](FloodInundatedAreas2020KamrupMetroDistrictApi.md#get_specific_feature) | **GET** /collections/b7cdc784-a5ec-4b42-9d33-38a030d8c793/items/{featureId} | Get single feature from Boundaries of flood inundated area for Kamrup Metropolitan district, Assam in 2020


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, class_names=class_names, band_value=band_value)

Get features from Boundaries of flood inundated area for Kamrup Metropolitan district, Assam in 2020
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.FloodInundatedAreas2020KamrupMetroDistrictApi(api_client)
    ...
    band_value = 3.4 # float |  (optional)

    try:
        # Get features from Boundaries of flood inundated area for Kamrup Metropolitan district, Assam in 2020
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, class_names=class_names, band_value=band_value)
        print("The response of FloodInundatedAreas2020KamrupMetroDistrictApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FloodInundatedAreas2020KamrupMetroDistrictApi->get_features: %s\n" % e)
```
...
Metadata about Boundaries of flood inundated area for Kamrup Metropolitan district, Assam in 2020
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FloodInundatedAreas2020KamrupMetroDistrictApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FloodInundatedAreas2020KamrupMetroDistrictApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from Boundaries of flood inundated area for Kamrup Metropolitan district, Assam in 2020
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FloodInundatedAreas2020KamrupMetroDistrictApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FloodInundatedAreas2020KamrupMetroDistrictApi->get_specific_feature: %s\n" % e)
```
