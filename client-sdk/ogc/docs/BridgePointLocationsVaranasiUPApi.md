# openapi_client.BridgePointLocationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](BridgePointLocationsVaranasiUPApi.md#get_features) | **GET** /collections/ba90dac9-204a-4f30-96dd-c3fffe25bde1/items | Get features from Point locations of bridges in Varanasi, UP
[**get_specific_collection**](BridgePointLocationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/ba90dac9-204a-4f30-96dd-c3fffe25bde1 | Metadata about Point locations of bridges in Varanasi, UP
[**get_specific_feature**](BridgePointLocationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/ba90dac9-204a-4f30-96dd-c3fffe25bde1/items/{featureId} | Get single feature from Point locations of bridges in Varanasi, UP
...
Get features from Point locations of bridges in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BridgePointLocationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BridgePointLocationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of bridges in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BridgePointLocationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BridgePointLocationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
