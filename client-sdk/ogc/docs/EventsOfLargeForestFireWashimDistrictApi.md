# openapi_client.EventsOfLargeForestFireWashimDistrictApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](EventsOfLargeForestFireWashimDistrictApi.md#get_features) | **GET** /collections/2876c7d5-a761-4b7f-a5ba-a33597f90c7b/items | Get features from Polygon layer delineating the extent of large forest fire including attributes
[**get_specific_collection**](EventsOfLargeForestFireWashimDistrictApi.md#get_specific_collection) | **GET** /collections/2876c7d5-a761-4b7f-a5ba-a33597f90c7b | Metadata about Polygon layer delineating the extent of large forest fire including attributes
[**get_specific_feature**](EventsOfLargeForestFireWashimDistrictApi.md#get_specific_feature) | **GET** /collections/2876c7d5-a761-4b7f-a5ba-a33597f90c7b/items/{featureId} | Get single feature from Polygon layer delineating the extent of large forest fire including attributes


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, l_t_dic=l_t_dic, f_s_time=f_s_time, fire_name=fire_name, first_stat=first_stat, first_dist=first_dist)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Polygon layer delineating the extent of large forest fire including attributes
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, l_t_dic=l_t_dic, f_s_time=f_s_time, fire_name=fire_name, first_stat=first_stat, first_dist=first_dist)
        print("The response of EventsOfLargeForestFireWashimDistrictApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EventsOfLargeForestFireWashimDistrictApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EventsOfLargeForestFireWashimDistrictApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EventsOfLargeForestFireWashimDistrictApi->get_specific_feature: %s\n" % e)
```
