# openapi_client.WaterCollectionPointsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterCollectionPointsVaranasiUPApi.md#get_features) | **GET** /collections/d807ac80-50f4-44c8-b38e-2d665363248c/items | Get features from Point locations of water collection utilities in Varanasi, UP
[**get_specific_collection**](WaterCollectionPointsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/d807ac80-50f4-44c8-b38e-2d665363248c | Metadata about Point locations of water collection utilities in Varanasi, UP
[**get_specific_feature**](WaterCollectionPointsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/d807ac80-50f4-44c8-b38e-2d665363248c/items/{featureId} | Get single feature from Point locations of water collection utilities in Varanasi, UP
...
Get features from Point locations of water collection utilities in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterCollectionPointsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterCollectionPointsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of water collection utilities in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterCollectionPointsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterCollectionPointsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
