# openapi_client.RailwayInfrastructureLinesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RailwayInfrastructureLinesVaranasiUPApi.md#get_features) | **GET** /collections/7d1e23bd-c355-4bd4-b551-3135d8df5410/items | Get features from Line features representing railway line routes in in Varanasi, UP
[**get_specific_collection**](RailwayInfrastructureLinesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/7d1e23bd-c355-4bd4-b551-3135d8df5410 | Metadata about Line features representing railway line routes in in Varanasi, UP
[**get_specific_feature**](RailwayInfrastructureLinesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/7d1e23bd-c355-4bd4-b551-3135d8df5410/items/{featureId} | Get single feature from Line features representing railway line routes in in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, rly_name=rly_name, addl_info=addl_info, line_type=line_type, type1=type1)

Get features from Line features representing railway line routes in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    rly_name = 'rly_name_example' # str |  (optional)
    addl_info = 'addl_info_example' # str |  (optional)
    line_type = 'line_type_example' # str |  (optional)
    type1 = 'type1_example' # str |  (optional)

    try:
        # Get features from Line features representing railway line routes in in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, rly_name=rly_name, addl_info=addl_info, line_type=line_type, type1=type1)
        print("The response of RailwayInfrastructureLinesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayInfrastructureLinesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing railway line routes in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayInfrastructureLinesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayInfrastructureLinesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
