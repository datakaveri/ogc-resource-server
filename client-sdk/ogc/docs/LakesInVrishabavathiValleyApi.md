# openapi_client.LakesInVrishabavathiValleyApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LakesInVrishabavathiValleyApi.md#get_features) | **GET** /collections/dc8aa541-4ee0-4956-aae7-a56387595a28/items | Get features from Polygon features of lakes within Vrishabavathi Valley boundary
[**get_specific_collection**](LakesInVrishabavathiValleyApi.md#get_specific_collection) | **GET** /collections/dc8aa541-4ee0-4956-aae7-a56387595a28 | Metadata about Polygon features of lakes within Vrishabavathi Valley boundary
[**get_specific_feature**](LakesInVrishabavathiValleyApi.md#get_specific_feature) | **GET** /collections/dc8aa541-4ee0-4956-aae7-a56387595a28/items/{featureId} | Get single feature from Polygon features of lakes within Vrishabavathi Valley boundary


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, rs_area_23=rs_area_23)

Get features from Polygon features of lakes within Vrishabavathi Valley boundary
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    rs_area_23 = 'rs_area_23_example' # str |  (optional)

    try:
        # Get features from Polygon features of lakes within Vrishabavathi Valley boundary
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, rs_area_23=rs_area_23)
        print("The response of LakesInVrishabavathiValleyApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LakesInVrishabavathiValleyApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of lakes within Vrishabavathi Valley boundary
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LakesInVrishabavathiValleyApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LakesInVrishabavathiValleyApi->get_specific_feature: %s\n" % e)
```
