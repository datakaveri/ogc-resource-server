...
------------- | ------------- | -------------
[**get_features**](PostOfficeLocationsKamrupAssamApi.md#get_features) | **GET** /collections/349168c8-9324-4c12-99b7-0b5e598e720d/items | Get features from Point features of post office in Kamrup Metropolitan District, Assam
[**get_specific_collection**](PostOfficeLocationsKamrupAssamApi.md#get_specific_collection) | **GET** /collections/349168c8-9324-4c12-99b7-0b5e598e720d | Metadata about Point features of post office in Kamrup Metropolitan District, Assam
[**get_specific_feature**](PostOfficeLocationsKamrupAssamApi.md#get_specific_feature) | **GET** /collections/349168c8-9324-4c12-99b7-0b5e598e720d/items/{featureId} | Get single feature from Point features of post office in Kamrup Metropolitan District, Assam
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PostOfficeLocationsKamrupAssamApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of post office in Kamrup Metropolitan District, Assam
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficeLocationsKamrupAssamApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficeLocationsKamrupAssamApi->get_specific_feature: %s\n" % e)
```
