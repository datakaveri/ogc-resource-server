# openapi_client.RevenuePointFeaturesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RevenuePointFeaturesVaranasiUPApi.md#get_features) | **GET** /collections/813e6e52-c334-407c-b316-8d667b549394/items | Get features from Revenue point features in Varanasi, UP
[**get_specific_collection**](RevenuePointFeaturesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/813e6e52-c334-407c-b316-8d667b549394 | Metadata about Revenue point features in Varanasi, UP
[**get_specific_feature**](RevenuePointFeaturesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/813e6e52-c334-407c-b316-8d667b549394/items/{featureId} | Get single feature from Revenue point features in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, dist_twn_c=dist_twn_c, district=district, refname=refname, dist_sub_c=dist_sub_c, block_name=block_name, tahsil=tahsil, village_co=village_co, devlopment=devlopment, pargana=pargana)

Get features from Revenue point features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    refname = 'refname_example' # str |  (optional)
    ...
    try:
        # Get features from Revenue point features in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, dist_twn_c=dist_twn_c, district=district, refname=refname, dist_sub_c=dist_sub_c, block_name=block_name, tahsil=tahsil, village_co=village_co, devlopment=devlopment, pargana=pargana)
        print("The response of RevenuePointFeaturesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RevenuePointFeaturesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Revenue point features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RevenuePointFeaturesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RevenuePointFeaturesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
