# openapi_client.MajorAdministrativeDivisionVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MajorAdministrativeDivisionVaranasiUPApi.md#get_features) | **GET** /collections/49cee075-4bb1-47a1-a247-bd0e9d5a045f/items | Get features from Polygon features of different levels of administrative divisions in Varanasi, UP
[**get_specific_collection**](MajorAdministrativeDivisionVaranasiUPApi.md#get_specific_collection) | **GET** /collections/49cee075-4bb1-47a1-a247-bd0e9d5a045f | Metadata about Polygon features of different levels of administrative divisions in Varanasi, UP
[**get_specific_feature**](MajorAdministrativeDivisionVaranasiUPApi.md#get_specific_feature) | **GET** /collections/49cee075-4bb1-47a1-a247-bd0e9d5a045f/items/{featureId} | Get single feature from Polygon features of different levels of administrative divisions in Varanasi, UP
...
Get features from Polygon features of different levels of administrative divisions in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MajorAdministrativeDivisionVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MajorAdministrativeDivisionVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of different levels of administrative divisions in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MajorAdministrativeDivisionVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MajorAdministrativeDivisionVaranasiUPApi->get_specific_feature: %s\n" % e)
```
