# openapi_client.LocationOfPostOfficesInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LocationOfPostOfficesInSirmaurApi.md#get_features) | **GET** /collections/9a2b7d02-5db5-446a-99db-33995934bba9/items | Get features from Point locations of post offices
[**get_specific_collection**](LocationOfPostOfficesInSirmaurApi.md#get_specific_collection) | **GET** /collections/9a2b7d02-5db5-446a-99db-33995934bba9 | Metadata about Point locations of post offices
[**get_specific_feature**](LocationOfPostOfficesInSirmaurApi.md#get_specific_feature) | **GET** /collections/9a2b7d02-5db5-446a-99db-33995934bba9/items/{featureId} | Get single feature from Point locations of post offices
...
Get features from Point locations of post offices
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LocationOfPostOfficesInSirmaurApi(api_client)
    ...
    try:
        ...
        print("The response of LocationOfPostOfficesInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfPostOfficesInSirmaurApi->get_features: %s\n" % e)
```
...
Metadata about Point locations of post offices
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationOfPostOfficesInSirmaurApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfPostOfficesInSirmaurApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from Point locations of post offices
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationOfPostOfficesInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfPostOfficesInSirmaurApi->get_specific_feature: %s\n" % e)
```
