# openapi_client.RoadCenterlineInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RoadCenterlineInSirmaurApi.md#get_features) | **GET** /collections/67e032c8-c73c-4fc4-b48f-2679ad4a2e55/items | Get features from Centerline of roads with attribute info on the road type, construction material, usage of road
[**get_specific_collection**](RoadCenterlineInSirmaurApi.md#get_specific_collection) | **GET** /collections/67e032c8-c73c-4fc4-b48f-2679ad4a2e55 | Metadata about Centerline of roads with attribute info on the road type, construction material, usage of road
[**get_specific_feature**](RoadCenterlineInSirmaurApi.md#get_specific_feature) | **GET** /collections/67e032c8-c73c-4fc4-b48f-2679ad4a2e55/items/{featureId} | Get single feature from Centerline of roads with attribute info on the road type, construction material, usage of road
...
Get features from Centerline of roads with attribute info on the road type, construction material, usage of road
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadCenterlineInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadCenterlineInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Centerline of roads with attribute info on the road type, construction material, usage of road
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadCenterlineInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadCenterlineInSirmaurApi->get_specific_feature: %s\n" % e)
```
