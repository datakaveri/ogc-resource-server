# openapi_client.MorphostratigraphicUnitDataPartOfSonipatApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MorphostratigraphicUnitDataPartOfSonipatApi.md#get_features) | **GET** /collections/117fbe82-18fb-42c8-a74c-ee01481e2d31/items | Get features from Polygon features representing morphostratigraphic unit data for part of Sonipat district, Haryana
[**get_specific_collection**](MorphostratigraphicUnitDataPartOfSonipatApi.md#get_specific_collection) | **GET** /collections/117fbe82-18fb-42c8-a74c-ee01481e2d31 | Metadata about Polygon features representing morphostratigraphic unit data for part of Sonipat district, Haryana
[**get_specific_feature**](MorphostratigraphicUnitDataPartOfSonipatApi.md#get_specific_feature) | **GET** /collections/117fbe82-18fb-42c8-a74c-ee01481e2d31/items/{featureId} | Get single feature from Polygon features representing morphostratigraphic unit data for part of Sonipat district, Haryana


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, toposheet_=toposheet_, m_strat_un=m_strat_un)

Get features from Polygon features representing morphostratigraphic unit data for part of Sonipat district, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    m_strat_un = 'm_strat_un_example' # str |  (optional)

    try:
        # Get features from Polygon features representing morphostratigraphic unit data for part of Sonipat district, Haryana
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, toposheet_=toposheet_, m_strat_un=m_strat_un)
        print("The response of MorphostratigraphicUnitDataPartOfSonipatApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MorphostratigraphicUnitDataPartOfSonipatApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features representing morphostratigraphic unit data for part of Sonipat district, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MorphostratigraphicUnitDataPartOfSonipatApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MorphostratigraphicUnitDataPartOfSonipatApi->get_specific_feature: %s\n" % e)
```
