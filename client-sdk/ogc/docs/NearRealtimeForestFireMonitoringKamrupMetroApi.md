...
------------- | ------------- | -------------
[**get_features**](NearRealtimeForestFireMonitoringKamrupMetroApi.md#get_features) | **GET** /collections/d1c1e885-72cf-4b43-b334-acd74e8200e6/items | Get features from Extent of forest fire hotspots identified through near real-time monitoring systems
[**get_specific_collection**](NearRealtimeForestFireMonitoringKamrupMetroApi.md#get_specific_collection) | **GET** /collections/d1c1e885-72cf-4b43-b334-acd74e8200e6 | Metadata about Extent of forest fire hotspots identified through near real-time monitoring systems
[**get_specific_feature**](NearRealtimeForestFireMonitoringKamrupMetroApi.md#get_specific_feature) | **GET** /collections/d1c1e885-72cf-4b43-b334-acd74e8200e6/items/{featureId} | Get single feature from Extent of forest fire hotspots identified through near real-time monitoring systems
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NearRealtimeForestFireMonitoringKamrupMetroApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NearRealtimeForestFireMonitoringKamrupMetroApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NearRealtimeForestFireMonitoringKamrupMetroApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NearRealtimeForestFireMonitoringKamrupMetroApi->get_specific_feature: %s\n" % e)
```
