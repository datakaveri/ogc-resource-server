# openapi_client.ParcelAreasOfSonipatHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ParcelAreasOfSonipatHaryanaApi.md#get_features) | **GET** /collections/96c3ef6e-5447-4970-a37b-887c12f2067f/items | Get features from Parcel areas mapped under SVAMITVA scheme in Sonipat, Haryana
[**get_specific_collection**](ParcelAreasOfSonipatHaryanaApi.md#get_specific_collection) | **GET** /collections/96c3ef6e-5447-4970-a37b-887c12f2067f | Metadata about Parcel areas mapped under SVAMITVA scheme in Sonipat, Haryana
[**get_specific_feature**](ParcelAreasOfSonipatHaryanaApi.md#get_specific_feature) | **GET** /collections/96c3ef6e-5447-4970-a37b-887c12f2067f/items/{featureId} | Get single feature from Parcel areas mapped under SVAMITVA scheme in Sonipat, Haryana


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, state_code=state_code, village_co=village_co, area_sqm=area_sqm, tehsil_cod=tehsil_cod, open_area=open_area, block_code=block_code, village_na=village_na, built_up_a=built_up_a, lgd_code=lgd_code, district_c=district_c)

Get features from Parcel areas mapped under SVAMITVA scheme in Sonipat, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    village_co = 'village_co_example' # str |  (optional)
    area_sqm = 'area_sqm_example' # str |  (optional)
    tehsil_cod = 'tehsil_cod_example' # str |  (optional)
    open_area = 'open_area_example' # str |  (optional)
    block_code = 'block_code_example' # str |  (optional)
    village_na = 'village_na_example' # str |  (optional)
    built_up_a = 'built_up_a_example' # str |  (optional)
    lgd_code = 'lgd_code_example' # str |  (optional)
    district_c = 'district_c_example' # str |  (optional)

    try:
        # Get features from Parcel areas mapped under SVAMITVA scheme in Sonipat, Haryana
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, state_code=state_code, village_co=village_co, area_sqm=area_sqm, tehsil_cod=tehsil_cod, open_area=open_area, block_code=block_code, village_na=village_na, built_up_a=built_up_a, lgd_code=lgd_code, district_c=district_c)
        print("The response of ParcelAreasOfSonipatHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ParcelAreasOfSonipatHaryanaApi->get_features: %s\n" % e)
```
 ...
 **village_co** | **str**|  | [optional] 
 **area_sqm** | **str**|  | [optional] 
 **tehsil_cod** | **str**|  | [optional] 
 **open_area** | **str**|  | [optional] 
 **block_code** | **str**|  | [optional] 
 **village_na** | **str**|  | [optional] 
 **built_up_a** | **str**|  | [optional] 
 **lgd_code** | **str**|  | [optional] 
 **district_c** | **str**|  | [optional] 
...
Get single feature from Parcel areas mapped under SVAMITVA scheme in Sonipat, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ParcelAreasOfSonipatHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ParcelAreasOfSonipatHaryanaApi->get_specific_feature: %s\n" % e)
```
