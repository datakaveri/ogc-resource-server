# openapi_client.PowerPoleLocationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PowerPoleLocationsVaranasiUPApi.md#get_features) | **GET** /collections/af6e74c4-ddba-4357-95e3-dcfc02cfcaf5/items | Get features from Point locations of power poles in Varanasi, UP
[**get_specific_collection**](PowerPoleLocationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/af6e74c4-ddba-4357-95e3-dcfc02cfcaf5 | Metadata about Point locations of power poles in Varanasi, UP
[**get_specific_feature**](PowerPoleLocationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/af6e74c4-ddba-4357-95e3-dcfc02cfcaf5/items/{featureId} | Get single feature from Point locations of power poles in Varanasi, UP
...
Get features from Point locations of power poles in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PowerPoleLocationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PowerPoleLocationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of power poles in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PowerPoleLocationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PowerPoleLocationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
