# openapi_client.SoilPropertiesKamrupMetropolitanAssamApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SoilPropertiesKamrupMetropolitanAssamApi.md#get_features) | **GET** /collections/ae402e89-7a95-4a30-8536-3af8fe2428f4/items | Get features from Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_collection**](SoilPropertiesKamrupMetropolitanAssamApi.md#get_specific_collection) | **GET** /collections/ae402e89-7a95-4a30-8536-3af8fe2428f4 | Metadata about Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_feature**](SoilPropertiesKamrupMetropolitanAssamApi.md#get_specific_feature) | **GET** /collections/ae402e89-7a95-4a30-8536-3af8fe2428f4/items/{featureId} | Get single feature from Polygon feature illustrating the extent of soil and its associated attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SoilPropertiesKamrupMetropolitanAssamApi(api_client)
    ...
    try:
        ...
        print("The response of SoilPropertiesKamrupMetropolitanAssamApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesKamrupMetropolitanAssamApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesKamrupMetropolitanAssamApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesKamrupMetropolitanAssamApi->get_specific_collection: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesKamrupMetropolitanAssamApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesKamrupMetropolitanAssamApi->get_specific_feature: %s\n" % e)
```
