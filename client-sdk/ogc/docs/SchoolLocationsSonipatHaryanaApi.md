# openapi_client.SchoolLocationsSonipatHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SchoolLocationsSonipatHaryanaApi.md#get_features) | **GET** /collections/2867732f-f58c-491a-bd22-a956468b4b05/items | Get features from Point features of schools in Sonipat District, Haryana
[**get_specific_collection**](SchoolLocationsSonipatHaryanaApi.md#get_specific_collection) | **GET** /collections/2867732f-f58c-491a-bd22-a956468b4b05 | Metadata about Point features of schools in Sonipat District, Haryana
[**get_specific_feature**](SchoolLocationsSonipatHaryanaApi.md#get_specific_feature) | **GET** /collections/2867732f-f58c-491a-bd22-a956468b4b05/items/{featureId} | Get single feature from Point features of schools in Sonipat District, Haryana


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, block_lgd=block_lgd, school_cat=school_cat, dtname=dtname, latitude=latitude, schname=schname, block_name=block_name, management=management, subdt_lgd=subdt_lgd, vilname=vilname, state_lgd=state_lgd, schcd=schcd, dist_lgd=dist_lgd, gp_code=gp_code, gp_name=gp_name, vilcode11=vilcode11, stname=stname, longitude=longitude)

Get features from Point features of schools in Sonipat District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SchoolLocationsSonipatHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchoolLocationsSonipatHaryanaApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of schools in Sonipat District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SchoolLocationsSonipatHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchoolLocationsSonipatHaryanaApi->get_specific_feature: %s\n" % e)
```
