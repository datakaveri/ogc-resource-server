...
# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, railway_br=railway_br, descriptio=descriptio, electrifie=electrifie, zone_=zone_, division=division, gauge=gauge)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Railway Lines Data
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, railway_br=railway_br, descriptio=descriptio, electrifie=electrifie, zone_=zone_, division=division, gauge=gauge)
