# openapi_client.SluicesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SluicesVaranasiUPApi.md#get_features) | **GET** /collections/38f6ad6c-ccf1-4d61-b4c6-8a2ab769e0fd/items | Get features from Locations of sluices in Varanasi, UP
[**get_specific_collection**](SluicesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/38f6ad6c-ccf1-4d61-b4c6-8a2ab769e0fd | Metadata about Locations of sluices in Varanasi, UP
[**get_specific_feature**](SluicesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/38f6ad6c-ccf1-4d61-b4c6-8a2ab769e0fd/items/{featureId} | Get single feature from Locations of sluices in Varanasi, UP
...
Get features from Locations of sluices in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SluicesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SluicesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of sluices in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SluicesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SluicesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
