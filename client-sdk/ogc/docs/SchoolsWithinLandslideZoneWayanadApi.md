# openapi_client.SchoolsWithinLandslideZoneWayanadApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SchoolsWithinLandslideZoneWayanadApi.md#get_features) | **GET** /collections/fe20a626-351a-4cc6-ad5e-f19171241cf0/items | Get features from Polygon features of school buildings that were damaged in the event of landslide in Wayanad, Kerala
[**get_specific_collection**](SchoolsWithinLandslideZoneWayanadApi.md#get_specific_collection) | **GET** /collections/fe20a626-351a-4cc6-ad5e-f19171241cf0 | Metadata about Polygon features of school buildings that were damaged in the event of landslide in Wayanad, Kerala
[**get_specific_feature**](SchoolsWithinLandslideZoneWayanadApi.md#get_specific_feature) | **GET** /collections/fe20a626-351a-4cc6-ad5e-f19171241cf0/items/{featureId} | Get single feature from Polygon features of school buildings that were damaged in the event of landslide in Wayanad, Kerala


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, scl_name=scl_name)

Get features from Polygon features of school buildings that were damaged in the event of landslide in Wayanad, Kerala
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    scl_name = 'scl_name_example' # str |  (optional)

    try:
        # Get features from Polygon features of school buildings that were damaged in the event of landslide in Wayanad, Kerala
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, scl_name=scl_name)
        print("The response of SchoolsWithinLandslideZoneWayanadApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchoolsWithinLandslideZoneWayanadApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of school buildings that were damaged in the event of landslide in Wayanad, Kerala
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SchoolsWithinLandslideZoneWayanadApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchoolsWithinLandslideZoneWayanadApi->get_specific_feature: %s\n" % e)
```
