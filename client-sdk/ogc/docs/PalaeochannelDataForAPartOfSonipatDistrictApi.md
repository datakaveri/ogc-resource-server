...
------------- | ------------- | -------------
[**get_features**](PalaeochannelDataForAPartOfSonipatDistrictApi.md#get_features) | **GET** /collections/f2afd3dc-112e-4d31-b059-83b5c73f91c4/items | Get features from polygon features representing palaeochannel data for a part of Sonipat district, Haryana
[**get_specific_collection**](PalaeochannelDataForAPartOfSonipatDistrictApi.md#get_specific_collection) | **GET** /collections/f2afd3dc-112e-4d31-b059-83b5c73f91c4 | Metadata about polygon features representing palaeochannel data for a part of Sonipat district, Haryana
[**get_specific_feature**](PalaeochannelDataForAPartOfSonipatDistrictApi.md#get_specific_feature) | **GET** /collections/f2afd3dc-112e-4d31-b059-83b5c73f91c4/items/{featureId} | Get single feature from polygon features representing palaeochannel data for a part of Sonipat district, Haryana


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, toposheet_=toposheet_)

Get features from polygon features representing palaeochannel data for a part of Sonipat district, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from polygon features representing palaeochannel data for a part of Sonipat district, Haryana
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, toposheet_=toposheet_)
        print("The response of PalaeochannelDataForAPartOfSonipatDistrictApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PalaeochannelDataForAPartOfSonipatDistrictApi->get_features: %s\n" % e)
```
...
Get single feature from polygon features representing palaeochannel data for a part of Sonipat district, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PalaeochannelDataForAPartOfSonipatDistrictApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PalaeochannelDataForAPartOfSonipatDistrictApi->get_specific_feature: %s\n" % e)
```
