# openapi_client.SmartToiletLocationsInAhmedabadCityApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SmartToiletLocationsInAhmedabadCityApi.md#get_features) | **GET** /collections/66e70775-57f7-48b7-b38c-da8973119276/items | Get features from The physical coordinates of smart toilet locations in Ahmedabad city
[**get_specific_collection**](SmartToiletLocationsInAhmedabadCityApi.md#get_specific_collection) | **GET** /collections/66e70775-57f7-48b7-b38c-da8973119276 | Metadata about The physical coordinates of smart toilet locations in Ahmedabad city
[**get_specific_feature**](SmartToiletLocationsInAhmedabadCityApi.md#get_specific_feature) | **GET** /collections/66e70775-57f7-48b7-b38c-da8973119276/items/{featureId} | Get single feature from The physical coordinates of smart toilet locations in Ahmedabad city


# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, address=address, name=name, observation_date_time=observation_date_time)

Get features from The physical coordinates of smart toilet locations in Ahmedabad city
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from The physical coordinates of smart toilet locations in Ahmedabad city
        api_response = api_instance.get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, address=address, name=name, observation_date_time=observation_date_time)
        print("The response of SmartToiletLocationsInAhmedabadCityApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SmartToiletLocationsInAhmedabadCityApi->get_features: %s\n" % e)
```
...
Get single feature from The physical coordinates of smart toilet locations in Ahmedabad city
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SmartToiletLocationsInAhmedabadCityApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SmartToiletLocationsInAhmedabadCityApi->get_specific_feature: %s\n" % e)
```
