...
# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, address=address, name=name, observation_date_time=observation_date_time)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from The physical coordinates of smart toilet locations in Ahmedabad city
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, address=address, name=name, observation_date_time=observation_date_time)
