# openapi_client.LandingGroundInVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LandingGroundInVaranasiUPApi.md#get_features) | **GET** /collections/ca73b63f-9284-474d-901f-9fcc8ded6582/items | Get features from Point locations of landing grounds in Varanasi, UP
[**get_specific_collection**](LandingGroundInVaranasiUPApi.md#get_specific_collection) | **GET** /collections/ca73b63f-9284-474d-901f-9fcc8ded6582 | Metadata about Point locations of landing grounds in Varanasi, UP
[**get_specific_feature**](LandingGroundInVaranasiUPApi.md#get_specific_feature) | **GET** /collections/ca73b63f-9284-474d-901f-9fcc8ded6582/items/{featureId} | Get single feature from Point locations of landing grounds in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, category=category, use_typ=use_typ)

Get features from Point locations of landing grounds in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    use_typ = 'use_typ_example' # str |  (optional)

    try:
        # Get features from Point locations of landing grounds in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, category=category, use_typ=use_typ)
        print("The response of LandingGroundInVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LandingGroundInVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of landing grounds in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LandingGroundInVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LandingGroundInVaranasiUPApi->get_specific_feature: %s\n" % e)
```
