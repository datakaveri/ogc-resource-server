# openapi_client.FootbridgeCenterlineVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](FootbridgeCenterlineVaranasiUPApi.md#get_features) | **GET** /collections/df2bee18-a475-48ed-8f99-027c0a53f837/items | Get features from Centerline of footbridges in Varanasi, UP
[**get_specific_collection**](FootbridgeCenterlineVaranasiUPApi.md#get_specific_collection) | **GET** /collections/df2bee18-a475-48ed-8f99-027c0a53f837 | Metadata about Centerline of footbridges in Varanasi, UP
[**get_specific_feature**](FootbridgeCenterlineVaranasiUPApi.md#get_specific_feature) | **GET** /collections/df2bee18-a475-48ed-8f99-027c0a53f837/items/{featureId} | Get single feature from Centerline of footbridges in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, category=category, c_mtrl=c_mtrl, name=name)

Get features from Centerline of footbridges in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Centerline of footbridges in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, category=category, c_mtrl=c_mtrl, name=name)
        print("The response of FootbridgeCenterlineVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FootbridgeCenterlineVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Centerline of footbridges in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FootbridgeCenterlineVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FootbridgeCenterlineVaranasiUPApi->get_specific_feature: %s\n" % e)
```
