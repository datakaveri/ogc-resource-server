...
------------- | ------------- | -------------
[**get_features**](DailyLandSurfaceTemperatureInBengaluruApi.md#get_features) | **GET** /collections/0c320b52-a7d8-476b-a695-a59fbe8a89a8/items | Get features from Wardwise daily land surface temperature data for Bengaluru from 01-01-2019 to 30-04-2024
[**get_specific_collection**](DailyLandSurfaceTemperatureInBengaluruApi.md#get_specific_collection) | **GET** /collections/0c320b52-a7d8-476b-a695-a59fbe8a89a8 | Metadata about Wardwise daily land surface temperature data for Bengaluru from 01-01-2019 to 30-04-2024
[**get_specific_feature**](DailyLandSurfaceTemperatureInBengaluruApi.md#get_specific_feature) | **GET** /collections/0c320b52-a7d8-476b-a695-a59fbe8a89a8/items/{featureId} | Get single feature from Wardwise daily land surface temperature data for Bengaluru from 01-01-2019 to 30-04-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, value_name=value_name, dates=dates, lst=lst, kgis_ward_na=kgis_ward_na)

Get features from Wardwise daily land surface temperature data for Bengaluru from 01-01-2019 to 30-04-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    lst = 'lst_example' # str |  (optional)
    kgis_ward_na = 'kgis_ward_na_example' # str |  (optional)

    try:
        # Get features from Wardwise daily land surface temperature data for Bengaluru from 01-01-2019 to 30-04-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, value_name=value_name, dates=dates, lst=lst, kgis_ward_na=kgis_ward_na)
        print("The response of DailyLandSurfaceTemperatureInBengaluruApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyLandSurfaceTemperatureInBengaluruApi->get_features: %s\n" % e)
```
...
Get single feature from Wardwise daily land surface temperature data for Bengaluru from 01-01-2019 to 30-04-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DailyLandSurfaceTemperatureInBengaluruApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyLandSurfaceTemperatureInBengaluruApi->get_specific_feature: %s\n" % e)
```
