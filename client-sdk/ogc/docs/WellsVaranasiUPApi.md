# openapi_client.WellsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WellsVaranasiUPApi.md#get_features) | **GET** /collections/348f57fb-fbba-492b-b73a-c108bd6a6579/items | Get features from Locations of wells in Varanasi, UP
[**get_specific_collection**](WellsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/348f57fb-fbba-492b-b73a-c108bd6a6579 | Metadata about Locations of wells in Varanasi, UP
[**get_specific_feature**](WellsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/348f57fb-fbba-492b-b73a-c108bd6a6579/items/{featureId} | Get single feature from Locations of wells in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, svy_date=svy_date, well_type=well_type, gmrotation=gmrotation, addl_info=addl_info, unique_id=unique_id, type1=type1)

Get features from Locations of wells in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    well_type = 'well_type_example' # str |  (optional)
    ...
    try:
        # Get features from Locations of wells in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, svy_date=svy_date, well_type=well_type, gmrotation=gmrotation, addl_info=addl_info, unique_id=unique_id, type1=type1)
        print("The response of WellsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WellsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of wells in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WellsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WellsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
