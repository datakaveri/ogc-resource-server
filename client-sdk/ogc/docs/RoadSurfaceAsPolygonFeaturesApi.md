...
------------- | ------------- | -------------
[**get_features**](RoadSurfaceAsPolygonFeaturesApi.md#get_features) | **GET** /collections/f5680889-7b3d-429b-9068-de26e8c1b782/items | Get features from Major roads as polygon feature, consisting of the attributes like road type, construction material
[**get_specific_collection**](RoadSurfaceAsPolygonFeaturesApi.md#get_specific_collection) | **GET** /collections/f5680889-7b3d-429b-9068-de26e8c1b782 | Metadata about Major roads as polygon feature, consisting of the attributes like road type, construction material
[**get_specific_feature**](RoadSurfaceAsPolygonFeaturesApi.md#get_specific_feature) | **GET** /collections/f5680889-7b3d-429b-9068-de26e8c1b782/items/{featureId} | Get single feature from Major roads as polygon feature, consisting of the attributes like road type, construction material


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, crrg_way=crrg_way, category=category, srfc_typ=srfc_typ, subcat=subcat, pavement=pavement, bult_on=bult_on, name=name)

Get features from Major roads as polygon feature, consisting of the attributes like road type, construction material
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Major roads as polygon feature, consisting of the attributes like road type, construction material
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, crrg_way=crrg_way, category=category, srfc_typ=srfc_typ, subcat=subcat, pavement=pavement, bult_on=bult_on, name=name)
        print("The response of RoadSurfaceAsPolygonFeaturesApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadSurfaceAsPolygonFeaturesApi->get_features: %s\n" % e)
```
...
Get single feature from Major roads as polygon feature, consisting of the attributes like road type, construction material
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadSurfaceAsPolygonFeaturesApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadSurfaceAsPolygonFeaturesApi->get_specific_feature: %s\n" % e)
```
