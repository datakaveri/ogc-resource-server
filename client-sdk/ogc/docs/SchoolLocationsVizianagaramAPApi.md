# openapi_client.SchoolLocationsVizianagaramAPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SchoolLocationsVizianagaramAPApi.md#get_features) | **GET** /collections/04f63421-aea4-4aac-b8b1-00182692ca34/items | Get features from Point features of schools in Vizianagaram District, Andhra Pradesh
[**get_specific_collection**](SchoolLocationsVizianagaramAPApi.md#get_specific_collection) | **GET** /collections/04f63421-aea4-4aac-b8b1-00182692ca34 | Metadata about Point features of schools in Vizianagaram District, Andhra Pradesh
[**get_specific_feature**](SchoolLocationsVizianagaramAPApi.md#get_specific_feature) | **GET** /collections/04f63421-aea4-4aac-b8b1-00182692ca34/items/{featureId} | Get single feature from Point features of schools in Vizianagaram District, Andhra Pradesh


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, school_cat=school_cat, block_lgd=block_lgd, dtname=dtname, latitude=latitude, schname=schname, block_name=block_name, subdt_lgd=subdt_lgd, management=management, vilname=vilname, state_lgd=state_lgd, dist_lgd=dist_lgd, schcd=schcd, gp_code=gp_code, vilcode11=vilcode11, gp_name=gp_name, longitude=longitude, stname=stname)

Get features from Point features of schools in Vizianagaram District, Andhra Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SchoolLocationsVizianagaramAPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchoolLocationsVizianagaramAPApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of schools in Vizianagaram District, Andhra Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SchoolLocationsVizianagaramAPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchoolLocationsVizianagaramAPApi->get_specific_feature: %s\n" % e)
```
