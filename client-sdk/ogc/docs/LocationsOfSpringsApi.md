# openapi_client.LocationsOfSpringsApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LocationsOfSpringsApi.md#get_features) | **GET** /collections/85dae6b4-b161-4eb8-8179-aa1de903882e/items | Get features from Spring locations
[**get_specific_collection**](LocationsOfSpringsApi.md#get_specific_collection) | **GET** /collections/85dae6b4-b161-4eb8-8179-aa1de903882e | Metadata about Spring locations
[**get_specific_feature**](LocationsOfSpringsApi.md#get_specific_feature) | **GET** /collections/85dae6b4-b161-4eb8-8179-aa1de903882e/items/{featureId} | Get single feature from Spring locations


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)

Get features from Spring locations
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.LocationsOfSpringsApi(api_client)
    ...
    try:
        ...
        print("The response of LocationsOfSpringsApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationsOfSpringsApi->get_features: %s\n" % e)
```
...
Metadata about Spring locations
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationsOfSpringsApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationsOfSpringsApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from Spring locations
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationsOfSpringsApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationsOfSpringsApi->get_specific_feature: %s\n" % e)
```
