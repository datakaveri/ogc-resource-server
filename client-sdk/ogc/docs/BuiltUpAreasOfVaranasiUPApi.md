# openapi_client.BuiltUpAreasOfVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](BuiltUpAreasOfVaranasiUPApi.md#get_features) | **GET** /collections/1112c08d-cf5a-41ab-ba7c-e72074e6ff91/items | Get features from Polygon features of built-up areas mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_collection**](BuiltUpAreasOfVaranasiUPApi.md#get_specific_collection) | **GET** /collections/1112c08d-cf5a-41ab-ba7c-e72074e6ff91 | Metadata about Polygon features of built-up areas mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_feature**](BuiltUpAreasOfVaranasiUPApi.md#get_specific_feature) | **GET** /collections/1112c08d-cf5a-41ab-ba7c-e72074e6ff91/items/{featureId} | Get single feature from Polygon features of built-up areas mapped under SVAMITVA scheme in Varanasi district, UP
...
Get features from Polygon features of built-up areas mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BuiltUpAreasOfVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BuiltUpAreasOfVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of built-up areas mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BuiltUpAreasOfVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BuiltUpAreasOfVaranasiUPApi->get_specific_feature: %s\n" % e)
```
