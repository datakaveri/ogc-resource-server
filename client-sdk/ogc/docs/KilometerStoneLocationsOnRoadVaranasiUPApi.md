# openapi_client.KilometerStoneLocationsOnRoadVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](KilometerStoneLocationsOnRoadVaranasiUPApi.md#get_features) | **GET** /collections/6d7adeb6-afb7-477c-9e6c-b70e4f93f0b9/items | Get features from Geographical locations of km stones on roads in Varanasi, UP
[**get_specific_collection**](KilometerStoneLocationsOnRoadVaranasiUPApi.md#get_specific_collection) | **GET** /collections/6d7adeb6-afb7-477c-9e6c-b70e4f93f0b9 | Metadata about Geographical locations of km stones on roads in Varanasi, UP
[**get_specific_feature**](KilometerStoneLocationsOnRoadVaranasiUPApi.md#get_specific_feature) | **GET** /collections/6d7adeb6-afb7-477c-9e6c-b70e4f93f0b9/items/{featureId} | Get single feature from Geographical locations of km stones on roads in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, dist_km=dist_km, rd_cat=rd_cat, rd_sbcat=rd_sbcat)

Get features from Geographical locations of km stones on roads in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    dist_km = 3.4 # float |  (optional)
    rd_cat = 56 # int |  (optional)
    rd_sbcat = 'rd_sbcat_example' # str |  (optional)

    try:
        # Get features from Geographical locations of km stones on roads in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, dist_km=dist_km, rd_cat=rd_cat, rd_sbcat=rd_sbcat)
        print("The response of KilometerStoneLocationsOnRoadVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KilometerStoneLocationsOnRoadVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **dist_km** | **float**|  | [optional] 
 **rd_cat** | **int**|  | [optional] 
 **rd_sbcat** | **str**|  | [optional] 
...
Get single feature from Geographical locations of km stones on roads in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KilometerStoneLocationsOnRoadVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KilometerStoneLocationsOnRoadVaranasiUPApi->get_specific_feature: %s\n" % e)
```
