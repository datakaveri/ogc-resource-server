# openapi_client.CroppingIntensityKamrupMetroDistrictApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CroppingIntensityKamrupMetroDistrictApi.md#get_features) | **GET** /collections/d26dd8bc-d2c5-4c3f-b2b7-f91c9f002de8/items | Get features from Areas of single and double crop
[**get_specific_collection**](CroppingIntensityKamrupMetroDistrictApi.md#get_specific_collection) | **GET** /collections/d26dd8bc-d2c5-4c3f-b2b7-f91c9f002de8 | Metadata about Areas of single and double crop
[**get_specific_feature**](CroppingIntensityKamrupMetroDistrictApi.md#get_specific_feature) | **GET** /collections/d26dd8bc-d2c5-4c3f-b2b7-f91c9f002de8/items/{featureId} | Get single feature from Areas of single and double crop
...
Get features from Areas of single and double crop
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CroppingIntensityKamrupMetroDistrictApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CroppingIntensityKamrupMetroDistrictApi->get_features: %s\n" % e)
```
...
Get single feature from Areas of single and double crop
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CroppingIntensityKamrupMetroDistrictApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CroppingIntensityKamrupMetroDistrictApi->get_specific_feature: %s\n" % e)
```
