# openapi_client.IrrigationCommandAreasVizianagaramAPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](IrrigationCommandAreasVizianagaramAPApi.md#get_features) | **GET** /collections/eeb18950-c22f-4035-a12f-5aa304025d7d/items | Get features from Polygon features of irrigation command areas in and around Vizianagaram district, Andhra Pradesh
[**get_specific_collection**](IrrigationCommandAreasVizianagaramAPApi.md#get_specific_collection) | **GET** /collections/eeb18950-c22f-4035-a12f-5aa304025d7d | Metadata about Polygon features of irrigation command areas in and around Vizianagaram district, Andhra Pradesh
[**get_specific_feature**](IrrigationCommandAreasVizianagaramAPApi.md#get_specific_feature) | **GET** /collections/eeb18950-c22f-4035-a12f-5aa304025d7d/items/{featureId} | Get single feature from Polygon features of irrigation command areas in and around Vizianagaram district, Andhra Pradesh
...
Get features from Polygon features of irrigation command areas in and around Vizianagaram district, Andhra Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IrrigationCommandAreasVizianagaramAPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IrrigationCommandAreasVizianagaramAPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of irrigation command areas in and around Vizianagaram district, Andhra Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IrrigationCommandAreasVizianagaramAPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IrrigationCommandAreasVizianagaramAPApi->get_specific_feature: %s\n" % e)
```
