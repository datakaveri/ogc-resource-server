# openapi_client.EcosensitiveAreaVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](EcosensitiveAreaVaranasiUPApi.md#get_features) | **GET** /collections/ecf2a8b7-2150-425d-962e-71e194d0f026/items | Get features from Extent of ecosensitive areas as polygon features in Varanasi, UP
[**get_specific_collection**](EcosensitiveAreaVaranasiUPApi.md#get_specific_collection) | **GET** /collections/ecf2a8b7-2150-425d-962e-71e194d0f026 | Metadata about Extent of ecosensitive areas as polygon features in Varanasi, UP
[**get_specific_feature**](EcosensitiveAreaVaranasiUPApi.md#get_specific_feature) | **GET** /collections/ecf2a8b7-2150-425d-962e-71e194d0f026/items/{featureId} | Get single feature from Extent of ecosensitive areas as polygon features in Varanasi, UP
...
Get features from Extent of ecosensitive areas as polygon features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EcosensitiveAreaVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EcosensitiveAreaVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Extent of ecosensitive areas as polygon features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EcosensitiveAreaVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EcosensitiveAreaVaranasiUPApi->get_specific_feature: %s\n" % e)
```
