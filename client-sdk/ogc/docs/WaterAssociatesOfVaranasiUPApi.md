# openapi_client.WaterAssociatesOfVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterAssociatesOfVaranasiUPApi.md#get_features) | **GET** /collections/65d88014-d03e-4920-ac7e-9adc73c5992e/items | Get features from Polygon features of water associates mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_collection**](WaterAssociatesOfVaranasiUPApi.md#get_specific_collection) | **GET** /collections/65d88014-d03e-4920-ac7e-9adc73c5992e | Metadata about Polygon features of water associates mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_feature**](WaterAssociatesOfVaranasiUPApi.md#get_specific_feature) | **GET** /collections/65d88014-d03e-4920-ac7e-9adc73c5992e/items/{featureId} | Get single feature from Polygon features of water associates mapped under SVAMITVA scheme in Varanasi district, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)

Get features from Polygon features of water associates mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterAssociatesOfVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterAssociatesOfVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of water associates mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterAssociatesOfVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterAssociatesOfVaranasiUPApi->get_specific_feature: %s\n" % e)
```
