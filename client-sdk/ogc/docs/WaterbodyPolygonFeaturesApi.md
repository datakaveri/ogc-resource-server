# openapi_client.WaterbodyPolygonFeaturesApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterbodyPolygonFeaturesApi.md#get_features) | **GET** /collections/aa67a53c-ed57-4851-9ded-6bc7dbd1b99e/items | Get features from Waterbody polygon features
[**get_specific_collection**](WaterbodyPolygonFeaturesApi.md#get_specific_collection) | **GET** /collections/aa67a53c-ed57-4851-9ded-6bc7dbd1b99e | Metadata about Waterbody polygon features
[**get_specific_feature**](WaterbodyPolygonFeaturesApi.md#get_specific_feature) | **GET** /collections/aa67a53c-ed57-4851-9ded-6bc7dbd1b99e/items/{featureId} | Get single feature from Waterbody polygon features


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, origin=origin, category=category, covered=covered, perinlty=perinlty, name=name)

Get features from Waterbody polygon features
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Waterbody polygon features
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, origin=origin, category=category, covered=covered, perinlty=perinlty, name=name)
        print("The response of WaterbodyPolygonFeaturesApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodyPolygonFeaturesApi->get_features: %s\n" % e)
```
...
Get single feature from Waterbody polygon features
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterbodyPolygonFeaturesApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodyPolygonFeaturesApi->get_specific_feature: %s\n" % e)
```
