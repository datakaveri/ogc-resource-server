# openapi_client.BridgePolygonLocationsInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](BridgePolygonLocationsInSirmaurApi.md#get_features) | **GET** /collections/b664751f-e95e-4ec2-946e-4d45f427a354/items | Get features from Bridges as polygon features
[**get_specific_collection**](BridgePolygonLocationsInSirmaurApi.md#get_specific_collection) | **GET** /collections/b664751f-e95e-4ec2-946e-4d45f427a354 | Metadata about Bridges as polygon features
[**get_specific_feature**](BridgePolygonLocationsInSirmaurApi.md#get_specific_feature) | **GET** /collections/b664751f-e95e-4ec2-946e-4d45f427a354/items/{featureId} | Get single feature from Bridges as polygon features


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, c_type=c_type, category=category, af_cat=af_cat, c_mtrl=c_mtrl, blt_acrs=blt_acrs)

Get features from Bridges as polygon features
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Bridges as polygon features
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, c_type=c_type, category=category, af_cat=af_cat, c_mtrl=c_mtrl, blt_acrs=blt_acrs)
        print("The response of BridgePolygonLocationsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BridgePolygonLocationsInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Bridges as polygon features
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BridgePolygonLocationsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BridgePolygonLocationsInSirmaurApi->get_specific_feature: %s\n" % e)
```
