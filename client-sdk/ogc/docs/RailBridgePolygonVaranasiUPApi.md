# openapi_client.RailBridgePolygonVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RailBridgePolygonVaranasiUPApi.md#get_features) | **GET** /collections/b059ad54-63fa-43d8-b637-de322cb208ab/items | Get features from Detailed polygon representations of rail bridges in Varanasi, UP
[**get_specific_collection**](RailBridgePolygonVaranasiUPApi.md#get_specific_collection) | **GET** /collections/b059ad54-63fa-43d8-b637-de322cb208ab | Metadata about Detailed polygon representations of rail bridges in Varanasi, UP
[**get_specific_feature**](RailBridgePolygonVaranasiUPApi.md#get_specific_feature) | **GET** /collections/b059ad54-63fa-43d8-b637-de322cb208ab/items/{featureId} | Get single feature from Detailed polygon representations of rail bridges in Varanasi, UP
...
Get features from Detailed polygon representations of rail bridges in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailBridgePolygonVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailBridgePolygonVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Detailed polygon representations of rail bridges in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailBridgePolygonVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailBridgePolygonVaranasiUPApi->get_specific_feature: %s\n" % e)
```
