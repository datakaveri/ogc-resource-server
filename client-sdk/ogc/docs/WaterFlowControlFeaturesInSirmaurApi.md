# openapi_client.WaterFlowControlFeaturesInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterFlowControlFeaturesInSirmaurApi.md#get_features) | **GET** /collections/3d26009a-cece-4ee7-a65d-5cdf2d8a7dbd/items | Get features from Flow control polygon features like sluice, weir, dam, barrage
[**get_specific_collection**](WaterFlowControlFeaturesInSirmaurApi.md#get_specific_collection) | **GET** /collections/3d26009a-cece-4ee7-a65d-5cdf2d8a7dbd | Metadata about Flow control polygon features like sluice, weir, dam, barrage
[**get_specific_feature**](WaterFlowControlFeaturesInSirmaurApi.md#get_specific_feature) | **GET** /collections/3d26009a-cece-4ee7-a65d-5cdf2d8a7dbd/items/{featureId} | Get single feature from Flow control polygon features like sluice, weir, dam, barrage


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, ftr_on=ftr_on, category=category, perinlty=perinlty, c_mtrl=c_mtrl)

Get features from Flow control polygon features like sluice, weir, dam, barrage
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    ftr_on = 'ftr_on_example' # str |  (optional)
    ...
    try:
        # Get features from Flow control polygon features like sluice, weir, dam, barrage
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, ftr_on=ftr_on, category=category, perinlty=perinlty, c_mtrl=c_mtrl)
        print("The response of WaterFlowControlFeaturesInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterFlowControlFeaturesInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Flow control polygon features like sluice, weir, dam, barrage
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterFlowControlFeaturesInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterFlowControlFeaturesInSirmaurApi->get_specific_feature: %s\n" % e)
```
