# openapi_client.RailwayStationVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RailwayStationVaranasiUPApi.md#get_features) | **GET** /collections/72c4c558-05b5-4f19-b64a-636540a4e9fd/items | Get features from Point locations of railway stations in Varanasi, UP
[**get_specific_collection**](RailwayStationVaranasiUPApi.md#get_specific_collection) | **GET** /collections/72c4c558-05b5-4f19-b64a-636540a4e9fd | Metadata about Point locations of railway stations in Varanasi, UP
[**get_specific_feature**](RailwayStationVaranasiUPApi.md#get_specific_feature) | **GET** /collections/72c4c558-05b5-4f19-b64a-636540a4e9fd/items/{featureId} | Get single feature from Point locations of railway stations in Varanasi, UP
...
Get features from Point locations of railway stations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayStationVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayStationVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of railway stations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayStationVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayStationVaranasiUPApi->get_specific_feature: %s\n" % e)
```
