# openapi_client.LalDoraOfVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LalDoraOfVaranasiUPApi.md#get_features) | **GET** /collections/0a3684f0-79ab-4bfa-be8b-ca75f98236fd/items | Get features from Polygon features of Lal Dora mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_collection**](LalDoraOfVaranasiUPApi.md#get_specific_collection) | **GET** /collections/0a3684f0-79ab-4bfa-be8b-ca75f98236fd | Metadata about Polygon features of Lal Dora mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_feature**](LalDoraOfVaranasiUPApi.md#get_specific_feature) | **GET** /collections/0a3684f0-79ab-4bfa-be8b-ca75f98236fd/items/{featureId} | Get single feature from Polygon features of Lal Dora mapped under SVAMITVA scheme in Varanasi district, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)

Get features from Polygon features of Lal Dora mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LalDoraOfVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LalDoraOfVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of Lal Dora mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LalDoraOfVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LalDoraOfVaranasiUPApi->get_specific_feature: %s\n" % e)
```
