...
------------- | ------------- | -------------
[**get_features**](WasteLandCoverInSirmaurApi.md#get_features) | **GET** /collections/cc2b97d3-f4c2-4821-9d52-377772f3023b/items | Get features from Spatial extent of the wasteland covers like quarry, barren land and other vacant lands
[**get_specific_collection**](WasteLandCoverInSirmaurApi.md#get_specific_collection) | **GET** /collections/cc2b97d3-f4c2-4821-9d52-377772f3023b | Metadata about Spatial extent of the wasteland covers like quarry, barren land and other vacant lands
[**get_specific_feature**](WasteLandCoverInSirmaurApi.md#get_specific_feature) | **GET** /collections/cc2b97d3-f4c2-4821-9d52-377772f3023b/items/{featureId} | Get single feature from Spatial extent of the wasteland covers like quarry, barren land and other vacant lands
...
Get features from Spatial extent of the wasteland covers like quarry, barren land and other vacant lands
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WasteLandCoverInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WasteLandCoverInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Spatial extent of the wasteland covers like quarry, barren land and other vacant lands
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WasteLandCoverInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WasteLandCoverInSirmaurApi->get_specific_feature: %s\n" % e)
```
