# openapi_client.ForestCoverGurugramDistrict2021Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ForestCoverGurugramDistrict2021Api.md#get_features) | **GET** /collections/b7765a88-6b4a-488e-856a-cfac593698de/items | Get features from Boundaries of forest cover based on canopy density in Gurguram distirict, Haryana
[**get_specific_collection**](ForestCoverGurugramDistrict2021Api.md#get_specific_collection) | **GET** /collections/b7765a88-6b4a-488e-856a-cfac593698de | Metadata about Boundaries of forest cover based on canopy density in Gurguram distirict, Haryana
[**get_specific_feature**](ForestCoverGurugramDistrict2021Api.md#get_specific_feature) | **GET** /collections/b7765a88-6b4a-488e-856a-cfac593698de/items/{featureId} | Get single feature from Boundaries of forest cover based on canopy density in Gurguram distirict, Haryana
...
Get features from Boundaries of forest cover based on canopy density in Gurguram distirict, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ForestCoverGurugramDistrict2021Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ForestCoverGurugramDistrict2021Api->get_features: %s\n" % e)
```
...
Get single feature from Boundaries of forest cover based on canopy density in Gurguram distirict, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ForestCoverGurugramDistrict2021Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ForestCoverGurugramDistrict2021Api->get_specific_feature: %s\n" % e)
```
