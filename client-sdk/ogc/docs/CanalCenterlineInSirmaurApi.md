...
------------- | ------------- | -------------
[**get_features**](CanalCenterlineInSirmaurApi.md#get_features) | **GET** /collections/eea2586d-dcdc-48bc-90f1-312d2ee674a1/items | Get features from centerline of canals with the attributes like the name, perenniality and current status of its use
[**get_specific_collection**](CanalCenterlineInSirmaurApi.md#get_specific_collection) | **GET** /collections/eea2586d-dcdc-48bc-90f1-312d2ee674a1 | Metadata about centerline of canals with the attributes like the name, perenniality and current status of its use
[**get_specific_feature**](CanalCenterlineInSirmaurApi.md#get_specific_feature) | **GET** /collections/eea2586d-dcdc-48bc-90f1-312d2ee674a1/items/{featureId} | Get single feature from centerline of canals with the attributes like the name, perenniality and current status of its use


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, category=category, perinlty=perinlty, name=name)

Get features from centerline of canals with the attributes like the name, perenniality and current status of its use
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from centerline of canals with the attributes like the name, perenniality and current status of its use
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, category=category, perinlty=perinlty, name=name)
        print("The response of CanalCenterlineInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CanalCenterlineInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from centerline of canals with the attributes like the name, perenniality and current status of its use
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CanalCenterlineInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CanalCenterlineInSirmaurApi->get_specific_feature: %s\n" % e)
```
