# openapi_client.ExtentOfSurfaceWaterVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ExtentOfSurfaceWaterVaranasiUPApi.md#get_features) | **GET** /collections/bfab0cfd-93ca-426e-8a2c-addd67e74b30/items | Get features from Geographical extent of surface water features with attributes in Varanasi, UP
[**get_specific_collection**](ExtentOfSurfaceWaterVaranasiUPApi.md#get_specific_collection) | **GET** /collections/bfab0cfd-93ca-426e-8a2c-addd67e74b30 | Metadata about Geographical extent of surface water features with attributes in Varanasi, UP
[**get_specific_feature**](ExtentOfSurfaceWaterVaranasiUPApi.md#get_specific_feature) | **GET** /collections/bfab0cfd-93ca-426e-8a2c-addd67e74b30/items/{featureId} | Get single feature from Geographical extent of surface water features with attributes in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, cat=cat, subcat_1=subcat_1)

Get features from Geographical extent of surface water features with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    subcat_1 = 'subcat_1_example' # str |  (optional)

    try:
        # Get features from Geographical extent of surface water features with attributes in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, cat=cat, subcat_1=subcat_1)
        print("The response of ExtentOfSurfaceWaterVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExtentOfSurfaceWaterVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Geographical extent of surface water features with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ExtentOfSurfaceWaterVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExtentOfSurfaceWaterVaranasiUPApi->get_specific_feature: %s\n" % e)
```
