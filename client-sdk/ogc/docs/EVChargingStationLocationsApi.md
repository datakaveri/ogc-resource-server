# openapi_client.EVChargingStationLocationsApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](EVChargingStationLocationsApi.md#get_features) | **GET** /collections/55833f68-fb1d-4123-b7b9-f55e83282c77/items | Get features from The physical coordinates of EV Charging Station Locations in Thiruvananthapuram City.
[**get_specific_collection**](EVChargingStationLocationsApi.md#get_specific_collection) | **GET** /collections/55833f68-fb1d-4123-b7b9-f55e83282c77 | Metadata about The physical coordinates of EV Charging Station Locations in Thiruvananthapuram City.
[**get_specific_feature**](EVChargingStationLocationsApi.md#get_specific_feature) | **GET** /collections/55833f68-fb1d-4123-b7b9-f55e83282c77/items/{featureId} | Get single feature from The physical coordinates of EV Charging Station Locations in Thiruvananthapuram City.
...
Get features from The physical coordinates of EV Charging Station Locations in Thiruvananthapuram City.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EVChargingStationLocationsApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EVChargingStationLocationsApi->get_features: %s\n" % e)
```
...
Get single feature from The physical coordinates of EV Charging Station Locations in Thiruvananthapuram City.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EVChargingStationLocationsApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EVChargingStationLocationsApi->get_specific_feature: %s\n" % e)
```
