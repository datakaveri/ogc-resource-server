# openapi_client.TourismInVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](TourismInVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/4a01ea26-7ad2-4c00-ae7b-f94b4539dbcc/items | Get features from Point locations of tourist attractions in Varanasi district of Uttar Pradesh
[**get_specific_collection**](TourismInVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/4a01ea26-7ad2-4c00-ae7b-f94b4539dbcc | Metadata about Point locations of tourist attractions in Varanasi district of Uttar Pradesh
[**get_specific_feature**](TourismInVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/4a01ea26-7ad2-4c00-ae7b-f94b4539dbcc/items/{featureId} | Get single feature from Point locations of tourist attractions in Varanasi district of Uttar Pradesh


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, name=name, tourism=tourism, name_en=name_en)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    tourism = 'tourism_example' # str |  (optional)
    name_en = 'name_en_example' # str |  (optional)

    try:
        # Get features from Point locations of tourist attractions in Varanasi district of Uttar Pradesh
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, name=name, tourism=tourism, name_en=name_en)
        print("The response of TourismInVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TourismInVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TourismInVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TourismInVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
