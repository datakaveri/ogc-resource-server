# openapi_client.ParcelAreasOfVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ParcelAreasOfVaranasiUPApi.md#get_features) | **GET** /collections/16a59ce2-ebf2-4931-8e2a-efe939b49678/items | Get features from Polygon features of parcel areas mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_collection**](ParcelAreasOfVaranasiUPApi.md#get_specific_collection) | **GET** /collections/16a59ce2-ebf2-4931-8e2a-efe939b49678 | Metadata about Polygon features of parcel areas mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_feature**](ParcelAreasOfVaranasiUPApi.md#get_specific_feature) | **GET** /collections/16a59ce2-ebf2-4931-8e2a-efe939b49678/items/{featureId} | Get single feature from Polygon features of parcel areas mapped under SVAMITVA scheme in Varanasi district, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, abr=abr, village_co=village_co)

Get features from Polygon features of parcel areas mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Polygon features of parcel areas mapped under SVAMITVA scheme in Varanasi district, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, abr=abr, village_co=village_co)
        print("The response of ParcelAreasOfVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ParcelAreasOfVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of parcel areas mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ParcelAreasOfVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ParcelAreasOfVaranasiUPApi->get_specific_feature: %s\n" % e)
```
