# openapi_client.WaterSupplyStoragePointsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterSupplyStoragePointsVaranasiUPApi.md#get_features) | **GET** /collections/654c1cad-0890-4b2d-afbb-ac4e258b1451/items | Get features from Point locations of water supply storage facilities in Varanasi, UP
[**get_specific_collection**](WaterSupplyStoragePointsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/654c1cad-0890-4b2d-afbb-ac4e258b1451 | Metadata about Point locations of water supply storage facilities in Varanasi, UP
[**get_specific_feature**](WaterSupplyStoragePointsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/654c1cad-0890-4b2d-afbb-ac4e258b1451/items/{featureId} | Get single feature from Point locations of water supply storage facilities in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category)

Get features from Point locations of water supply storage facilities in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Point locations of water supply storage facilities in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category)
        print("The response of WaterSupplyStoragePointsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterSupplyStoragePointsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of water supply storage facilities in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterSupplyStoragePointsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterSupplyStoragePointsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
