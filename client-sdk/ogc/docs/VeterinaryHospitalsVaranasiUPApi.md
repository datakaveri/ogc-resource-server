# openapi_client.VeterinaryHospitalsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](VeterinaryHospitalsVaranasiUPApi.md#get_features) | **GET** /collections/82b08407-b69e-41cd-b432-597f7bcf59da/items | Get features from Locations of veterinary hospitals in Varanasi, UP
[**get_specific_collection**](VeterinaryHospitalsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/82b08407-b69e-41cd-b432-597f7bcf59da | Metadata about Locations of veterinary hospitals in Varanasi, UP
[**get_specific_feature**](VeterinaryHospitalsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/82b08407-b69e-41cd-b432-597f7bcf59da/items/{featureId} | Get single feature from Locations of veterinary hospitals in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, loc_name=loc_name, photograph=photograph, svy_date=svy_date, gmrotation=gmrotation, addl_info=addl_info, type_1=type_1, unique_id=unique_id, type=type, name=name)

Get features from Locations of veterinary hospitals in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    orig_fid = 56 # int |  (optional)
    loc_name = 'loc_name_example' # str |  (optional)
    photograph = 'photograph_example' # str |  (optional)
    svy_date = 'svy_date_example' # str |  (optional)
    gmrotation = 3.4 # float |  (optional)
    ...
    try:
        # Get features from Locations of veterinary hospitals in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, loc_name=loc_name, photograph=photograph, svy_date=svy_date, gmrotation=gmrotation, addl_info=addl_info, type_1=type_1, unique_id=unique_id, type=type, name=name)
        print("The response of VeterinaryHospitalsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VeterinaryHospitalsVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **orig_fid** | **int**|  | [optional] 
 **loc_name** | **str**|  | [optional] 
 **photograph** | **str**|  | [optional] 
 **svy_date** | **str**|  | [optional] 
 **gmrotation** | **float**|  | [optional] 
...
Get single feature from Locations of veterinary hospitals in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VeterinaryHospitalsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VeterinaryHospitalsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
