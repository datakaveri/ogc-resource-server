...
------------- | ------------- | -------------
[**get_features**](NearRealtimeForestFireMonitoringVizianagaramApi.md#get_features) | **GET** /collections/f64db089-c3c6-4bdd-87a4-2af8d2104c3b/items | Get features from Extent of forest fire hotspots identified through near real-time monitoring systems
[**get_specific_collection**](NearRealtimeForestFireMonitoringVizianagaramApi.md#get_specific_collection) | **GET** /collections/f64db089-c3c6-4bdd-87a4-2af8d2104c3b | Metadata about Extent of forest fire hotspots identified through near real-time monitoring systems
[**get_specific_feature**](NearRealtimeForestFireMonitoringVizianagaramApi.md#get_specific_feature) | **GET** /collections/f64db089-c3c6-4bdd-87a4-2af8d2104c3b/items/{featureId} | Get single feature from Extent of forest fire hotspots identified through near real-time monitoring systems
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NearRealtimeForestFireMonitoringVizianagaramApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NearRealtimeForestFireMonitoringVizianagaramApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NearRealtimeForestFireMonitoringVizianagaramApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NearRealtimeForestFireMonitoringVizianagaramApi->get_specific_feature: %s\n" % e)
```
