# openapi_client.ZoneBoundariesOfBBMPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ZoneBoundariesOfBBMPApi.md#get_features) | **GET** /collections/af12af3d-12fb-42a6-aedb-551ed324d931/items | Get features from Polygon boundary of the zones in Bruhat Bengaluru Mahanagara Palike (BBMP)
[**get_specific_collection**](ZoneBoundariesOfBBMPApi.md#get_specific_collection) | **GET** /collections/af12af3d-12fb-42a6-aedb-551ed324d931 | Metadata about Polygon boundary of the zones in Bruhat Bengaluru Mahanagara Palike (BBMP)
[**get_specific_feature**](ZoneBoundariesOfBBMPApi.md#get_specific_feature) | **GET** /collections/af12af3d-12fb-42a6-aedb-551ed324d931/items/{featureId} | Get single feature from Polygon boundary of the zones in Bruhat Bengaluru Mahanagara Palike (BBMP)


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bbmp_zone=bbmp_zone, xlat=xlat, xlong=xlong)

Get features from Polygon boundary of the zones in Bruhat Bengaluru Mahanagara Palike (BBMP)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    bbmp_zone = 'bbmp_zone_example' # str |  (optional)
    xlat = 3.4 # float |  (optional)
    xlong = 3.4 # float |  (optional)

    try:
        # Get features from Polygon boundary of the zones in Bruhat Bengaluru Mahanagara Palike (BBMP)
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bbmp_zone=bbmp_zone, xlat=xlat, xlong=xlong)
        print("The response of ZoneBoundariesOfBBMPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ZoneBoundariesOfBBMPApi->get_features: %s\n" % e)
```
 ...
 **bbmp_zone** | **str**|  | [optional] 
 **xlat** | **float**|  | [optional] 
 **xlong** | **float**|  | [optional] 
...
Get single feature from Polygon boundary of the zones in Bruhat Bengaluru Mahanagara Palike (BBMP)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ZoneBoundariesOfBBMPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ZoneBoundariesOfBBMPApi->get_specific_feature: %s\n" % e)
```
