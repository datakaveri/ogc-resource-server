# openapi_client.OtherBuiltupPointStructuresVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](OtherBuiltupPointStructuresVaranasiUPApi.md#get_features) | **GET** /collections/34f997f2-ca15-4919-b07e-26ac4524394d/items | Get features from Point locations of other builtup structures in Varanasi, UP
[**get_specific_collection**](OtherBuiltupPointStructuresVaranasiUPApi.md#get_specific_collection) | **GET** /collections/34f997f2-ca15-4919-b07e-26ac4524394d | Metadata about Point locations of other builtup structures in Varanasi, UP
[**get_specific_feature**](OtherBuiltupPointStructuresVaranasiUPApi.md#get_specific_feature) | **GET** /collections/34f997f2-ca15-4919-b07e-26ac4524394d/items/{featureId} | Get single feature from Point locations of other builtup structures in Varanasi, UP
...
Get features from Point locations of other builtup structures in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OtherBuiltupPointStructuresVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherBuiltupPointStructuresVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of other builtup structures in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OtherBuiltupPointStructuresVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherBuiltupPointStructuresVaranasiUPApi->get_specific_feature: %s\n" % e)
```
