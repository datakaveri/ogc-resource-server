# openapi_client.PredictedLandwardCoastalErosion2035Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PredictedLandwardCoastalErosion2035Api.md#get_features) | **GET** /collections/96d3acf3-bd8f-4095-8e12-830a3d6c4572/items | Get features from Landward coastal erosion predicted for 2035 for coastline from Rasthakaadu Beach to Panjal Beach
[**get_specific_collection**](PredictedLandwardCoastalErosion2035Api.md#get_specific_collection) | **GET** /collections/96d3acf3-bd8f-4095-8e12-830a3d6c4572 | Metadata about Landward coastal erosion predicted for 2035 for coastline from Rasthakaadu Beach to Panjal Beach
[**get_specific_feature**](PredictedLandwardCoastalErosion2035Api.md#get_specific_feature) | **GET** /collections/96d3acf3-bd8f-4095-8e12-830a3d6c4572/items/{featureId} | Get single feature from Landward coastal erosion predicted for 2035 for coastline from Rasthakaadu Beach to Panjal Beach


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, forecast_y=forecast_y)

Get features from Landward coastal erosion predicted for 2035 for coastline from Rasthakaadu Beach to Panjal Beach
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    forecast_y = 56 # int |  (optional)

    try:
        # Get features from Landward coastal erosion predicted for 2035 for coastline from Rasthakaadu Beach to Panjal Beach
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, forecast_y=forecast_y)
        print("The response of PredictedLandwardCoastalErosion2035Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PredictedLandwardCoastalErosion2035Api->get_features: %s\n" % e)
```
...
Get single feature from Landward coastal erosion predicted for 2035 for coastline from Rasthakaadu Beach to Panjal Beach
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PredictedLandwardCoastalErosion2035Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PredictedLandwardCoastalErosion2035Api->get_specific_feature: %s\n" % e)
```
