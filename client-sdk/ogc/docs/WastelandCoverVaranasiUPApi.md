# openapi_client.WastelandCoverVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WastelandCoverVaranasiUPApi.md#get_features) | **GET** /collections/96180c26-ffa3-4b37-b53e-8f3db3aaaba5/items | Get features from Spatial extent of the wasteland covers in Varanasi, UP
[**get_specific_collection**](WastelandCoverVaranasiUPApi.md#get_specific_collection) | **GET** /collections/96180c26-ffa3-4b37-b53e-8f3db3aaaba5 | Metadata about Spatial extent of the wasteland covers in Varanasi, UP
[**get_specific_feature**](WastelandCoverVaranasiUPApi.md#get_specific_feature) | **GET** /collections/96180c26-ffa3-4b37-b53e-8f3db3aaaba5/items/{featureId} | Get single feature from Spatial extent of the wasteland covers in Varanasi, UP
...
Get features from Spatial extent of the wasteland covers in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WastelandCoverVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WastelandCoverVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Spatial extent of the wasteland covers in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WastelandCoverVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WastelandCoverVaranasiUPApi->get_specific_feature: %s\n" % e)
```
