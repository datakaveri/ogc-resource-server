# openapi_client.SchoolLocationsGurugramHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SchoolLocationsGurugramHaryanaApi.md#get_features) | **GET** /collections/bdc51125-1361-4505-9518-9d08b83796aa/items | Get features from Point features of schools in Gurugram District, Haryana
[**get_specific_collection**](SchoolLocationsGurugramHaryanaApi.md#get_specific_collection) | **GET** /collections/bdc51125-1361-4505-9518-9d08b83796aa | Metadata about Point features of schools in Gurugram District, Haryana
[**get_specific_feature**](SchoolLocationsGurugramHaryanaApi.md#get_specific_feature) | **GET** /collections/bdc51125-1361-4505-9518-9d08b83796aa/items/{featureId} | Get single feature from Point features of schools in Gurugram District, Haryana


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, block_lgd=block_lgd, school_cat=school_cat, dtname=dtname, latitude=latitude, schname=schname, block_name=block_name, management=management, vilname=vilname, subdt_lgd=subdt_lgd, state_lgd=state_lgd, schcd=schcd, dist_lgd=dist_lgd, gp_code=gp_code, vilcode11=vilcode11, gp_name=gp_name, stname=stname, longitude=longitude)

Get features from Point features of schools in Gurugram District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SchoolLocationsGurugramHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchoolLocationsGurugramHaryanaApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of schools in Gurugram District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SchoolLocationsGurugramHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchoolLocationsGurugramHaryanaApi->get_specific_feature: %s\n" % e)
```
