# openapi_client.AdministrativeBoundaryPillarVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](AdministrativeBoundaryPillarVaranasiUPApi.md#get_features) | **GET** /collections/2efa4b0a-add5-4cd7-b0f1-11de1496cfca/items | Get features from Point features of administrative boundary pillars in Varanasi, UP
[**get_specific_collection**](AdministrativeBoundaryPillarVaranasiUPApi.md#get_specific_collection) | **GET** /collections/2efa4b0a-add5-4cd7-b0f1-11de1496cfca | Metadata about Point features of administrative boundary pillars in Varanasi, UP
[**get_specific_feature**](AdministrativeBoundaryPillarVaranasiUPApi.md#get_specific_feature) | **GET** /collections/2efa4b0a-add5-4cd7-b0f1-11de1496cfca/items/{featureId} | Get single feature from Point features of administrative boundary pillars in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, cat=cat, c_mtrl=c_mtrl)

Get features from Point features of administrative boundary pillars in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Point features of administrative boundary pillars in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, cat=cat, c_mtrl=c_mtrl)
        print("The response of AdministrativeBoundaryPillarVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AdministrativeBoundaryPillarVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of administrative boundary pillars in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AdministrativeBoundaryPillarVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AdministrativeBoundaryPillarVaranasiUPApi->get_specific_feature: %s\n" % e)
```
