# openapi_client.WaterbodyPolygonFeaturesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterbodyPolygonFeaturesVaranasiUPApi.md#get_features) | **GET** /collections/cbca2b4a-bc22-4592-9e13-8e15e8116599/items | Get features from Polygon features of waterbodies in Varanasi, UP
[**get_specific_collection**](WaterbodyPolygonFeaturesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/cbca2b4a-bc22-4592-9e13-8e15e8116599 | Metadata about Polygon features of waterbodies in Varanasi, UP
[**get_specific_feature**](WaterbodyPolygonFeaturesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/cbca2b4a-bc22-4592-9e13-8e15e8116599/items/{featureId} | Get single feature from Polygon features of waterbodies in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, origin=origin, adl_info=adl_info, category=category, covered=covered, perinlty=perinlty, name=name)

Get features from Polygon features of waterbodies in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.WaterbodyPolygonFeaturesVaranasiUPApi(api_client)
    ...
    covered = 'covered_example' # str |  (optional)
    perinlty = 'perinlty_example' # str |  (optional)
    name = 'name_example' # str |  (optional)

    try:
        # Get features from Polygon features of waterbodies in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, origin=origin, adl_info=adl_info, category=category, covered=covered, perinlty=perinlty, name=name)
        print("The response of WaterbodyPolygonFeaturesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodyPolygonFeaturesVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **bdry_typ** | **str**|  | [optional] 
 **origin** | **str**|  | [optional] 
 **adl_info** | **str**|  | [optional] 
 **category** | **str**|  | [optional] 
 **covered** | **str**|  | [optional] 
...
Metadata about Polygon features of waterbodies in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterbodyPolygonFeaturesVaranasiUPApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodyPolygonFeaturesVaranasiUPApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from Polygon features of waterbodies in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterbodyPolygonFeaturesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodyPolygonFeaturesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
