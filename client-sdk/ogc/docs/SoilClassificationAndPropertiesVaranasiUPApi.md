...
------------- | ------------- | -------------
[**get_features**](SoilClassificationAndPropertiesVaranasiUPApi.md#get_features) | **GET** /collections/159c3e61-8a8d-4193-904b-327fc60ea1b7/items | Get features from Polygon layer describing soil classification and properties in Varanasi, Uttar Pradesh
[**get_specific_collection**](SoilClassificationAndPropertiesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/159c3e61-8a8d-4193-904b-327fc60ea1b7 | Metadata about Polygon layer describing soil classification and properties in Varanasi, Uttar Pradesh
[**get_specific_feature**](SoilClassificationAndPropertiesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/159c3e61-8a8d-4193-904b-327fc60ea1b7/items/{featureId} | Get single feature from Polygon layer describing soil classification and properties in Varanasi, Uttar Pradesh


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, order_=order_, series=series, family_tex=family_tex, sb_order=sb_order, gr_group=gr_group, sb_group=sb_group, family_tem=family_tem, family_min=family_min)

Get features from Polygon layer describing soil classification and properties in Varanasi, Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    order_ = 'order__example' # str |  (optional)
    series = 'series_example' # str |  (optional)
    family_tex = 'family_tex_example' # str |  (optional)
    sb_order = 'sb_order_example' # str |  (optional)
    gr_group = 'gr_group_example' # str |  (optional)
    sb_group = 'sb_group_example' # str |  (optional)
    family_tem = 'family_tem_example' # str |  (optional)
    family_min = 'family_min_example' # str |  (optional)

    try:
        # Get features from Polygon layer describing soil classification and properties in Varanasi, Uttar Pradesh
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, order_=order_, series=series, family_tex=family_tex, sb_order=sb_order, gr_group=gr_group, sb_group=sb_group, family_tem=family_tem, family_min=family_min)
        print("The response of SoilClassificationAndPropertiesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilClassificationAndPropertiesVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **order_** | **str**|  | [optional] 
 **series** | **str**|  | [optional] 
 **family_tex** | **str**|  | [optional] 
 **sb_order** | **str**|  | [optional] 
 **gr_group** | **str**|  | [optional] 
 **sb_group** | **str**|  | [optional] 
 **family_tem** | **str**|  | [optional] 
 **family_min** | **str**|  | [optional] 
...
Get single feature from Polygon layer describing soil classification and properties in Varanasi, Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilClassificationAndPropertiesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilClassificationAndPropertiesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
