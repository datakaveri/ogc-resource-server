# openapi_client.VehicleParkingFacilityLocationsInChandigarhApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](VehicleParkingFacilityLocationsInChandigarhApi.md#get_features) | **GET** /collections/2ec430e7-b3e0-4b65-99f1-e7cea969a129/items | Get features from Location information of the vehicle parking facilities in Chandigarh city.
[**get_specific_collection**](VehicleParkingFacilityLocationsInChandigarhApi.md#get_specific_collection) | **GET** /collections/2ec430e7-b3e0-4b65-99f1-e7cea969a129 | Metadata about Location information of the vehicle parking facilities in Chandigarh city.
[**get_specific_feature**](VehicleParkingFacilityLocationsInChandigarhApi.md#get_specific_feature) | **GET** /collections/2ec430e7-b3e0-4b65-99f1-e7cea969a129/items/{featureId} | Get single feature from Location information of the vehicle parking facilities in Chandigarh city.


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, address=address, name=name)

Get features from Location information of the vehicle parking facilities in Chandigarh city.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Location information of the vehicle parking facilities in Chandigarh city.
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, address=address, name=name)
        print("The response of VehicleParkingFacilityLocationsInChandigarhApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VehicleParkingFacilityLocationsInChandigarhApi->get_features: %s\n" % e)
```
...
Get single feature from Location information of the vehicle parking facilities in Chandigarh city.
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VehicleParkingFacilityLocationsInChandigarhApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VehicleParkingFacilityLocationsInChandigarhApi->get_specific_feature: %s\n" % e)
```
