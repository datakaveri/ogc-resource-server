# openapi_client.PoliceEstablishmentsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PoliceEstablishmentsVaranasiUPApi.md#get_features) | **GET** /collections/10ff49bf-34aa-4c67-a21a-831279d1b3ff/items | Get features from Point locations of police establishments in Varanasi, UP
[**get_specific_collection**](PoliceEstablishmentsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/10ff49bf-34aa-4c67-a21a-831279d1b3ff | Metadata about Point locations of police establishments in Varanasi, UP
[**get_specific_feature**](PoliceEstablishmentsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/10ff49bf-34aa-4c67-a21a-831279d1b3ff/items/{featureId} | Get single feature from Point locations of police establishments in Varanasi, UP
...
Get features from Point locations of police establishments in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PoliceEstablishmentsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PoliceEstablishmentsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of police establishments in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PoliceEstablishmentsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PoliceEstablishmentsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
