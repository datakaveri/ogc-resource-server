# openapi_client.GaothanBoundaryOfVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](GaothanBoundaryOfVaranasiUPApi.md#get_features) | **GET** /collections/4c068097-ed64-4206-ac6d-d605aee170f8/items | Get features from Polygon features of Gaothan boundaries mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_collection**](GaothanBoundaryOfVaranasiUPApi.md#get_specific_collection) | **GET** /collections/4c068097-ed64-4206-ac6d-d605aee170f8 | Metadata about Polygon features of Gaothan boundaries mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_feature**](GaothanBoundaryOfVaranasiUPApi.md#get_specific_feature) | **GET** /collections/4c068097-ed64-4206-ac6d-d605aee170f8/items/{featureId} | Get single feature from Polygon features of Gaothan boundaries mapped under SVAMITVA scheme in Varanasi district, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)

Get features from Polygon features of Gaothan boundaries mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GaothanBoundaryOfVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GaothanBoundaryOfVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of Gaothan boundaries mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of GaothanBoundaryOfVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GaothanBoundaryOfVaranasiUPApi->get_specific_feature: %s\n" % e)
```
