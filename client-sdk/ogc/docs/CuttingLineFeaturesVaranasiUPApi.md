# openapi_client.CuttingLineFeaturesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CuttingLineFeaturesVaranasiUPApi.md#get_features) | **GET** /collections/35bd6d50-704e-4993-851d-b19e0a2abdb4/items | Get features from Cutting line features in Varanasi, UP
[**get_specific_collection**](CuttingLineFeaturesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/35bd6d50-704e-4993-851d-b19e0a2abdb4 | Metadata about Cutting line features in Varanasi, UP
[**get_specific_feature**](CuttingLineFeaturesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/35bd6d50-704e-4993-851d-b19e0a2abdb4/items/{featureId} | Get single feature from Cutting line features in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, slope_at=slope_at)

Get features from Cutting line features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Cutting line features in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, slope_at=slope_at)
        print("The response of CuttingLineFeaturesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CuttingLineFeaturesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Cutting line features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CuttingLineFeaturesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CuttingLineFeaturesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
