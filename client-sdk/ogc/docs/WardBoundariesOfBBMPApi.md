# openapi_client.WardBoundariesOfBBMPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WardBoundariesOfBBMPApi.md#get_features) | **GET** /collections/1e4b8698-a880-4a2e-a4a0-d692bc4a5988/items | Get features from Polygon boundary of the wards in Bruhat Bengaluru Mahanagara Palike (BBMP)
[**get_specific_collection**](WardBoundariesOfBBMPApi.md#get_specific_collection) | **GET** /collections/1e4b8698-a880-4a2e-a4a0-d692bc4a5988 | Metadata about Polygon boundary of the wards in Bruhat Bengaluru Mahanagara Palike (BBMP)
[**get_specific_feature**](WardBoundariesOfBBMPApi.md#get_specific_feature) | **GET** /collections/1e4b8698-a880-4a2e-a4a0-d692bc4a5988/items/{featureId} | Get single feature from Polygon boundary of the wards in Bruhat Bengaluru Mahanagara Palike (BBMP)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    ass_const_ = 'ass_const__example' # str |  (optional)
    pop_m = 3.4 # float |  (optional)
    pop_f = 3.4 # float |  (optional)
    ...
    try:
        ...
        print("Exception when calling WardBoundariesOfBBMPApi->get_features: %s\n" % e)
```
 ...
 **ass_const_** | **str**|  | [optional] 
 **pop_m** | **float**|  | [optional] 
 **pop_f** | **float**|  | [optional] 
...
Get single feature from Polygon boundary of the wards in Bruhat Bengaluru Mahanagara Palike (BBMP)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WardBoundariesOfBBMPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WardBoundariesOfBBMPApi->get_specific_feature: %s\n" % e)
```
