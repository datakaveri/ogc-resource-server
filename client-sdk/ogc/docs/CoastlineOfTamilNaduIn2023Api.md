# openapi_client.CoastlineOfTamilNaduIn2023Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CoastlineOfTamilNaduIn2023Api.md#get_features) | **GET** /collections/589a907d-c945-4b71-b4e8-4449f8a8eac5/items | Get features from Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2023
[**get_specific_collection**](CoastlineOfTamilNaduIn2023Api.md#get_specific_collection) | **GET** /collections/589a907d-c945-4b71-b4e8-4449f8a8eac5 | Metadata about Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2023
[**get_specific_feature**](CoastlineOfTamilNaduIn2023Api.md#get_specific_feature) | **GET** /collections/589a907d-c945-4b71-b4e8-4449f8a8eac5/items/{featureId} | Get single feature from Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2023


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, layer=layer)

Get features from Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2023
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CoastlineOfTamilNaduIn2023Api(api_client)
    ...
    layer = 'layer_example' # str |  (optional)

    try:
        # Get features from Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2023
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, layer=layer)
        print("The response of CoastlineOfTamilNaduIn2023Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoastlineOfTamilNaduIn2023Api->get_features: %s\n" % e)
```
...
Metadata about Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2023
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CoastlineOfTamilNaduIn2023Api->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoastlineOfTamilNaduIn2023Api->get_specific_collection: %s\n" % e)
```
...
Get single feature from Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2023
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CoastlineOfTamilNaduIn2023Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoastlineOfTamilNaduIn2023Api->get_specific_feature: %s\n" % e)
```
