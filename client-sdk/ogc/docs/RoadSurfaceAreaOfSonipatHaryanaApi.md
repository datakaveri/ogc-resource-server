# openapi_client.RoadSurfaceAreaOfSonipatHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RoadSurfaceAreaOfSonipatHaryanaApi.md#get_features) | **GET** /collections/5245a011-d73a-426e-bc70-eaf41e5bc128/items | Get features from Road polygons mapped under SVAMITVA scheme in Sonipat, Haryana
[**get_specific_collection**](RoadSurfaceAreaOfSonipatHaryanaApi.md#get_specific_collection) | **GET** /collections/5245a011-d73a-426e-bc70-eaf41e5bc128 | Metadata about Road polygons mapped under SVAMITVA scheme in Sonipat, Haryana
[**get_specific_feature**](RoadSurfaceAreaOfSonipatHaryanaApi.md#get_specific_feature) | **GET** /collections/5245a011-d73a-426e-bc70-eaf41e5bc128/items/{featureId} | Get single feature from Road polygons mapped under SVAMITVA scheme in Sonipat, Haryana


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, state_code=state_code, shape_leng=shape_leng, village_co=village_co, tehsil_cod=tehsil_cod, road_id=road_id, block_code=block_code, area_geode=area_geode, village_na=village_na, lgd_code=lgd_code, district_c=district_c)

Get features from Road polygons mapped under SVAMITVA scheme in Sonipat, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    road_id = 'road_id_example' # str |  (optional)
    block_code = 'block_code_example' # str |  (optional)
    area_geode = 'area_geode_example' # str |  (optional)
    ...
    try:
        # Get features from Road polygons mapped under SVAMITVA scheme in Sonipat, Haryana
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, state_code=state_code, shape_leng=shape_leng, village_co=village_co, tehsil_cod=tehsil_cod, road_id=road_id, block_code=block_code, area_geode=area_geode, village_na=village_na, lgd_code=lgd_code, district_c=district_c)
        print("The response of RoadSurfaceAreaOfSonipatHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadSurfaceAreaOfSonipatHaryanaApi->get_features: %s\n" % e)
```
...
Get single feature from Road polygons mapped under SVAMITVA scheme in Sonipat, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadSurfaceAreaOfSonipatHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadSurfaceAreaOfSonipatHaryanaApi->get_specific_feature: %s\n" % e)
```
