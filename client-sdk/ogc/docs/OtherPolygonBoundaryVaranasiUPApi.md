# openapi_client.OtherPolygonBoundaryVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](OtherPolygonBoundaryVaranasiUPApi.md#get_features) | **GET** /collections/8537eec8-0e3e-4f66-b229-a5fca8bbe9ef/items | Get features from Polygon boundary features demarcating the tribal area, locality, urban areas etc. in Varanasi, UP
[**get_specific_collection**](OtherPolygonBoundaryVaranasiUPApi.md#get_specific_collection) | **GET** /collections/8537eec8-0e3e-4f66-b229-a5fca8bbe9ef | Metadata about Polygon boundary features demarcating the tribal area, locality, urban areas etc. in Varanasi, UP
[**get_specific_feature**](OtherPolygonBoundaryVaranasiUPApi.md#get_specific_feature) | **GET** /collections/8537eec8-0e3e-4f66-b229-a5fca8bbe9ef/items/{featureId} | Get single feature from Polygon boundary features demarcating the tribal area, locality, urban areas etc. in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, cat=cat)

Get features from Polygon boundary features demarcating the tribal area, locality, urban areas etc. in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Polygon boundary features demarcating the tribal area, locality, urban areas etc. in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, cat=cat)
        print("The response of OtherPolygonBoundaryVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherPolygonBoundaryVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon boundary features demarcating the tribal area, locality, urban areas etc. in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OtherPolygonBoundaryVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherPolygonBoundaryVaranasiUPApi->get_specific_feature: %s\n" % e)
```
