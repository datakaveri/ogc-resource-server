# openapi_client.PerennialStreamsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PerennialStreamsVaranasiUPApi.md#get_features) | **GET** /collections/68661db4-2cf4-40f7-9970-de01b974adb1/items | Get features from Line features representing perennial streams in in Varanasi, UP
[**get_specific_collection**](PerennialStreamsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/68661db4-2cf4-40f7-9970-de01b974adb1 | Metadata about Line features representing perennial streams in in Varanasi, UP
[**get_specific_feature**](PerennialStreamsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/68661db4-2cf4-40f7-9970-de01b974adb1/items/{featureId} | Get single feature from Line features representing perennial streams in in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, name=name)

Get features from Line features representing perennial streams in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Line features representing perennial streams in in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, name=name)
        print("The response of PerennialStreamsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PerennialStreamsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing perennial streams in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PerennialStreamsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PerennialStreamsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
