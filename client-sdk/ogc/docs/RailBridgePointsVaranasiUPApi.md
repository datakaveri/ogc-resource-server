# openapi_client.RailBridgePointsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RailBridgePointsVaranasiUPApi.md#get_features) | **GET** /collections/99a3611f-ab7d-4cae-ba1a-55b3133d23da/items | Get features from Point locations of rail bridges in Varanasi, UP
[**get_specific_collection**](RailBridgePointsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/99a3611f-ab7d-4cae-ba1a-55b3133d23da | Metadata about Point locations of rail bridges in Varanasi, UP
[**get_specific_feature**](RailBridgePointsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/99a3611f-ab7d-4cae-ba1a-55b3133d23da/items/{featureId} | Get single feature from Point locations of rail bridges in Varanasi, UP
...
Get features from Point locations of rail bridges in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailBridgePointsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailBridgePointsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of rail bridges in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailBridgePointsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailBridgePointsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
