# openapi_client.WaterbodyPointFeaturesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterbodyPointFeaturesVaranasiUPApi.md#get_features) | **GET** /collections/8ac40e3a-b7b5-479b-8d01-7566dc7ddbff/items | Get features from Point locations of waterbodies and its attributes in Varanasi, UP
[**get_specific_collection**](WaterbodyPointFeaturesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/8ac40e3a-b7b5-479b-8d01-7566dc7ddbff | Metadata about Point locations of waterbodies and its attributes in Varanasi, UP
[**get_specific_feature**](WaterbodyPointFeaturesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/8ac40e3a-b7b5-479b-8d01-7566dc7ddbff/items/{featureId} | Get single feature from Point locations of waterbodies and its attributes in Varanasi, UP
...
Get features from Point locations of waterbodies and its attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterbodyPointFeaturesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodyPointFeaturesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of waterbodies and its attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterbodyPointFeaturesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodyPointFeaturesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
