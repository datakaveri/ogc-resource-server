# openapi_client.RevenueLineFeaturesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RevenueLineFeaturesVaranasiUPApi.md#get_features) | **GET** /collections/3a2a75c3-677e-44b0-a317-461d1bfafc87/items | Get features from Revenue line features in Varanasi, UP
[**get_specific_collection**](RevenueLineFeaturesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/3a2a75c3-677e-44b0-a317-461d1bfafc87 | Metadata about Revenue line features in Varanasi, UP
[**get_specific_feature**](RevenueLineFeaturesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/3a2a75c3-677e-44b0-a317-461d1bfafc87/items/{featureId} | Get single feature from Revenue line features in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, dist_twn_c=dist_twn_c, district=district, dist_sub_c=dist_sub_c, tahsil=tahsil, village_co=village_co, devlopment=devlopment, pargana=pargana, layers=layers)

Get features from Revenue line features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    layers = 'layers_example' # str |  (optional)

    try:
        # Get features from Revenue line features in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, dist_twn_c=dist_twn_c, district=district, dist_sub_c=dist_sub_c, tahsil=tahsil, village_co=village_co, devlopment=devlopment, pargana=pargana, layers=layers)
        print("The response of RevenueLineFeaturesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RevenueLineFeaturesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Revenue line features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RevenueLineFeaturesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RevenueLineFeaturesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
