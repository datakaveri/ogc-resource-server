# openapi_client.EmbankmentLineVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](EmbankmentLineVaranasiUPApi.md#get_features) | **GET** /collections/f34dea0b-cdc0-49c1-a522-ec2721e51a98/items | Get features from Embankment line features in Varanasi, UP
[**get_specific_collection**](EmbankmentLineVaranasiUPApi.md#get_specific_collection) | **GET** /collections/f34dea0b-cdc0-49c1-a522-ec2721e51a98 | Metadata about Embankment line features in Varanasi, UP
[**get_specific_feature**](EmbankmentLineVaranasiUPApi.md#get_specific_feature) | **GET** /collections/f34dea0b-cdc0-49c1-a522-ec2721e51a98/items/{featureId} | Get single feature from Embankment line features in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, slope_at=slope_at, adl_info=adl_info, category=category, af_cat=af_cat)

Get features from Embankment line features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Embankment line features in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, slope_at=slope_at, adl_info=adl_info, category=category, af_cat=af_cat)
        print("The response of EmbankmentLineVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentLineVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Embankment line features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EmbankmentLineVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentLineVaranasiUPApi->get_specific_feature: %s\n" % e)
```
