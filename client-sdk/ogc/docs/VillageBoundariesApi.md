...
------------- | ------------- | -------------
[**get_features**](VillageBoundariesApi.md#get_features) | **GET** /collections/13baecee-483b-4001-a199-de3a5ea072c8/items | Get features from Village level administrative boundaries except for TN,AP,TG,LA,JK,RJ,AR,SK,ML,TR,MZ,MN,NL
[**get_specific_collection**](VillageBoundariesApi.md#get_specific_collection) | **GET** /collections/13baecee-483b-4001-a199-de3a5ea072c8 | Metadata about Village level administrative boundaries except for TN,AP,TG,LA,JK,RJ,AR,SK,ML,TR,MZ,MN,NL
[**get_specific_feature**](VillageBoundariesApi.md#get_specific_feature) | **GET** /collections/13baecee-483b-4001-a199-de3a5ea072c8/items/{featureId} | Get single feature from Village level administrative boundaries except for TN,AP,TG,LA,JK,RJ,AR,SK,ML,TR,MZ,MN,NL


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, soi_name=soi_name, remarks=remarks, state=state, tehsil=tehsil)

Get features from Village level administrative boundaries except for TN,AP,TG,LA,JK,RJ,AR,SK,ML,TR,MZ,MN,NL
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Village level administrative boundaries except for TN,AP,TG,LA,JK,RJ,AR,SK,ML,TR,MZ,MN,NL
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, soi_name=soi_name, remarks=remarks, state=state, tehsil=tehsil)
        print("The response of VillageBoundariesApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VillageBoundariesApi->get_features: %s\n" % e)
```
...
Get single feature from Village level administrative boundaries except for TN,AP,TG,LA,JK,RJ,AR,SK,ML,TR,MZ,MN,NL
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VillageBoundariesApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VillageBoundariesApi->get_specific_feature: %s\n" % e)
```
