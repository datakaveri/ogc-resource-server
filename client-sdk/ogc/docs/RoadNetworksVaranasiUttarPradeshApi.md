# openapi_client.RoadNetworksVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RoadNetworksVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/5ad87747-01d8-4d71-988b-cddaa4b191db/items | Get features from Line features of road networks in Varanasi district of Uttar Pradesh along with attributes
[**get_specific_collection**](RoadNetworksVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/5ad87747-01d8-4d71-988b-cddaa4b191db | Metadata about Line features of road networks in Varanasi district of Uttar Pradesh along with attributes
[**get_specific_feature**](RoadNetworksVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/5ad87747-01d8-4d71-988b-cddaa4b191db/items/{featureId} | Get single feature from Line features of road networks in Varanasi district of Uttar Pradesh along with attributes


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, ministry_n=ministry_n, dtcode=dtcode, stcode11=stcode11, type=type, stname=stname)

Get features from Line features of road networks in Varanasi district of Uttar Pradesh along with attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    ministry_n = 'ministry_n_example' # str |  (optional)
    dtcode = 'dtcode_example' # str |  (optional)
    stcode11 = 'stcode11_example' # str |  (optional)
    type = 'type_example' # str |  (optional)
    stname = 'stname_example' # str |  (optional)

    try:
        # Get features from Line features of road networks in Varanasi district of Uttar Pradesh along with attributes
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, ministry_n=ministry_n, dtcode=dtcode, stcode11=stcode11, type=type, stname=stname)
        print("The response of RoadNetworksVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadNetworksVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
 ...
 **ministry_n** | **str**|  | [optional] 
 **dtcode** | **str**|  | [optional] 
 **stcode11** | **str**|  | [optional] 
 **type** | **str**|  | [optional] 
 **stname** | **str**|  | [optional] 
...
Get single feature from Line features of road networks in Varanasi district of Uttar Pradesh along with attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadNetworksVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadNetworksVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
