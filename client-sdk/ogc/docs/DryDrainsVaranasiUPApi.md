# openapi_client.DryDrainsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DryDrainsVaranasiUPApi.md#get_features) | **GET** /collections/4603a41c-d042-46d2-8bbd-34208ed60cba/items | Get features from Line features representing dry drains in Varanasi, UP
[**get_specific_collection**](DryDrainsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/4603a41c-d042-46d2-8bbd-34208ed60cba | Metadata about Line features representing dry drains in Varanasi, UP
[**get_specific_feature**](DryDrainsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/4603a41c-d042-46d2-8bbd-34208ed60cba/items/{featureId} | Get single feature from Line features representing dry drains in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, drain_name=drain_name)

Get features from Line features representing dry drains in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    drain_name = 'drain_name_example' # str |  (optional)

    try:
        # Get features from Line features representing dry drains in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, drain_name=drain_name)
        print("The response of DryDrainsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DryDrainsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing dry drains in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DryDrainsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DryDrainsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
