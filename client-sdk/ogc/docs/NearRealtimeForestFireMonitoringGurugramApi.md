# openapi_client.NearRealtimeForestFireMonitoringGurugramApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](NearRealtimeForestFireMonitoringGurugramApi.md#get_features) | **GET** /collections/ac9b9d04-9143-4542-b885-b46da137ec88/items | Get features from Extent of forest fire hotspots identified through near real-time monitoring systems
[**get_specific_collection**](NearRealtimeForestFireMonitoringGurugramApi.md#get_specific_collection) | **GET** /collections/ac9b9d04-9143-4542-b885-b46da137ec88 | Metadata about Extent of forest fire hotspots identified through near real-time monitoring systems
[**get_specific_feature**](NearRealtimeForestFireMonitoringGurugramApi.md#get_specific_feature) | **GET** /collections/ac9b9d04-9143-4542-b885-b46da137ec88/items/{featureId} | Get single feature from Extent of forest fire hotspots identified through near real-time monitoring systems


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, acqdate=acqdate, first_stat=first_stat, buff_dist=buff_dist, first_divi=first_divi, sensor=sensor, lon=lon, first_dist=first_dist, lat=lat, name=name)

Get features from Extent of forest fire hotspots identified through near real-time monitoring systems
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    acqdate = 'acqdate_example' # str |  (optional)
    first_stat = 'first_stat_example' # str |  (optional)
    buff_dist = 3.4 # float |  (optional)
    first_divi = 'first_divi_example' # str |  (optional)
    sensor = 'sensor_example' # str |  (optional)
    ...
    try:
        # Get features from Extent of forest fire hotspots identified through near real-time monitoring systems
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, acqdate=acqdate, first_stat=first_stat, buff_dist=buff_dist, first_divi=first_divi, sensor=sensor, lon=lon, first_dist=first_dist, lat=lat, name=name)
        print("The response of NearRealtimeForestFireMonitoringGurugramApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NearRealtimeForestFireMonitoringGurugramApi->get_features: %s\n" % e)
```
...
Get single feature from Extent of forest fire hotspots identified through near real-time monitoring systems
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of NearRealtimeForestFireMonitoringGurugramApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling NearRealtimeForestFireMonitoringGurugramApi->get_specific_feature: %s\n" % e)
```
