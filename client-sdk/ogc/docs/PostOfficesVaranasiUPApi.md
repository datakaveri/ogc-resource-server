# openapi_client.PostOfficesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PostOfficesVaranasiUPApi.md#get_features) | **GET** /collections/0b24a794-6933-44f3-962c-bfbdcc2087f7/items | Get features from Point locations of post offices in Varanasi, UP
[**get_features_0**](PostOfficesVaranasiUPApi.md#get_features_0) | **GET** /collections/35925397-7cf5-439f-83ee-ff3b336c378c/items | Get features from Locations of post offices in Varanasi, UP
[**get_specific_collection**](PostOfficesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/0b24a794-6933-44f3-962c-bfbdcc2087f7 | Metadata about Point locations of post offices in Varanasi, UP
[**get_specific_collection_0**](PostOfficesVaranasiUPApi.md#get_specific_collection_0) | **GET** /collections/35925397-7cf5-439f-83ee-ff3b336c378c | Metadata about Locations of post offices in Varanasi, UP
[**get_specific_feature**](PostOfficesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/0b24a794-6933-44f3-962c-bfbdcc2087f7/items/{featureId} | Get single feature from Point locations of post offices in Varanasi, UP
[**get_specific_feature_0**](PostOfficesVaranasiUPApi.md#get_specific_feature_0) | **GET** /collections/35925397-7cf5-439f-83ee-ff3b336c378c/items/{featureId} | Get single feature from Locations of post offices in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, category=category)

Get features from Point locations of post offices in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Point locations of post offices in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, category=category)
        print("The response of PostOfficesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficesVaranasiUPApi->get_features: %s\n" % e)
```
...
# **get_features_0**
> FeatureCollectionGeoJSON get_features_0(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, unique_id=unique_id)

Get features from Locations of post offices in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Locations of post offices in Varanasi, UP
        api_response = api_instance.get_features_0(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, unique_id=unique_id)
        print("The response of PostOfficesVaranasiUPApi->get_features_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficesVaranasiUPApi->get_features_0: %s\n" % e)
```
...
Get single feature from Point locations of post offices in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
...
Get single feature from Locations of post offices in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficesVaranasiUPApi->get_specific_feature_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficesVaranasiUPApi->get_specific_feature_0: %s\n" % e)
```
