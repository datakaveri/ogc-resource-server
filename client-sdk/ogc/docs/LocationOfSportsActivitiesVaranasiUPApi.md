# openapi_client.LocationOfSportsActivitiesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LocationOfSportsActivitiesVaranasiUPApi.md#get_features) | **GET** /collections/8b651988-f15a-4625-8313-e7ff9512d4ab/items | Get features from Point locations of land used for sports activities in Varanasi, UP
[**get_specific_collection**](LocationOfSportsActivitiesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/8b651988-f15a-4625-8313-e7ff9512d4ab | Metadata about Point locations of land used for sports activities in Varanasi, UP
[**get_specific_feature**](LocationOfSportsActivitiesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/8b651988-f15a-4625-8313-e7ff9512d4ab/items/{featureId} | Get single feature from Point locations of land used for sports activities in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, outdoor=outdoor, category=category, ownershp=ownershp)

Get features from Point locations of land used for sports activities in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    outdoor = 'outdoor_example' # str |  (optional)
    category = 'category_example' # str |  (optional)
    ownershp = 'ownershp_example' # str |  (optional)

    try:
        # Get features from Point locations of land used for sports activities in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, outdoor=outdoor, category=category, ownershp=ownershp)
        print("The response of LocationOfSportsActivitiesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfSportsActivitiesVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **outdoor** | **str**|  | [optional] 
 **category** | **str**|  | [optional] 
 **ownershp** | **str**|  | [optional] 
...
Get single feature from Point locations of land used for sports activities in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationOfSportsActivitiesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfSportsActivitiesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
