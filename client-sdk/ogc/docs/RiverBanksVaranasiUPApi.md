# openapi_client.RiverBanksVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RiverBanksVaranasiUPApi.md#get_features) | **GET** /collections/6683d53a-7fb1-42a8-92b4-d5de809b2d36/items | Get features from Line features representing river banks in in Varanasi, UP
[**get_specific_collection**](RiverBanksVaranasiUPApi.md#get_specific_collection) | **GET** /collections/6683d53a-7fb1-42a8-92b4-d5de809b2d36 | Metadata about Line features representing river banks in in Varanasi, UP
[**get_specific_feature**](RiverBanksVaranasiUPApi.md#get_specific_feature) | **GET** /collections/6683d53a-7fb1-42a8-92b4-d5de809b2d36/items/{featureId} | Get single feature from Line features representing river banks in in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, addl_info=addl_info, bank_type=bank_type, name=name, type1=type1)

Get features from Line features representing river banks in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    bank_type = 'bank_type_example' # str |  (optional)
    name = 'name_example' # str |  (optional)
    type1 = 'type1_example' # str |  (optional)

    try:
        # Get features from Line features representing river banks in in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, addl_info=addl_info, bank_type=bank_type, name=name, type1=type1)
        print("The response of RiverBanksVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RiverBanksVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing river banks in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RiverBanksVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RiverBanksVaranasiUPApi->get_specific_feature: %s\n" % e)
```
