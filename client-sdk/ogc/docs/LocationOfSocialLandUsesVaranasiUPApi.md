# openapi_client.LocationOfSocialLandUsesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LocationOfSocialLandUsesVaranasiUPApi.md#get_features) | **GET** /collections/89d3b215-f1ab-455f-b94c-acbcc7722849/items | Get features from Point locations of regions used for social purposes in Varanasi, UP
[**get_specific_collection**](LocationOfSocialLandUsesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/89d3b215-f1ab-455f-b94c-acbcc7722849 | Metadata about Point locations of regions used for social purposes in Varanasi, UP
[**get_specific_feature**](LocationOfSocialLandUsesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/89d3b215-f1ab-455f-b94c-acbcc7722849/items/{featureId} | Get single feature from Point locations of regions used for social purposes in Varanasi, UP
...
Get features from Point locations of regions used for social purposes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationOfSocialLandUsesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfSocialLandUsesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of regions used for social purposes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationOfSocialLandUsesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfSocialLandUsesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
