# openapi_client.BridgePointLocationsInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](BridgePointLocationsInSirmaurApi.md#get_features) | **GET** /collections/baac6786-96fb-4f59-932b-c9082cbfe2d5/items | Get features from Point location of bridges
[**get_specific_collection**](BridgePointLocationsInSirmaurApi.md#get_specific_collection) | **GET** /collections/baac6786-96fb-4f59-932b-c9082cbfe2d5 | Metadata about Point location of bridges
[**get_specific_feature**](BridgePointLocationsInSirmaurApi.md#get_specific_feature) | **GET** /collections/baac6786-96fb-4f59-932b-c9082cbfe2d5/items/{featureId} | Get single feature from Point location of bridges
...
Get features from Point location of bridges
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BridgePointLocationsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BridgePointLocationsInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Point location of bridges
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BridgePointLocationsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BridgePointLocationsInSirmaurApi->get_specific_feature: %s\n" % e)
```
