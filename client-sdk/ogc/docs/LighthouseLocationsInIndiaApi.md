# openapi_client.LighthouseLocationsInIndiaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LighthouseLocationsInIndiaApi.md#get_features) | **GET** /collections/7d251a0c-8133-4e53-8ced-e2a39bb98a02/items | Get features from Location information of lighthouses along the coastlines in India
[**get_specific_collection**](LighthouseLocationsInIndiaApi.md#get_specific_collection) | **GET** /collections/7d251a0c-8133-4e53-8ced-e2a39bb98a02 | Metadata about Location information of lighthouses along the coastlines in India
[**get_specific_feature**](LighthouseLocationsInIndiaApi.md#get_specific_feature) | **GET** /collections/7d251a0c-8133-4e53-8ced-e2a39bb98a02/items/{featureId} | Get single feature from Location information of lighthouses along the coastlines in India


# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)

Get features from Location information of lighthouses along the coastlines in India
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Location information of lighthouses along the coastlines in India
        api_response = api_instance.get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)
        print("The response of LighthouseLocationsInIndiaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LighthouseLocationsInIndiaApi->get_features: %s\n" % e)
```
...
Get single feature from Location information of lighthouses along the coastlines in India
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LighthouseLocationsInIndiaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LighthouseLocationsInIndiaApi->get_specific_feature: %s\n" % e)
```
