# openapi_client.IMDPortWarningInformationApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](IMDPortWarningInformationApi.md#get_features) | **GET** /collections/924fb85c-6f65-404a-8a8c-b4fb5f2a2982/items | Get features from Daily port warning information reported by the Indian Meteorological Department (IMD)
[**get_specific_collection**](IMDPortWarningInformationApi.md#get_specific_collection) | **GET** /collections/924fb85c-6f65-404a-8a8c-b4fb5f2a2982 | Metadata about Daily port warning information reported by the Indian Meteorological Department (IMD)
[**get_specific_feature**](IMDPortWarningInformationApi.md#get_specific_feature) | **GET** /collections/924fb85c-6f65-404a-8a8c-b4fb5f2a2982/items/{featureId} | Get single feature from Daily port warning information reported by the Indian Meteorological Department (IMD)


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, id_imd=id_imd, warning=warning, issued_by=issued_by, blink=blink, observation_date_time=observation_date_time, port_name=port_name)

Get features from Daily port warning information reported by the Indian Meteorological Department (IMD)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    warning = 'warning_example' # str |  (optional)
    issued_by = 'issued_by_example' # str |  (optional)
    blink = 'blink_example' # str |  (optional)
    observation_date_time = 'observation_date_time_example' # str |  (optional)
    port_name = 'port_name_example' # str |  (optional)

    try:
        # Get features from Daily port warning information reported by the Indian Meteorological Department (IMD)
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, id_imd=id_imd, warning=warning, issued_by=issued_by, blink=blink, observation_date_time=observation_date_time, port_name=port_name)
        print("The response of IMDPortWarningInformationApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IMDPortWarningInformationApi->get_features: %s\n" % e)
```
...
Get single feature from Daily port warning information reported by the Indian Meteorological Department (IMD)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IMDPortWarningInformationApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IMDPortWarningInformationApi->get_specific_feature: %s\n" % e)
```
