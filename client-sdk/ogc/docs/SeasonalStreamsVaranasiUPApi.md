# openapi_client.SeasonalStreamsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SeasonalStreamsVaranasiUPApi.md#get_features) | **GET** /collections/afd16ec0-2f8c-49d3-83fa-df66466fca36/items | Get features from Line features representing seasonal streams in in Varanasi, UP
[**get_specific_collection**](SeasonalStreamsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/afd16ec0-2f8c-49d3-83fa-df66466fca36 | Metadata about Line features representing seasonal streams in in Varanasi, UP
[**get_specific_feature**](SeasonalStreamsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/afd16ec0-2f8c-49d3-83fa-df66466fca36/items/{featureId} | Get single feature from Line features representing seasonal streams in in Varanasi, UP
...
Get features from Line features representing seasonal streams in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SeasonalStreamsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SeasonalStreamsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing seasonal streams in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SeasonalStreamsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SeasonalStreamsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
