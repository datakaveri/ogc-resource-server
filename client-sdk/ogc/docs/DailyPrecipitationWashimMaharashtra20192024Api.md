# openapi_client.DailyPrecipitationWashimMaharashtra20192024Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DailyPrecipitationWashimMaharashtra20192024Api.md#get_features) | **GET** /collections/f2064214-bda3-4e54-88b0-11c2ed2f1dd9/items | Get features from Village wise daily precipitation data for Washim district, Maharashtra from 01-01-2019 to 30-09-2024
[**get_specific_collection**](DailyPrecipitationWashimMaharashtra20192024Api.md#get_specific_collection) | **GET** /collections/f2064214-bda3-4e54-88b0-11c2ed2f1dd9 | Metadata about Village wise daily precipitation data for Washim district, Maharashtra from 01-01-2019 to 30-09-2024
[**get_specific_feature**](DailyPrecipitationWashimMaharashtra20192024Api.md#get_specific_feature) | **GET** /collections/f2064214-bda3-4e54-88b0-11c2ed2f1dd9/items/{featureId} | Get single feature from Village wise daily precipitation data for Washim district, Maharashtra from 01-01-2019 to 30-09-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, precipitation=precipitation, value_name=value_name, dates=dates, state=state, tehsil=tehsil)

Get features from Village wise daily precipitation data for Washim district, Maharashtra from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Village wise daily precipitation data for Washim district, Maharashtra from 01-01-2019 to 30-09-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, precipitation=precipitation, value_name=value_name, dates=dates, state=state, tehsil=tehsil)
        print("The response of DailyPrecipitationWashimMaharashtra20192024Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipitationWashimMaharashtra20192024Api->get_features: %s\n" % e)
```
...
Get single feature from Village wise daily precipitation data for Washim district, Maharashtra from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DailyPrecipitationWashimMaharashtra20192024Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipitationWashimMaharashtra20192024Api->get_specific_feature: %s\n" % e)
```
