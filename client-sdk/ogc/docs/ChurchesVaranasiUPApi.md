# openapi_client.ChurchesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ChurchesVaranasiUPApi.md#get_features) | **GET** /collections/f25499be-024d-43a8-a86a-94edd38b6d76/items | Get features from Locations of churches in Varanasi, UP
[**get_specific_collection**](ChurchesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/f25499be-024d-43a8-a86a-94edd38b6d76 | Metadata about Locations of churches in Varanasi, UP
[**get_specific_feature**](ChurchesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/f25499be-024d-43a8-a86a-94edd38b6d76/items/{featureId} | Get single feature from Locations of churches in Varanasi, UP
...
Get features from Locations of churches in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ChurchesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ChurchesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of churches in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ChurchesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ChurchesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
