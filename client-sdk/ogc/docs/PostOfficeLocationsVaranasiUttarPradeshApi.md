# openapi_client.PostOfficeLocationsVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PostOfficeLocationsVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/724b65ee-928f-4bca-864c-4084dd5a67c8/items | Get features from Point features of post offices in Varanasi District, Uttar Pradesh
[**get_specific_collection**](PostOfficeLocationsVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/724b65ee-928f-4bca-864c-4084dd5a67c8 | Metadata about Point features of post offices in Varanasi District, Uttar Pradesh
[**get_specific_feature**](PostOfficeLocationsVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/724b65ee-928f-4bca-864c-4084dd5a67c8/items/{featureId} | Get single feature from Point features of post offices in Varanasi District, Uttar Pradesh
...
Get features from Point features of post offices in Varanasi District, Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    facilty_ty = 'facilty_ty_example' # str |  (optional)
    subd_name = 'subd_name_example' # str |  (optional)
    pin = 'pin_example' # str |  (optional)
    ...
    try:
        ...
        print("The response of PostOfficeLocationsVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficeLocationsVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
 ...
 **facilty_ty** | **str**|  | [optional] 
 **subd_name** | **str**|  | [optional] 
 **pin** | **str**|  | [optional] 
...
Get single feature from Point features of post offices in Varanasi District, Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficeLocationsVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficeLocationsVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
