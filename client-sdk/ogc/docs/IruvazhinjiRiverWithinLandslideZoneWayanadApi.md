# openapi_client.IruvazhinjiRiverWithinLandslideZoneWayanadApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](IruvazhinjiRiverWithinLandslideZoneWayanadApi.md#get_features) | **GET** /collections/d5d5653f-4fb2-4581-a06a-18729d5b6a85/items | Get features from Polygon features of Iruvazhinji river within the boundary of the landslide event in Wayanad, Kerala
[**get_specific_collection**](IruvazhinjiRiverWithinLandslideZoneWayanadApi.md#get_specific_collection) | **GET** /collections/d5d5653f-4fb2-4581-a06a-18729d5b6a85 | Metadata about Polygon features of Iruvazhinji river within the boundary of the landslide event in Wayanad, Kerala
[**get_specific_feature**](IruvazhinjiRiverWithinLandslideZoneWayanadApi.md#get_specific_feature) | **GET** /collections/d5d5653f-4fb2-4581-a06a-18729d5b6a85/items/{featureId} | Get single feature from Polygon features of Iruvazhinji river within the boundary of the landslide event in Wayanad, Kerala


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)

Get features from Polygon features of Iruvazhinji river within the boundary of the landslide event in Wayanad, Kerala
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Polygon features of Iruvazhinji river within the boundary of the landslide event in Wayanad, Kerala
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)
        print("The response of IruvazhinjiRiverWithinLandslideZoneWayanadApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IruvazhinjiRiverWithinLandslideZoneWayanadApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of Iruvazhinji river within the boundary of the landslide event in Wayanad, Kerala
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IruvazhinjiRiverWithinLandslideZoneWayanadApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IruvazhinjiRiverWithinLandslideZoneWayanadApi->get_specific_feature: %s\n" % e)
```
