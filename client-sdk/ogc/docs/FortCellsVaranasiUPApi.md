# openapi_client.FortCellsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](FortCellsVaranasiUPApi.md#get_features) | **GET** /collections/bd61dc92-e7fb-4fab-88d4-df1e2a07a8cc/items | Get features from Locations of fort cells in Varanasi, UP
[**get_specific_collection**](FortCellsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/bd61dc92-e7fb-4fab-88d4-df1e2a07a8cc | Metadata about Locations of fort cells in Varanasi, UP
[**get_specific_feature**](FortCellsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/bd61dc92-e7fb-4fab-88d4-df1e2a07a8cc/items/{featureId} | Get single feature from Locations of fort cells in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, unique_id=unique_id, name=name)

Get features from Locations of fort cells in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Locations of fort cells in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, unique_id=unique_id, name=name)
        print("The response of FortCellsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FortCellsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of fort cells in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FortCellsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FortCellsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
