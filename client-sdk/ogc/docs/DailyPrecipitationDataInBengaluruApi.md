# openapi_client.DailyPrecipitationDataInBengaluruApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DailyPrecipitationDataInBengaluruApi.md#get_features) | **GET** /collections/f860dc36-4649-402a-b35b-45c5f6c6812e/items | Get features from Wardwise daily precipitation data for Bengaluru from 01-01-2019 to 30-04-2024
[**get_specific_collection**](DailyPrecipitationDataInBengaluruApi.md#get_specific_collection) | **GET** /collections/f860dc36-4649-402a-b35b-45c5f6c6812e | Metadata about Wardwise daily precipitation data for Bengaluru from 01-01-2019 to 30-04-2024
[**get_specific_feature**](DailyPrecipitationDataInBengaluruApi.md#get_specific_feature) | **GET** /collections/f860dc36-4649-402a-b35b-45c5f6c6812e/items/{featureId} | Get single feature from Wardwise daily precipitation data for Bengaluru from 01-01-2019 to 30-04-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, precipitation=precipitation, value_name=value_name, dates=dates, kgis_ward_na=kgis_ward_na)

Get features from Wardwise daily precipitation data for Bengaluru from 01-01-2019 to 30-04-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    kgis_ward_na = 'kgis_ward_na_example' # str |  (optional)

    try:
        # Get features from Wardwise daily precipitation data for Bengaluru from 01-01-2019 to 30-04-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, precipitation=precipitation, value_name=value_name, dates=dates, kgis_ward_na=kgis_ward_na)
        print("The response of DailyPrecipitationDataInBengaluruApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipitationDataInBengaluruApi->get_features: %s\n" % e)
```
...
Get single feature from Wardwise daily precipitation data for Bengaluru from 01-01-2019 to 30-04-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DailyPrecipitationDataInBengaluruApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipitationDataInBengaluruApi->get_specific_feature: %s\n" % e)
```
