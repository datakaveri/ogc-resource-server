# openapi_client.CuttingBothSidesLocationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CuttingBothSidesLocationsVaranasiUPApi.md#get_features) | **GET** /collections/7acb9a4f-ead4-4f33-8a3a-7e512d62f3b8/items | Get features from Geographic locations of areas with cutting on both sides in Varanasi, UP
[**get_specific_collection**](CuttingBothSidesLocationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/7acb9a4f-ead4-4f33-8a3a-7e512d62f3b8 | Metadata about Geographic locations of areas with cutting on both sides in Varanasi, UP
[**get_specific_feature**](CuttingBothSidesLocationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/7acb9a4f-ead4-4f33-8a3a-7e512d62f3b8/items/{featureId} | Get single feature from Geographic locations of areas with cutting on both sides in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, shape_leng=shape_leng, svy_date=svy_date, addl_info=addl_info, cutg_place=cutg_place, shape_le_1=shape_le_1, height_m=height_m, shape_length=shape_length, unique_id=unique_id, entity_on=entity_on, type1=type1)

Get features from Geographic locations of areas with cutting on both sides in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    svy_date = 'svy_date_example' # str |  (optional)
    addl_info = 'addl_info_example' # str |  (optional)
    cutg_place = 'cutg_place_example' # str |  (optional)
    shape_le_1 = 3.4 # float |  (optional)
    height_m = 3.4 # float |  (optional)
    shape_length = 3.4 # float |  (optional)
    unique_id = 'unique_id_example' # str |  (optional)
    entity_on = 'entity_on_example' # str |  (optional)
    type1 = 'type1_example' # str |  (optional)

    try:
        # Get features from Geographic locations of areas with cutting on both sides in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, shape_leng=shape_leng, svy_date=svy_date, addl_info=addl_info, cutg_place=cutg_place, shape_le_1=shape_le_1, height_m=height_m, shape_length=shape_length, unique_id=unique_id, entity_on=entity_on, type1=type1)
        print("The response of CuttingBothSidesLocationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CuttingBothSidesLocationsVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **svy_date** | **str**|  | [optional] 
 **addl_info** | **str**|  | [optional] 
 **cutg_place** | **str**|  | [optional] 
 **shape_le_1** | **float**|  | [optional] 
 **height_m** | **float**|  | [optional] 
 **shape_length** | **float**|  | [optional] 
 **unique_id** | **str**|  | [optional] 
 **entity_on** | **str**|  | [optional] 
 **type1** | **str**|  | [optional] 
...
Get single feature from Geographic locations of areas with cutting on both sides in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CuttingBothSidesLocationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CuttingBothSidesLocationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
