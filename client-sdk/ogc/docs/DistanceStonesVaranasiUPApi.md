# openapi_client.DistanceStonesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DistanceStonesVaranasiUPApi.md#get_features) | **GET** /collections/ae2f8e21-57ed-4424-948e-c69d54097f5d/items | Get features from Locations of distance stones in Varanasi, UP
[**get_specific_collection**](DistanceStonesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/ae2f8e21-57ed-4424-948e-c69d54097f5d | Metadata about Locations of distance stones in Varanasi, UP
[**get_specific_feature**](DistanceStonesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/ae2f8e21-57ed-4424-948e-c69d54097f5d/items/{featureId} | Get single feature from Locations of distance stones in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, type=type, svy_date=svy_date, gmrotation=gmrotation, feature_on=feature_on, addl_info=addl_info, distnce_km=distnce_km, unique_id=unique_id)

Get features from Locations of distance stones in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    feature_on = 'feature_on_example' # str |  (optional)
    addl_info = 'addl_info_example' # str |  (optional)
    distnce_km = 3.4 # float |  (optional)
    unique_id = 'unique_id_example' # str |  (optional)

    try:
        # Get features from Locations of distance stones in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, type=type, svy_date=svy_date, gmrotation=gmrotation, feature_on=feature_on, addl_info=addl_info, distnce_km=distnce_km, unique_id=unique_id)
        print("The response of DistanceStonesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DistanceStonesVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **feature_on** | **str**|  | [optional] 
 **addl_info** | **str**|  | [optional] 
 **distnce_km** | **float**|  | [optional] 
...
Get single feature from Locations of distance stones in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DistanceStonesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DistanceStonesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
