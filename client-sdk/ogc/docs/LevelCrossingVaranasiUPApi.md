# openapi_client.LevelCrossingVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LevelCrossingVaranasiUPApi.md#get_features) | **GET** /collections/8b3ef32e-ee80-44b2-bbce-45d8d0ca49ec/items | Get features from Locations where railway tracks intersect with roads or pathways in Varanasi, UP
[**get_specific_collection**](LevelCrossingVaranasiUPApi.md#get_specific_collection) | **GET** /collections/8b3ef32e-ee80-44b2-bbce-45d8d0ca49ec | Metadata about Locations where railway tracks intersect with roads or pathways in Varanasi, UP
[**get_specific_feature**](LevelCrossingVaranasiUPApi.md#get_specific_feature) | **GET** /collections/8b3ef32e-ee80-44b2-bbce-45d8d0ca49ec/items/{featureId} | Get single feature from Locations where railway tracks intersect with roads or pathways in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, guarded=guarded, adl_info=adl_info)

Get features from Locations where railway tracks intersect with roads or pathways in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    guarded = 'guarded_example' # str |  (optional)
    adl_info = 'adl_info_example' # str |  (optional)

    try:
        # Get features from Locations where railway tracks intersect with roads or pathways in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, guarded=guarded, adl_info=adl_info)
        print("The response of LevelCrossingVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LevelCrossingVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations where railway tracks intersect with roads or pathways in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LevelCrossingVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LevelCrossingVaranasiUPApi->get_specific_feature: %s\n" % e)
```
