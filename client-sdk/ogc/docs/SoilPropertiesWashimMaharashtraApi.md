# openapi_client.SoilPropertiesWashimMaharashtraApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SoilPropertiesWashimMaharashtraApi.md#get_features) | **GET** /collections/4fe1ac06-7a37-4483-8f17-da1dcdb36d82/items | Get features from Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_collection**](SoilPropertiesWashimMaharashtraApi.md#get_specific_collection) | **GET** /collections/4fe1ac06-7a37-4483-8f17-da1dcdb36d82 | Metadata about Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_feature**](SoilPropertiesWashimMaharashtraApi.md#get_specific_feature) | **GET** /collections/4fe1ac06-7a37-4483-8f17-da1dcdb36d82/items/{featureId} | Get single feature from Polygon feature illustrating the extent of soil and its associated attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SoilPropertiesWashimMaharashtraApi(api_client)
    ...
    try:
        ...
        print("The response of SoilPropertiesWashimMaharashtraApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesWashimMaharashtraApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesWashimMaharashtraApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesWashimMaharashtraApi->get_specific_collection: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesWashimMaharashtraApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesWashimMaharashtraApi->get_specific_feature: %s\n" % e)
```
