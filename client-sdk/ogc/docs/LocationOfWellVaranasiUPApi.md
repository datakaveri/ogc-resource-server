# openapi_client.LocationOfWellVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LocationOfWellVaranasiUPApi.md#get_features) | **GET** /collections/9690f157-adfd-42be-b544-b93630552827/items | Get features from Point locations of wells  in Varanasi, UP
[**get_specific_collection**](LocationOfWellVaranasiUPApi.md#get_specific_collection) | **GET** /collections/9690f157-adfd-42be-b544-b93630552827 | Metadata about Point locations of wells  in Varanasi, UP
[**get_specific_feature**](LocationOfWellVaranasiUPApi.md#get_specific_feature) | **GET** /collections/9690f157-adfd-42be-b544-b93630552827/items/{featureId} | Get single feature from Point locations of wells  in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, category=category, perinlty=perinlty)

Get features from Point locations of wells  in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Point locations of wells  in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, category=category, perinlty=perinlty)
        print("The response of LocationOfWellVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfWellVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of wells  in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationOfWellVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfWellVaranasiUPApi->get_specific_feature: %s\n" % e)
```
