# openapi_client.ParkingVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ParkingVaranasiUPApi.md#get_features) | **GET** /collections/4988ecae-c3e2-4d14-a4a1-f06818ac60fb/items | Get features from Point locations of parking areas in Varanasi, UP
[**get_specific_collection**](ParkingVaranasiUPApi.md#get_specific_collection) | **GET** /collections/4988ecae-c3e2-4d14-a4a1-f06818ac60fb | Metadata about Point locations of parking areas in Varanasi, UP
[**get_specific_feature**](ParkingVaranasiUPApi.md#get_specific_feature) | **GET** /collections/4988ecae-c3e2-4d14-a4a1-f06818ac60fb/items/{featureId} | Get single feature from Point locations of parking areas in Varanasi, UP
...
Get features from Point locations of parking areas in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ParkingVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ParkingVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of parking areas in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ParkingVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ParkingVaranasiUPApi->get_specific_feature: %s\n" % e)
```
