# openapi_client.ForestCoverVaranasiDistrict2021Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ForestCoverVaranasiDistrict2021Api.md#get_features) | **GET** /collections/d509effa-34a2-47be-81ec-9ee30c9b83be/items | Get features from Boundaries of forest cover based on canopy density in Varanasi distirict, UP
[**get_specific_collection**](ForestCoverVaranasiDistrict2021Api.md#get_specific_collection) | **GET** /collections/d509effa-34a2-47be-81ec-9ee30c9b83be | Metadata about Boundaries of forest cover based on canopy density in Varanasi distirict, UP
[**get_specific_feature**](ForestCoverVaranasiDistrict2021Api.md#get_specific_feature) | **GET** /collections/d509effa-34a2-47be-81ec-9ee30c9b83be/items/{featureId} | Get single feature from Boundaries of forest cover based on canopy density in Varanasi distirict, UP
...
Get features from Boundaries of forest cover based on canopy density in Varanasi distirict, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ForestCoverVaranasiDistrict2021Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ForestCoverVaranasiDistrict2021Api->get_features: %s\n" % e)
```
...
Get single feature from Boundaries of forest cover based on canopy density in Varanasi distirict, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ForestCoverVaranasiDistrict2021Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ForestCoverVaranasiDistrict2021Api->get_specific_feature: %s\n" % e)
```
