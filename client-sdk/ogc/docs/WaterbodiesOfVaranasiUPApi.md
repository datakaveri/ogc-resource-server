# openapi_client.WaterbodiesOfVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterbodiesOfVaranasiUPApi.md#get_features) | **GET** /collections/5386ab71-83aa-4439-bf3a-3eeca1a329be/items | Get features from Polygon features of waterbodies mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_collection**](WaterbodiesOfVaranasiUPApi.md#get_specific_collection) | **GET** /collections/5386ab71-83aa-4439-bf3a-3eeca1a329be | Metadata about Polygon features of waterbodies mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_feature**](WaterbodiesOfVaranasiUPApi.md#get_specific_feature) | **GET** /collections/5386ab71-83aa-4439-bf3a-3eeca1a329be/items/{featureId} | Get single feature from Polygon features of waterbodies mapped under SVAMITVA scheme in Varanasi district, UP
...
Get features from Polygon features of waterbodies mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterbodiesOfVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodiesOfVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of waterbodies mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterbodiesOfVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodiesOfVaranasiUPApi->get_specific_feature: %s\n" % e)
```
