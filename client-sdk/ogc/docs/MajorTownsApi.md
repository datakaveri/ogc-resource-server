# openapi_client.MajorTownsApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MajorTownsApi.md#get_features) | **GET** /collections/3c3a1572-ebd7-4c77-8de1-f641fbb831e5/items | Get features from Fetched from Administrative_Boundary_Database_For_Entire_Country_Upto_Taluk_level_with_HQ
[**get_specific_collection**](MajorTownsApi.md#get_specific_collection) | **GET** /collections/3c3a1572-ebd7-4c77-8de1-f641fbb831e5 | Metadata about Fetched from Administrative_Boundary_Database_For_Entire_Country_Upto_Taluk_level_with_HQ
[**get_specific_feature**](MajorTownsApi.md#get_specific_feature) | **GET** /collections/3c3a1572-ebd7-4c77-8de1-f641fbb831e5/items/{featureId} | Get single feature from Fetched from Administrative_Boundary_Database_For_Entire_Country_Upto_Taluk_level_with_HQ


# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, name_of_to=name_of_to, district=district, elevation=elevation, scale=scale, state=state, rotation=rotation)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.MajorTownsApi(api_client)
    ...
    try:
        # Get features from Fetched from Administrative_Boundary_Database_For_Entire_Country_Upto_Taluk_level_with_HQ
        api_response = api_instance.get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, name_of_to=name_of_to, district=district, elevation=elevation, scale=scale, state=state, rotation=rotation)
        print("The response of MajorTownsApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MajorTownsApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MajorTownsApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MajorTownsApi->get_specific_collection: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MajorTownsApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MajorTownsApi->get_specific_feature: %s\n" % e)
```
