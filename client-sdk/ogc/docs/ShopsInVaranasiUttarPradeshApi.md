# openapi_client.ShopsInVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ShopsInVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/225cfde9-fa68-47f1-ace4-f77568844593/items | Get features from Point locations of the shops in Varanasi district of Uttar Pradesh
[**get_specific_collection**](ShopsInVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/225cfde9-fa68-47f1-ace4-f77568844593 | Metadata about Point locations of the shops in Varanasi district of Uttar Pradesh
[**get_specific_feature**](ShopsInVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/225cfde9-fa68-47f1-ace4-f77568844593/items/{featureId} | Get single feature from Point locations of the shops in Varanasi district of Uttar Pradesh


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, shop=shop, name=name, name_en=name_en)

Get features from Point locations of the shops in Varanasi district of Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Point locations of the shops in Varanasi district of Uttar Pradesh
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, shop=shop, name=name, name_en=name_en)
        print("The response of ShopsInVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ShopsInVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of the shops in Varanasi district of Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ShopsInVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ShopsInVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
