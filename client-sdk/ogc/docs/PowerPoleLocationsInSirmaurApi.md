# openapi_client.PowerPoleLocationsInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PowerPoleLocationsInSirmaurApi.md#get_features) | **GET** /collections/5d42d722-4790-4510-be61-8c15739c2d3a/items | Get features from Point locations of power poles in Sirmaur
[**get_specific_collection**](PowerPoleLocationsInSirmaurApi.md#get_specific_collection) | **GET** /collections/5d42d722-4790-4510-be61-8c15739c2d3a | Metadata about Point locations of power poles in Sirmaur
[**get_specific_feature**](PowerPoleLocationsInSirmaurApi.md#get_specific_feature) | **GET** /collections/5d42d722-4790-4510-be61-8c15739c2d3a/items/{featureId} | Get single feature from Point locations of power poles in Sirmaur
...
Get features from Point locations of power poles in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PowerPoleLocationsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PowerPoleLocationsInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of power poles in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PowerPoleLocationsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PowerPoleLocationsInSirmaurApi->get_specific_feature: %s\n" % e)
```
