...
------------- | ------------- | -------------
[**get_features**](DirectionOfWaterFlowInSirmaurApi.md#get_features) | **GET** /collections/9b3da91c-d1fd-40d1-825c-b16762875db7/items | Get features from Point locations defining if the flow of water is tidal or unidirectional
[**get_specific_collection**](DirectionOfWaterFlowInSirmaurApi.md#get_specific_collection) | **GET** /collections/9b3da91c-d1fd-40d1-825c-b16762875db7 | Metadata about Point locations defining if the flow of water is tidal or unidirectional
[**get_specific_feature**](DirectionOfWaterFlowInSirmaurApi.md#get_specific_feature) | **GET** /collections/9b3da91c-d1fd-40d1-825c-b16762875db7/items/{featureId} | Get single feature from Point locations defining if the flow of water is tidal or unidirectional
...
Get features from Point locations defining if the flow of water is tidal or unidirectional
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DirectionOfWaterFlowInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DirectionOfWaterFlowInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations defining if the flow of water is tidal or unidirectional
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DirectionOfWaterFlowInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DirectionOfWaterFlowInSirmaurApi->get_specific_feature: %s\n" % e)
```
