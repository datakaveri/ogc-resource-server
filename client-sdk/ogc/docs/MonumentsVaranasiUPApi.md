# openapi_client.MonumentsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MonumentsVaranasiUPApi.md#get_features) | **GET** /collections/2b72cc0b-8c6a-4f1d-bc3e-45d4a336a6ee/items | Get features from Locations of monuments in Varanasi, UP
[**get_specific_collection**](MonumentsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/2b72cc0b-8c6a-4f1d-bc3e-45d4a336a6ee | Metadata about Locations of monuments in Varanasi, UP
[**get_specific_feature**](MonumentsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/2b72cc0b-8c6a-4f1d-bc3e-45d4a336a6ee/items/{featureId} | Get single feature from Locations of monuments in Varanasi, UP
...
Get features from Locations of monuments in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonumentsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonumentsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of monuments in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonumentsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonumentsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
