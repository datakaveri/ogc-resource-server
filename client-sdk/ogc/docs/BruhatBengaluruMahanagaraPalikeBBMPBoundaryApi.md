...
------------- | ------------- | -------------
[**get_features**](BruhatBengaluruMahanagaraPalikeBBMPBoundaryApi.md#get_features) | **GET** /collections/082949ab-9767-43ac-9c85-3e4725081817/items | Get features from Polygon boundary of the Bruhat Bengaluru Mahanagara Palike (BBMP)
[**get_specific_collection**](BruhatBengaluruMahanagaraPalikeBBMPBoundaryApi.md#get_specific_collection) | **GET** /collections/082949ab-9767-43ac-9c85-3e4725081817 | Metadata about Polygon boundary of the Bruhat Bengaluru Mahanagara Palike (BBMP)
[**get_specific_feature**](BruhatBengaluruMahanagaraPalikeBBMPBoundaryApi.md#get_specific_feature) | **GET** /collections/082949ab-9767-43ac-9c85-3e4725081817/items/{featureId} | Get single feature from Polygon boundary of the Bruhat Bengaluru Mahanagara Palike (BBMP)


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, area_sq_km=area_sq_km)

Get features from Polygon boundary of the Bruhat Bengaluru Mahanagara Palike (BBMP)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Polygon boundary of the Bruhat Bengaluru Mahanagara Palike (BBMP)
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, area_sq_km=area_sq_km)
        print("The response of BruhatBengaluruMahanagaraPalikeBBMPBoundaryApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BruhatBengaluruMahanagaraPalikeBBMPBoundaryApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon boundary of the Bruhat Bengaluru Mahanagara Palike (BBMP)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BruhatBengaluruMahanagaraPalikeBBMPBoundaryApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BruhatBengaluruMahanagaraPalikeBBMPBoundaryApi->get_specific_feature: %s\n" % e)
```
