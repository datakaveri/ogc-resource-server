# openapi_client.RiceFallowAreasKamrupMetroDistrictApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RiceFallowAreasKamrupMetroDistrictApi.md#get_features) | **GET** /collections/03aa8966-b979-4f37-8e41-031a089377cd/items | Get features from Boundaries indicating areas remaining fallow in rabi season but having kharif paddy
[**get_specific_collection**](RiceFallowAreasKamrupMetroDistrictApi.md#get_specific_collection) | **GET** /collections/03aa8966-b979-4f37-8e41-031a089377cd | Metadata about Boundaries indicating areas remaining fallow in rabi season but having kharif paddy
[**get_specific_feature**](RiceFallowAreasKamrupMetroDistrictApi.md#get_specific_feature) | **GET** /collections/03aa8966-b979-4f37-8e41-031a089377cd/items/{featureId} | Get single feature from Boundaries indicating areas remaining fallow in rabi season but having kharif paddy
...
Get features from Boundaries indicating areas remaining fallow in rabi season but having kharif paddy
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RiceFallowAreasKamrupMetroDistrictApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RiceFallowAreasKamrupMetroDistrictApi->get_features: %s\n" % e)
```
...
Get single feature from Boundaries indicating areas remaining fallow in rabi season but having kharif paddy
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RiceFallowAreasKamrupMetroDistrictApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RiceFallowAreasKamrupMetroDistrictApi->get_specific_feature: %s\n" % e)
```
