# openapi_client.UnclassifiedBuildingsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](UnclassifiedBuildingsVaranasiUPApi.md#get_features) | **GET** /collections/78b78189-531d-4c53-85e3-23051218480b/items | Get features from Point locations of buildings that are not classified based on its purpose in Varanasi, UP
[**get_specific_collection**](UnclassifiedBuildingsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/78b78189-531d-4c53-85e3-23051218480b | Metadata about Point locations of buildings that are not classified based on its purpose in Varanasi, UP
[**get_specific_feature**](UnclassifiedBuildingsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/78b78189-531d-4c53-85e3-23051218480b/items/{featureId} | Get single feature from Point locations of buildings that are not classified based on its purpose in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bldg_shp=bldg_shp, bldg_typ=bldg_typ)

Get features from Point locations of buildings that are not classified based on its purpose in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    bldg_shp = 'bldg_shp_example' # str |  (optional)
    bldg_typ = 'bldg_typ_example' # str |  (optional)

    try:
        # Get features from Point locations of buildings that are not classified based on its purpose in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bldg_shp=bldg_shp, bldg_typ=bldg_typ)
        print("The response of UnclassifiedBuildingsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UnclassifiedBuildingsVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **bldg_shp** | **str**|  | [optional] 
 **bldg_typ** | **str**|  | [optional] 
...
Get single feature from Point locations of buildings that are not classified based on its purpose in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of UnclassifiedBuildingsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UnclassifiedBuildingsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
