# openapi_client.OtherLinearBoundaryVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](OtherLinearBoundaryVaranasiUPApi.md#get_features) | **GET** /collections/5c34ec94-3a85-408f-a707-85d714ba6ef1/items | Get features from Linear boundary features like wall gate, hedge, fence etc. in Varanasi, UP
[**get_specific_collection**](OtherLinearBoundaryVaranasiUPApi.md#get_specific_collection) | **GET** /collections/5c34ec94-3a85-408f-a707-85d714ba6ef1 | Metadata about Linear boundary features like wall gate, hedge, fence etc. in Varanasi, UP
[**get_specific_feature**](OtherLinearBoundaryVaranasiUPApi.md#get_specific_feature) | **GET** /collections/5c34ec94-3a85-408f-a707-85d714ba6ef1/items/{featureId} | Get single feature from Linear boundary features like wall gate, hedge, fence etc. in Varanasi, UP
...
Get features from Linear boundary features like wall gate, hedge, fence etc. in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OtherLinearBoundaryVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherLinearBoundaryVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Linear boundary features like wall gate, hedge, fence etc. in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OtherLinearBoundaryVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherLinearBoundaryVaranasiUPApi->get_specific_feature: %s\n" % e)
```
