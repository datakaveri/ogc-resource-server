# openapi_client.DirectionOfWaterFlowVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DirectionOfWaterFlowVaranasiUPApi.md#get_features) | **GET** /collections/8b11a208-12ce-464d-9d41-89740894bf6c/items | Get features from Point locations defining the if the flow of water is tidal or unidirectional in Varanasi, UP
[**get_specific_collection**](DirectionOfWaterFlowVaranasiUPApi.md#get_specific_collection) | **GET** /collections/8b11a208-12ce-464d-9d41-89740894bf6c | Metadata about Point locations defining the if the flow of water is tidal or unidirectional in Varanasi, UP
[**get_specific_feature**](DirectionOfWaterFlowVaranasiUPApi.md#get_specific_feature) | **GET** /collections/8b11a208-12ce-464d-9d41-89740894bf6c/items/{featureId} | Get single feature from Point locations defining the if the flow of water is tidal or unidirectional in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, c_at=c_at)

Get features from Point locations defining the if the flow of water is tidal or unidirectional in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    c_at = 'c_at_example' # str |  (optional)

    try:
        # Get features from Point locations defining the if the flow of water is tidal or unidirectional in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, c_at=c_at)
        print("The response of DirectionOfWaterFlowVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DirectionOfWaterFlowVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations defining the if the flow of water is tidal or unidirectional in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DirectionOfWaterFlowVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DirectionOfWaterFlowVaranasiUPApi->get_specific_feature: %s\n" % e)
```
