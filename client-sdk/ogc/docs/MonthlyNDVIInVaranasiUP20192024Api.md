# openapi_client.MonthlyNDVIInVaranasiUP20192024Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MonthlyNDVIInVaranasiUP20192024Api.md#get_features) | **GET** /collections/56ef6853-c084-462b-814a-f28562ff84cb/items | Get features from village wise monthly NDVI data for Varanasi district, UP from 01-01-2019 to 30-09-2024
[**get_specific_collection**](MonthlyNDVIInVaranasiUP20192024Api.md#get_specific_collection) | **GET** /collections/56ef6853-c084-462b-814a-f28562ff84cb | Metadata about village wise monthly NDVI data for Varanasi district, UP from 01-01-2019 to 30-09-2024
[**get_specific_feature**](MonthlyNDVIInVaranasiUP20192024Api.md#get_specific_feature) | **GET** /collections/56ef6853-c084-462b-814a-f28562ff84cb/items/{featureId} | Get single feature from village wise monthly NDVI data for Varanasi district, UP from 01-01-2019 to 30-09-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, district=district, value_name=value_name, tahsil=tahsil, dates=dates, vill_name=vill_name, ndvi=ndvi, vill_code=vill_code)

Get features from village wise monthly NDVI data for Varanasi district, UP from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from village wise monthly NDVI data for Varanasi district, UP from 01-01-2019 to 30-09-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, district=district, value_name=value_name, tahsil=tahsil, dates=dates, vill_name=vill_name, ndvi=ndvi, vill_code=vill_code)
        print("The response of MonthlyNDVIInVaranasiUP20192024Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInVaranasiUP20192024Api->get_features: %s\n" % e)
```
...
Get single feature from village wise monthly NDVI data for Varanasi district, UP from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonthlyNDVIInVaranasiUP20192024Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInVaranasiUP20192024Api->get_specific_feature: %s\n" % e)
```
