# openapi_client.PowerLinesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PowerLinesVaranasiUPApi.md#get_features) | **GET** /collections/1acadfb3-7171-495b-b5a9-351aee6e832d/items | Get features from Power line features in Varanasi, UP
[**get_specific_collection**](PowerLinesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/1acadfb3-7171-495b-b5a9-351aee6e832d | Metadata about Power line features in Varanasi, UP
[**get_specific_feature**](PowerLinesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/1acadfb3-7171-495b-b5a9-351aee6e832d/items/{featureId} | Get single feature from Power line features in Varanasi, UP
...
Get features from Power line features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PowerLinesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PowerLinesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Power line features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PowerLinesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PowerLinesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
