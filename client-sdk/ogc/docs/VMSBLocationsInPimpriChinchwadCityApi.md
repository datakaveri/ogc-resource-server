...
------------- | ------------- | -------------
[**get_features**](VMSBLocationsInPimpriChinchwadCityApi.md#get_features) | **GET** /collections/9c6ff112-bd55-4efb-b713-9d7ea3175c09/items | Get features from Physical coordinates of Variable Messaging Sign Board locations in Pimpri Chinchwad City
[**get_specific_collection**](VMSBLocationsInPimpriChinchwadCityApi.md#get_specific_collection) | **GET** /collections/9c6ff112-bd55-4efb-b713-9d7ea3175c09 | Metadata about Physical coordinates of Variable Messaging Sign Board locations in Pimpri Chinchwad City
[**get_specific_feature**](VMSBLocationsInPimpriChinchwadCityApi.md#get_specific_feature) | **GET** /collections/9c6ff112-bd55-4efb-b713-9d7ea3175c09/items/{featureId} | Get single feature from Physical coordinates of Variable Messaging Sign Board locations in Pimpri Chinchwad City
...
Get features from Physical coordinates of Variable Messaging Sign Board locations in Pimpri Chinchwad City
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VMSBLocationsInPimpriChinchwadCityApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VMSBLocationsInPimpriChinchwadCityApi->get_features: %s\n" % e)
```
...
Get single feature from Physical coordinates of Variable Messaging Sign Board locations in Pimpri Chinchwad City
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VMSBLocationsInPimpriChinchwadCityApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VMSBLocationsInPimpriChinchwadCityApi->get_specific_feature: %s\n" % e)
```
