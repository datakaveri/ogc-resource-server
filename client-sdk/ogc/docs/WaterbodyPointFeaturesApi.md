# openapi_client.WaterbodyPointFeaturesApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterbodyPointFeaturesApi.md#get_features) | **GET** /collections/9ce733c1-59ed-4ca8-a349-7f48c5badce1/items | Get features from Point locations of waterbody and attributes defining its origin, category, perenniality
[**get_specific_collection**](WaterbodyPointFeaturesApi.md#get_specific_collection) | **GET** /collections/9ce733c1-59ed-4ca8-a349-7f48c5badce1 | Metadata about Point locations of waterbody and attributes defining its origin, category, perenniality
[**get_specific_feature**](WaterbodyPointFeaturesApi.md#get_specific_feature) | **GET** /collections/9ce733c1-59ed-4ca8-a349-7f48c5badce1/items/{featureId} | Get single feature from Point locations of waterbody and attributes defining its origin, category, perenniality


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, origin=origin, category=category, covered=covered, perinlty=perinlty)

Get features from Point locations of waterbody and attributes defining its origin, category, perenniality
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Point locations of waterbody and attributes defining its origin, category, perenniality
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bdry_typ=bdry_typ, origin=origin, category=category, covered=covered, perinlty=perinlty)
        print("The response of WaterbodyPointFeaturesApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodyPointFeaturesApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of waterbody and attributes defining its origin, category, perenniality
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterbodyPointFeaturesApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodyPointFeaturesApi->get_specific_feature: %s\n" % e)
```
