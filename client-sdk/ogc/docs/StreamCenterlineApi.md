# openapi_client.StreamCenterlineApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](StreamCenterlineApi.md#get_features) | **GET** /collections/eaa00db6-628b-404f-ba0c-4dbb4a15001c/items | Get features from Centerline of linear waterbody
[**get_specific_collection**](StreamCenterlineApi.md#get_specific_collection) | **GET** /collections/eaa00db6-628b-404f-ba0c-4dbb4a15001c | Metadata about Centerline of linear waterbody
[**get_specific_feature**](StreamCenterlineApi.md#get_specific_feature) | **GET** /collections/eaa00db6-628b-404f-ba0c-4dbb4a15001c/items/{featureId} | Get single feature from Centerline of linear waterbody


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, tidal=tidal, perinlty=perinlty, course=course, name=name)

Get features from Centerline of linear waterbody
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.StreamCenterlineApi(api_client)
    ...
    try:
        # Get features from Centerline of linear waterbody
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, tidal=tidal, perinlty=perinlty, course=course, name=name)
        print("The response of StreamCenterlineApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamCenterlineApi->get_features: %s\n" % e)
```
...
Metadata about Centerline of linear waterbody
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StreamCenterlineApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamCenterlineApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from Centerline of linear waterbody
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StreamCenterlineApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamCenterlineApi->get_specific_feature: %s\n" % e)
```
