...
------------- | ------------- | -------------
[**get_features**](ControlPointLocationsInSirmaurApi.md#get_features) | **GET** /collections/3777b34c-2f92-4898-90ad-60f8d14eb2e9/items | Get features from Control point locations in Sirmaur
[**get_specific_collection**](ControlPointLocationsInSirmaurApi.md#get_specific_collection) | **GET** /collections/3777b34c-2f92-4898-90ad-60f8d14eb2e9 | Metadata about Control point locations in Sirmaur
[**get_specific_feature**](ControlPointLocationsInSirmaurApi.md#get_specific_feature) | **GET** /collections/3777b34c-2f92-4898-90ad-60f8d14eb2e9/items/{featureId} | Get single feature from Control point locations in Sirmaur


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, subcat=subcat, type=type)

Get features from Control point locations in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Control point locations in Sirmaur
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, subcat=subcat, type=type)
        print("The response of ControlPointLocationsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ControlPointLocationsInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Control point locations in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ControlPointLocationsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ControlPointLocationsInSirmaurApi->get_specific_feature: %s\n" % e)
```
