...
------------- | ------------- | -------------
[**get_features**](RailwayPolygonInfrastructureVaranasiUPApi.md#get_features) | **GET** /collections/c6685ee1-5f75-4dfa-999c-0046e8635f53/items | Get features from Polygons representing various railway-related infrastructure in Varanasi, UP
[**get_specific_collection**](RailwayPolygonInfrastructureVaranasiUPApi.md#get_specific_collection) | **GET** /collections/c6685ee1-5f75-4dfa-999c-0046e8635f53 | Metadata about Polygons representing various railway-related infrastructure in Varanasi, UP
[**get_specific_feature**](RailwayPolygonInfrastructureVaranasiUPApi.md#get_specific_feature) | **GET** /collections/c6685ee1-5f75-4dfa-999c-0046e8635f53/items/{featureId} | Get single feature from Polygons representing various railway-related infrastructure in Varanasi, UP
...
Get features from Polygons representing various railway-related infrastructure in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayPolygonInfrastructureVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayPolygonInfrastructureVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygons representing various railway-related infrastructure in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayPolygonInfrastructureVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayPolygonInfrastructureVaranasiUPApi->get_specific_feature: %s\n" % e)
```
