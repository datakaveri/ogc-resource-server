# openapi_client.PostOfficeLocationsSonipatHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PostOfficeLocationsSonipatHaryanaApi.md#get_features) | **GET** /collections/e22e0b0e-e810-473e-b77b-7ea79f76880c/items | Get features from Point features of post offices in Sonipat District, Haryana
[**get_specific_collection**](PostOfficeLocationsSonipatHaryanaApi.md#get_specific_collection) | **GET** /collections/e22e0b0e-e810-473e-b77b-7ea79f76880c | Metadata about Point features of post offices in Sonipat District, Haryana
[**get_specific_feature**](PostOfficeLocationsSonipatHaryanaApi.md#get_specific_feature) | **GET** /collections/e22e0b0e-e810-473e-b77b-7ea79f76880c/items/{featureId} | Get single feature from Point features of post offices in Sonipat District, Haryana
...
Get features from Point features of post offices in Sonipat District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficeLocationsSonipatHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficeLocationsSonipatHaryanaApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of post offices in Sonipat District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficeLocationsSonipatHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficeLocationsSonipatHaryanaApi->get_specific_feature: %s\n" % e)
```
