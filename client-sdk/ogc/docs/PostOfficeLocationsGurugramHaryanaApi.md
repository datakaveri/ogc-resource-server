# openapi_client.PostOfficeLocationsGurugramHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PostOfficeLocationsGurugramHaryanaApi.md#get_features) | **GET** /collections/2f162a0e-fd22-4d66-910f-184d0810b953/items | Get features from Point features of post offices in Gurugram District, Haryana
[**get_specific_collection**](PostOfficeLocationsGurugramHaryanaApi.md#get_specific_collection) | **GET** /collections/2f162a0e-fd22-4d66-910f-184d0810b953 | Metadata about Point features of post offices in Gurugram District, Haryana
[**get_specific_feature**](PostOfficeLocationsGurugramHaryanaApi.md#get_specific_feature) | **GET** /collections/2f162a0e-fd22-4d66-910f-184d0810b953/items/{featureId} | Get single feature from Point features of post offices in Gurugram District, Haryana
...
Get features from Point features of post offices in Gurugram District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficeLocationsGurugramHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficeLocationsGurugramHaryanaApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of post offices in Gurugram District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficeLocationsGurugramHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficeLocationsGurugramHaryanaApi->get_specific_feature: %s\n" % e)
```
