# openapi_client.ChatriVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ChatriVaranasiUPApi.md#get_features) | **GET** /collections/e9f002f7-c19a-4d50-9fca-638851231624/items | Get features from Locations of chatri in Varanasi, UP
[**get_specific_collection**](ChatriVaranasiUPApi.md#get_specific_collection) | **GET** /collections/e9f002f7-c19a-4d50-9fca-638851231624 | Metadata about Locations of chatri in Varanasi, UP
[**get_specific_feature**](ChatriVaranasiUPApi.md#get_specific_feature) | **GET** /collections/e9f002f7-c19a-4d50-9fca-638851231624/items/{featureId} | Get single feature from Locations of chatri in Varanasi, UP
...
Get features from Locations of chatri in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ChatriVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ChatriVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of chatri in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ChatriVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ChatriVaranasiUPApi->get_specific_feature: %s\n" % e)
```
