# openapi_client.IrrigationCommandAreasInSomeDistHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](IrrigationCommandAreasInSomeDistHaryanaApi.md#get_features) | **GET** /collections/fdcd64b6-760b-4d39-8cfe-e5e213e15bdd/items | Get features from Polygon features of irrigation command areas in Sonipat, Gurgaon, and selected districts, Haryana
[**get_specific_collection**](IrrigationCommandAreasInSomeDistHaryanaApi.md#get_specific_collection) | **GET** /collections/fdcd64b6-760b-4d39-8cfe-e5e213e15bdd | Metadata about Polygon features of irrigation command areas in Sonipat, Gurgaon, and selected districts, Haryana
[**get_specific_feature**](IrrigationCommandAreasInSomeDistHaryanaApi.md#get_specific_feature) | **GET** /collections/fdcd64b6-760b-4d39-8cfe-e5e213e15bdd/items/{featureId} | Get single feature from Polygon features of irrigation command areas in Sonipat, Gurgaon, and selected districts, Haryana
...
Get features from Polygon features of irrigation command areas in Sonipat, Gurgaon, and selected districts, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IrrigationCommandAreasInSomeDistHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IrrigationCommandAreasInSomeDistHaryanaApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of irrigation command areas in Sonipat, Gurgaon, and selected districts, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IrrigationCommandAreasInSomeDistHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IrrigationCommandAreasInSomeDistHaryanaApi->get_specific_feature: %s\n" % e)
```
