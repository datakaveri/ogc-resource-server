# openapi_client.RevenueLandParcelCentroidPointsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RevenueLandParcelCentroidPointsVaranasiUPApi.md#get_features) | **GET** /collections/28aa9d32-144f-4ae6-b81b-3fb1024b89bf/items | Get features from Revenue land parcel centroid point features in Varanasi, UP
[**get_specific_collection**](RevenueLandParcelCentroidPointsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/28aa9d32-144f-4ae6-b81b-3fb1024b89bf | Metadata about Revenue land parcel centroid point features in Varanasi, UP
[**get_specific_feature**](RevenueLandParcelCentroidPointsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/28aa9d32-144f-4ae6-b81b-3fb1024b89bf/items/{featureId} | Get single feature from Revenue land parcel centroid point features in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, dist_twn_c=dist_twn_c, district=district, dist_sub_c=dist_sub_c, block_name=block_name, tahsil=tahsil, village_co=village_co, devlopment=devlopment, pargana=pargana)

Get features from Revenue land parcel centroid point features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    dist_twn_c = 'dist_twn_c_example' # str |  (optional)
    district = 'district_example' # str |  (optional)
    dist_sub_c = 'dist_sub_c_example' # str |  (optional)
    block_name = 'block_name_example' # str |  (optional)
    tahsil = 'tahsil_example' # str |  (optional)
    village_co = 'village_co_example' # str |  (optional)
    devlopment = 'devlopment_example' # str |  (optional)
    pargana = 'pargana_example' # str |  (optional)

    try:
        # Get features from Revenue land parcel centroid point features in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, dist_twn_c=dist_twn_c, district=district, dist_sub_c=dist_sub_c, block_name=block_name, tahsil=tahsil, village_co=village_co, devlopment=devlopment, pargana=pargana)
        print("The response of RevenueLandParcelCentroidPointsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RevenueLandParcelCentroidPointsVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **dist_twn_c** | **str**|  | [optional] 
 **district** | **str**|  | [optional] 
 **dist_sub_c** | **str**|  | [optional] 
 **block_name** | **str**|  | [optional] 
 **tahsil** | **str**|  | [optional] 
 **village_co** | **str**|  | [optional] 
 **devlopment** | **str**|  | [optional] 
 **pargana** | **str**|  | [optional] 
...
Get single feature from Revenue land parcel centroid point features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RevenueLandParcelCentroidPointsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RevenueLandParcelCentroidPointsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
