# openapi_client.WaterTankCellsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterTankCellsVaranasiUPApi.md#get_features) | **GET** /collections/9c51b53d-9c4c-472d-9e9a-f46d3c1ff836/items | Get features from Locations of water tank cells in Varanasi, UP
[**get_specific_collection**](WaterTankCellsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/9c51b53d-9c4c-472d-9e9a-f46d3c1ff836 | Metadata about Locations of water tank cells in Varanasi, UP
[**get_specific_feature**](WaterTankCellsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/9c51b53d-9c4c-472d-9e9a-f46d3c1ff836/items/{featureId} | Get single feature from Locations of water tank cells in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, lined=lined, loc_name=loc_name, svy_date=svy_date, gmrotation=gmrotation, addl_info=addl_info, unique_id=unique_id, tank_type=tank_type, type1=type1)

Get features from Locations of water tank cells in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    lined = 'lined_example' # str |  (optional)
    ...
    tank_type = 'tank_type_example' # str |  (optional)
    type1 = 'type1_example' # str |  (optional)

    try:
        # Get features from Locations of water tank cells in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, lined=lined, loc_name=loc_name, svy_date=svy_date, gmrotation=gmrotation, addl_info=addl_info, unique_id=unique_id, tank_type=tank_type, type1=type1)
        print("The response of WaterTankCellsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterTankCellsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of water tank cells in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterTankCellsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterTankCellsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
