# openapi_client.DetailsOfWarehousesInSonipatHaryanaApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DetailsOfWarehousesInSonipatHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DetailsOfWarehousesInSonipatHaryanaApi->get_features: %s\n" % e)
```
 ...
 **depot_name_5_depot_type_capacity_in_mt_** | **str**|  | [optional] 
 **depot_name_8_depot_type_capacity_in_mt_** | **str**|  | [optional] 
 **depot_name_10_depot_type_capacity_in_mt_** | **str**|  | [optional] 
