# openapi_client.RailwayCenterlineVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RailwayCenterlineVaranasiUPApi.md#get_features) | **GET** /collections/d1845bda-db6b-4e35-be6f-d786822c5ae7/items | Get features from Linear representation of rail routes in Varanasi, UP
[**get_specific_collection**](RailwayCenterlineVaranasiUPApi.md#get_specific_collection) | **GET** /collections/d1845bda-db6b-4e35-be6f-d786822c5ae7 | Metadata about Linear representation of rail routes in Varanasi, UP
[**get_specific_feature**](RailwayCenterlineVaranasiUPApi.md#get_specific_feature) | **GET** /collections/d1845bda-db6b-4e35-be6f-d786822c5ae7/items/{featureId} | Get single feature from Linear representation of rail routes in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, electrfd=electrfd, status=status, adl_info=adl_info, category=category, subcat=subcat, bult_on=bult_on, name=name)

Get features from Linear representation of rail routes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    electrfd = 'electrfd_example' # str |  (optional)
    ...
    try:
        # Get features from Linear representation of rail routes in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, electrfd=electrfd, status=status, adl_info=adl_info, category=category, subcat=subcat, bult_on=bult_on, name=name)
        print("The response of RailwayCenterlineVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayCenterlineVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Linear representation of rail routes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayCenterlineVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayCenterlineVaranasiUPApi->get_specific_feature: %s\n" % e)
```
