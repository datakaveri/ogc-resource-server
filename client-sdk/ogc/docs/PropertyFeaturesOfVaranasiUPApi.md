# openapi_client.PropertyFeaturesOfVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PropertyFeaturesOfVaranasiUPApi.md#get_features) | **GET** /collections/a6a2d44e-88e8-4394-8967-e730deccc404/items | Get features from Polygon features of properties mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_collection**](PropertyFeaturesOfVaranasiUPApi.md#get_specific_collection) | **GET** /collections/a6a2d44e-88e8-4394-8967-e730deccc404 | Metadata about Polygon features of properties mapped under SVAMITVA scheme in Varanasi district, UP
[**get_specific_feature**](PropertyFeaturesOfVaranasiUPApi.md#get_specific_feature) | **GET** /collections/a6a2d44e-88e8-4394-8967-e730deccc404/items/{featureId} | Get single feature from Polygon features of properties mapped under SVAMITVA scheme in Varanasi district, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, abr=abr)

Get features from Polygon features of properties mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.PropertyFeaturesOfVaranasiUPApi(api_client)
    ...
    abr = 'abr_example' # str |  (optional)

    try:
        # Get features from Polygon features of properties mapped under SVAMITVA scheme in Varanasi district, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, abr=abr)
        print("The response of PropertyFeaturesOfVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PropertyFeaturesOfVaranasiUPApi->get_features: %s\n" % e)
```
...
Metadata about Polygon features of properties mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PropertyFeaturesOfVaranasiUPApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PropertyFeaturesOfVaranasiUPApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from Polygon features of properties mapped under SVAMITVA scheme in Varanasi district, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PropertyFeaturesOfVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PropertyFeaturesOfVaranasiUPApi->get_specific_feature: %s\n" % e)
```
