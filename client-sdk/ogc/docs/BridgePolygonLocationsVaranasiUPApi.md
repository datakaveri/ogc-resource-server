# openapi_client.BridgePolygonLocationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](BridgePolygonLocationsVaranasiUPApi.md#get_features) | **GET** /collections/df9d3864-d0be-47e0-b041-b6c4a7d8d850/items | Get features from Geographical extent of bridges as polygon features in Varanasi, UP
[**get_specific_collection**](BridgePolygonLocationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/df9d3864-d0be-47e0-b041-b6c4a7d8d850 | Metadata about Geographical extent of bridges as polygon features in Varanasi, UP
[**get_specific_feature**](BridgePolygonLocationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/df9d3864-d0be-47e0-b041-b6c4a7d8d850/items/{featureId} | Get single feature from Geographical extent of bridges as polygon features in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, c_type=c_type, adl_info=adl_info, category=category, af_cat=af_cat, c_mtrl=c_mtrl, name=name, blt_acrs=blt_acrs)

Get features from Geographical extent of bridges as polygon features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    c_type = 'c_type_example' # str |  (optional)
    adl_info = 'adl_info_example' # str |  (optional)
    category = 'category_example' # str |  (optional)
    af_cat = 'af_cat_example' # str |  (optional)
    c_mtrl = 'c_mtrl_example' # str |  (optional)
    name = 'name_example' # str |  (optional)
    blt_acrs = 'blt_acrs_example' # str |  (optional)

    try:
        # Get features from Geographical extent of bridges as polygon features in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, c_type=c_type, adl_info=adl_info, category=category, af_cat=af_cat, c_mtrl=c_mtrl, name=name, blt_acrs=blt_acrs)
        print("The response of BridgePolygonLocationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BridgePolygonLocationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Geographical extent of bridges as polygon features in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BridgePolygonLocationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BridgePolygonLocationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
