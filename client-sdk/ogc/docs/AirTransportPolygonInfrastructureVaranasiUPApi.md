# openapi_client.AirTransportPolygonInfrastructureVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](AirTransportPolygonInfrastructureVaranasiUPApi.md#get_features) | **GET** /collections/2f4af226-bdce-4369-a7ab-eb159d3c5979/items | Get features from Polygon features of infrastructure used in air transportation in Varanasi, UP
[**get_specific_collection**](AirTransportPolygonInfrastructureVaranasiUPApi.md#get_specific_collection) | **GET** /collections/2f4af226-bdce-4369-a7ab-eb159d3c5979 | Metadata about Polygon features of infrastructure used in air transportation in Varanasi, UP
[**get_specific_feature**](AirTransportPolygonInfrastructureVaranasiUPApi.md#get_specific_feature) | **GET** /collections/2f4af226-bdce-4369-a7ab-eb159d3c5979/items/{featureId} | Get single feature from Polygon features of infrastructure used in air transportation in Varanasi, UP
...
Get features from Polygon features of infrastructure used in air transportation in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AirTransportPolygonInfrastructureVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AirTransportPolygonInfrastructureVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of infrastructure used in air transportation in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AirTransportPolygonInfrastructureVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AirTransportPolygonInfrastructureVaranasiUPApi->get_specific_feature: %s\n" % e)
```
