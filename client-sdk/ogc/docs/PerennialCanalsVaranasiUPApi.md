# openapi_client.PerennialCanalsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PerennialCanalsVaranasiUPApi.md#get_features) | **GET** /collections/98205063-3228-44a7-b959-1455dfd18669/items | Get features from Line features representing perennial canals in in Varanasi, UP
[**get_specific_collection**](PerennialCanalsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/98205063-3228-44a7-b959-1455dfd18669 | Metadata about Line features representing perennial canals in in Varanasi, UP
[**get_specific_feature**](PerennialCanalsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/98205063-3228-44a7-b959-1455dfd18669/items/{featureId} | Get single feature from Line features representing perennial canals in in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type1=type1, name=name)

Get features from Line features representing perennial canals in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Line features representing perennial canals in in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type1=type1, name=name)
        print("The response of PerennialCanalsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PerennialCanalsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing perennial canals in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PerennialCanalsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PerennialCanalsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
