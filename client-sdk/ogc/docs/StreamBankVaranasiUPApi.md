# openapi_client.StreamBankVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](StreamBankVaranasiUPApi.md#get_features) | **GET** /collections/feb745f3-6af4-473d-849b-e2eccbe789cc/items | Get features from Line features of stream banks with attribute information in Varanasi, UP
[**get_specific_collection**](StreamBankVaranasiUPApi.md#get_specific_collection) | **GET** /collections/feb745f3-6af4-473d-849b-e2eccbe789cc | Metadata about Line features of stream banks with attribute information in Varanasi, UP
[**get_specific_feature**](StreamBankVaranasiUPApi.md#get_specific_feature) | **GET** /collections/feb745f3-6af4-473d-849b-e2eccbe789cc/items/{featureId} | Get single feature from Line features of stream banks with attribute information in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, subcat=subcat, tidal=tidal, perinlty=perinlty, course=course, name=name)

Get features from Line features of stream banks with attribute information in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Line features of stream banks with attribute information in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, subcat=subcat, tidal=tidal, perinlty=perinlty, course=course, name=name)
        print("The response of StreamBankVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamBankVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features of stream banks with attribute information in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StreamBankVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamBankVaranasiUPApi->get_specific_feature: %s\n" % e)
```
