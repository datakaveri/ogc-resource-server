...
------------- | ------------- | -------------
[**get_features**](TemplesVaranasiUPApi.md#get_features) | **GET** /collections/f7881a68-73db-442d-bfa6-28487a63f79d/items | Get features from Locations of temples in Varanasi, UP
[**get_specific_collection**](TemplesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/f7881a68-73db-442d-bfa6-28487a63f79d | Metadata about Locations of temples in Varanasi, UP
[**get_specific_feature**](TemplesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/f7881a68-73db-442d-bfa6-28487a63f79d/items/{featureId} | Get single feature from Locations of temples in Varanasi, UP
...
Get features from Locations of temples in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TemplesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TemplesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of temples in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TemplesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TemplesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
