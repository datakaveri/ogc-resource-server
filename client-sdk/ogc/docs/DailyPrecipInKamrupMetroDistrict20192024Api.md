# openapi_client.DailyPrecipInKamrupMetroDistrict20192024Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DailyPrecipInKamrupMetroDistrict20192024Api.md#get_features) | **GET** /collections/d82c9c3f-a97c-4a24-b490-08a40464383b/items | Get features from Village wise daily precipitation data for Kamrup metropolitan dist. Assam, 01-01-2019 to 30-09-2024
[**get_specific_collection**](DailyPrecipInKamrupMetroDistrict20192024Api.md#get_specific_collection) | **GET** /collections/d82c9c3f-a97c-4a24-b490-08a40464383b | Metadata about Village wise daily precipitation data for Kamrup metropolitan dist. Assam, 01-01-2019 to 30-09-2024
[**get_specific_feature**](DailyPrecipInKamrupMetroDistrict20192024Api.md#get_specific_feature) | **GET** /collections/d82c9c3f-a97c-4a24-b490-08a40464383b/items/{featureId} | Get single feature from Village wise daily precipitation data for Kamrup metropolitan dist. Assam, 01-01-2019 to 30-09-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, precipitation=precipitation, soi_name=soi_name, value_name=value_name, state=state, dates=dates, tehsil=tehsil)

Get features from Village wise daily precipitation data for Kamrup metropolitan dist. Assam, 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    soi_name = 'soi_name_example' # str |  (optional)
    ...
    try:
        # Get features from Village wise daily precipitation data for Kamrup metropolitan dist. Assam, 01-01-2019 to 30-09-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, precipitation=precipitation, soi_name=soi_name, value_name=value_name, state=state, dates=dates, tehsil=tehsil)
        print("The response of DailyPrecipInKamrupMetroDistrict20192024Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipInKamrupMetroDistrict20192024Api->get_features: %s\n" % e)
```
...
Get single feature from Village wise daily precipitation data for Kamrup metropolitan dist. Assam, 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DailyPrecipInKamrupMetroDistrict20192024Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipInKamrupMetroDistrict20192024Api->get_specific_feature: %s\n" % e)
```
