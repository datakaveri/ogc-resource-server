# openapi_client.MonthlyNDVIInGurugramHaryana20192024Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MonthlyNDVIInGurugramHaryana20192024Api.md#get_features) | **GET** /collections/35615405-f128-4ed8-be85-3d383610d2f4/items | Get features from Village wise monthly NDVI data for Gurugram district in Haryana from 01-01-2019 to 31-09-2024
[**get_specific_collection**](MonthlyNDVIInGurugramHaryana20192024Api.md#get_specific_collection) | **GET** /collections/35615405-f128-4ed8-be85-3d383610d2f4 | Metadata about Village wise monthly NDVI data for Gurugram district in Haryana from 01-01-2019 to 31-09-2024
[**get_specific_feature**](MonthlyNDVIInGurugramHaryana20192024Api.md#get_specific_feature) | **GET** /collections/35615405-f128-4ed8-be85-3d383610d2f4/items/{featureId} | Get single feature from Village wise monthly NDVI data for Gurugram district in Haryana from 01-01-2019 to 31-09-2024
...
Get features from Village wise monthly NDVI data for Gurugram district in Haryana from 01-01-2019 to 31-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonthlyNDVIInGurugramHaryana20192024Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInGurugramHaryana20192024Api->get_features: %s\n" % e)
```
...
Get single feature from Village wise monthly NDVI data for Gurugram district in Haryana from 01-01-2019 to 31-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonthlyNDVIInGurugramHaryana20192024Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInGurugramHaryana20192024Api->get_specific_feature: %s\n" % e)
```
