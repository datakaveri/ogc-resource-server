# openapi_client.SoilPropertiesSonipatHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SoilPropertiesSonipatHaryanaApi.md#get_features) | **GET** /collections/1c4beb0b-34a7-456c-887f-4cd890987f57/items | Get features from Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_collection**](SoilPropertiesSonipatHaryanaApi.md#get_specific_collection) | **GET** /collections/1c4beb0b-34a7-456c-887f-4cd890987f57 | Metadata about Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_feature**](SoilPropertiesSonipatHaryanaApi.md#get_specific_feature) | **GET** /collections/1c4beb0b-34a7-456c-887f-4cd890987f57/items/{featureId} | Get single feature from Polygon feature illustrating the extent of soil and its associated attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SoilPropertiesSonipatHaryanaApi(api_client)
    ...
    try:
        ...
        print("The response of SoilPropertiesSonipatHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesSonipatHaryanaApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesSonipatHaryanaApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesSonipatHaryanaApi->get_specific_collection: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesSonipatHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesSonipatHaryanaApi->get_specific_feature: %s\n" % e)
```
