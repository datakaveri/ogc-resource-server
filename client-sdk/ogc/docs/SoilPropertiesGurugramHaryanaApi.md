# openapi_client.SoilPropertiesGurugramHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SoilPropertiesGurugramHaryanaApi.md#get_features) | **GET** /collections/4e368007-c40d-4ea2-a3f8-8a9aabed7160/items | Get features from Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_collection**](SoilPropertiesGurugramHaryanaApi.md#get_specific_collection) | **GET** /collections/4e368007-c40d-4ea2-a3f8-8a9aabed7160 | Metadata about Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_feature**](SoilPropertiesGurugramHaryanaApi.md#get_specific_feature) | **GET** /collections/4e368007-c40d-4ea2-a3f8-8a9aabed7160/items/{featureId} | Get single feature from Polygon feature illustrating the extent of soil and its associated attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SoilPropertiesGurugramHaryanaApi(api_client)
    ...
    try:
        ...
        print("The response of SoilPropertiesGurugramHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesGurugramHaryanaApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesGurugramHaryanaApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesGurugramHaryanaApi->get_specific_collection: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesGurugramHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesGurugramHaryanaApi->get_specific_feature: %s\n" % e)
```
