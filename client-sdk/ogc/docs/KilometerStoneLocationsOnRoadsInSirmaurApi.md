# openapi_client.KilometerStoneLocationsOnRoadsInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](KilometerStoneLocationsOnRoadsInSirmaurApi.md#get_features) | **GET** /collections/6a2f5e28-a032-403e-b94b-c6821bb01a35/items | Get features from Location of KM stone on roads
[**get_specific_collection**](KilometerStoneLocationsOnRoadsInSirmaurApi.md#get_specific_collection) | **GET** /collections/6a2f5e28-a032-403e-b94b-c6821bb01a35 | Metadata about Location of KM stone on roads
[**get_specific_feature**](KilometerStoneLocationsOnRoadsInSirmaurApi.md#get_specific_feature) | **GET** /collections/6a2f5e28-a032-403e-b94b-c6821bb01a35/items/{featureId} | Get single feature from Location of KM stone on roads


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, dist_km=dist_km, rd_cat=rd_cat, rd_sbcat=rd_sbcat)

Get features from Location of KM stone on roads
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Location of KM stone on roads
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, dist_km=dist_km, rd_cat=rd_cat, rd_sbcat=rd_sbcat)
        print("The response of KilometerStoneLocationsOnRoadsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KilometerStoneLocationsOnRoadsInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Location of KM stone on roads
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KilometerStoneLocationsOnRoadsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KilometerStoneLocationsOnRoadsInSirmaurApi->get_specific_feature: %s\n" % e)
```
