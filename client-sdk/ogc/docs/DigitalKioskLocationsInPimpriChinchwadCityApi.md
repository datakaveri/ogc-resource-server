...
# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, ward_name=ward_name, address=address, name=name, zone_name=zone_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from The physical coordinates of Digital Kiosk System locations in Pimpri-Chinchwad city.
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, ward_name=ward_name, address=address, name=name, zone_name=zone_name)
