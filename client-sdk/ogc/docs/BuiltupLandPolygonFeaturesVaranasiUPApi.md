# openapi_client.BuiltupLandPolygonFeaturesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](BuiltupLandPolygonFeaturesVaranasiUPApi.md#get_features) | **GET** /collections/5ecbbd8e-5bbc-44ea-81b0-3551e978f50c/items | Get features from Polygon features of coarsely mapped builtup land extent in Varanasi, UP
[**get_specific_collection**](BuiltupLandPolygonFeaturesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/5ecbbd8e-5bbc-44ea-81b0-3551e978f50c | Metadata about Polygon features of coarsely mapped builtup land extent in Varanasi, UP
[**get_specific_feature**](BuiltupLandPolygonFeaturesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/5ecbbd8e-5bbc-44ea-81b0-3551e978f50c/items/{featureId} | Get single feature from Polygon features of coarsely mapped builtup land extent in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, name=name)

Get features from Polygon features of coarsely mapped builtup land extent in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Polygon features of coarsely mapped builtup land extent in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, name=name)
        print("The response of BuiltupLandPolygonFeaturesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BuiltupLandPolygonFeaturesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of coarsely mapped builtup land extent in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BuiltupLandPolygonFeaturesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BuiltupLandPolygonFeaturesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
