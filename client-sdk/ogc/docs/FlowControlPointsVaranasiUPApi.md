# openapi_client.FlowControlPointsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](FlowControlPointsVaranasiUPApi.md#get_features) | **GET** /collections/30d349fb-dc57-4e04-ac64-cf7134b9618a/items | Get features from Flow control point features with its attributes in Varanasi, UP
[**get_specific_collection**](FlowControlPointsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/30d349fb-dc57-4e04-ac64-cf7134b9618a | Metadata about Flow control point features with its attributes in Varanasi, UP
[**get_specific_feature**](FlowControlPointsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/30d349fb-dc57-4e04-ac64-cf7134b9618a/items/{featureId} | Get single feature from Flow control point features with its attributes in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, perinlty1=perinlty1, c_mtrl_1=c_mtrl_1, cat=cat, ftr_on1=ftr_on1)

Get features from Flow control point features with its attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    perinlty1 = 'perinlty1_example' # str |  (optional)
    c_mtrl_1 = 'c_mtrl_1_example' # str |  (optional)
    cat = 'cat_example' # str |  (optional)
    ftr_on1 = 'ftr_on1_example' # str |  (optional)

    try:
        # Get features from Flow control point features with its attributes in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, perinlty1=perinlty1, c_mtrl_1=c_mtrl_1, cat=cat, ftr_on1=ftr_on1)
        print("The response of FlowControlPointsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowControlPointsVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **perinlty1** | **str**|  | [optional] 
 **c_mtrl_1** | **str**|  | [optional] 
 **cat** | **str**|  | [optional] 
 **ftr_on1** | **str**|  | [optional] 
...
Get single feature from Flow control point features with its attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowControlPointsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowControlPointsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
