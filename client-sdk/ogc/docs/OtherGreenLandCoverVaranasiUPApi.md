# openapi_client.OtherGreenLandCoverVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](OtherGreenLandCoverVaranasiUPApi.md#get_features) | **GET** /collections/ac55a25e-eeea-4239-bde2-782785b78450/items | Get features from Polygon features of green cover in Varanasi, UP
[**get_specific_collection**](OtherGreenLandCoverVaranasiUPApi.md#get_specific_collection) | **GET** /collections/ac55a25e-eeea-4239-bde2-782785b78450 | Metadata about Polygon features of green cover in Varanasi, UP
[**get_specific_feature**](OtherGreenLandCoverVaranasiUPApi.md#get_specific_feature) | **GET** /collections/ac55a25e-eeea-4239-bde2-782785b78450/items/{featureId} | Get single feature from Polygon features of green cover in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, density=density, category=category)

Get features from Polygon features of green cover in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Polygon features of green cover in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, density=density, category=category)
        print("The response of OtherGreenLandCoverVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherGreenLandCoverVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of green cover in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OtherGreenLandCoverVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherGreenLandCoverVaranasiUPApi->get_specific_feature: %s\n" % e)
```
