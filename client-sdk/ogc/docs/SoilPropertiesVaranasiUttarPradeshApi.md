# openapi_client.SoilPropertiesVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SoilPropertiesVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/ada25e47-a6b1-4043-bfbb-81e2206799c7/items | Get features from Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_collection**](SoilPropertiesVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/ada25e47-a6b1-4043-bfbb-81e2206799c7 | Metadata about Polygon feature illustrating the extent of soil and its associated attributes
[**get_specific_feature**](SoilPropertiesVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/ada25e47-a6b1-4043-bfbb-81e2206799c7/items/{featureId} | Get single feature from Polygon feature illustrating the extent of soil and its associated attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SoilPropertiesVaranasiUttarPradeshApi(api_client)
    ...
    try:
        ...
        print("The response of SoilPropertiesVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesVaranasiUttarPradeshApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesVaranasiUttarPradeshApi->get_specific_collection: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SoilPropertiesVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SoilPropertiesVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
