# openapi_client.ExtentOfSandyAreasVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ExtentOfSandyAreasVaranasiUPApi.md#get_features) | **GET** /collections/96ffe3ff-cdf1-4afc-adc8-c7c142b49a7d/items | Get features from Geographical extent of sandy areas as polygon features with attributes in Varanasi, UP
[**get_specific_collection**](ExtentOfSandyAreasVaranasiUPApi.md#get_specific_collection) | **GET** /collections/96ffe3ff-cdf1-4afc-adc8-c7c142b49a7d | Metadata about Geographical extent of sandy areas as polygon features with attributes in Varanasi, UP
[**get_specific_feature**](ExtentOfSandyAreasVaranasiUPApi.md#get_specific_feature) | **GET** /collections/96ffe3ff-cdf1-4afc-adc8-c7c142b49a7d/items/{featureId} | Get single feature from Geographical extent of sandy areas as polygon features with attributes in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, cat=cat, asso_f_1=asso_f_1)

Get features from Geographical extent of sandy areas as polygon features with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    asso_f_1 = 'asso_f_1_example' # str |  (optional)

    try:
        # Get features from Geographical extent of sandy areas as polygon features with attributes in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, cat=cat, asso_f_1=asso_f_1)
        print("The response of ExtentOfSandyAreasVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExtentOfSandyAreasVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Geographical extent of sandy areas as polygon features with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ExtentOfSandyAreasVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ExtentOfSandyAreasVaranasiUPApi->get_specific_feature: %s\n" % e)
```
