...
------------- | ------------- | -------------
[**get_features**](CartTracksVaranasiUPApi.md#get_features) | **GET** /collections/2b1af92b-d92c-4642-8c1b-ac46f22efa2e/items | Get features from Line features representing cart tracks in Varanasi, UP
[**get_specific_collection**](CartTracksVaranasiUPApi.md#get_specific_collection) | **GET** /collections/2b1af92b-d92c-4642-8c1b-ac46f22efa2e | Metadata about Line features representing cart tracks in Varanasi, UP
[**get_specific_feature**](CartTracksVaranasiUPApi.md#get_specific_feature) | **GET** /collections/2b1af92b-d92c-4642-8c1b-ac46f22efa2e/items/{featureId} | Get single feature from Line features representing cart tracks in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, addl_info=addl_info, track_type=track_type)

Get features from Line features representing cart tracks in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    track_type = 'track_type_example' # str |  (optional)

    try:
        # Get features from Line features representing cart tracks in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, addl_info=addl_info, track_type=track_type)
        print("The response of CartTracksVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CartTracksVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing cart tracks in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CartTracksVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CartTracksVaranasiUPApi->get_specific_feature: %s\n" % e)
```
