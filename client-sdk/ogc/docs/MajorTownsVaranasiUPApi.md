# openapi_client.MajorTownsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MajorTownsVaranasiUPApi.md#get_features) | **GET** /collections/bf2f6d45-0780-4f1d-a4b8-481d97425bb9/items | Get features from Locations of major towns in Varanasi, UP
[**get_specific_collection**](MajorTownsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/bf2f6d45-0780-4f1d-a4b8-481d97425bb9 | Metadata about Locations of major towns in Varanasi, UP
[**get_specific_feature**](MajorTownsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/bf2f6d45-0780-4f1d-a4b8-481d97425bb9/items/{featureId} | Get single feature from Locations of major towns in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, subdivision=subdivision, lgd_state_code=lgd_state_code, name_of_to=name_of_to, lgd_sub_dist_code=lgd_sub_dist_code, district=district, state=state, lgd_district_code=lgd_district_code, soi_code=soi_code)

Get features from Locations of major towns in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    subdivision = 'subdivision_example' # str |  (optional)
    lgd_state_code = 56 # int |  (optional)
    name_of_to = 'name_of_to_example' # str |  (optional)
    lgd_sub_dist_code = 56 # int |  (optional)
    district = 'district_example' # str |  (optional)
    state = 'state_example' # str |  (optional)
    lgd_district_code = 56 # int |  (optional)
    soi_code = 'soi_code_example' # str |  (optional)

    try:
        # Get features from Locations of major towns in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, subdivision=subdivision, lgd_state_code=lgd_state_code, name_of_to=name_of_to, lgd_sub_dist_code=lgd_sub_dist_code, district=district, state=state, lgd_district_code=lgd_district_code, soi_code=soi_code)
        print("The response of MajorTownsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MajorTownsVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **lgd_state_code** | **int**|  | [optional] 
 **name_of_to** | **str**|  | [optional] 
 **lgd_sub_dist_code** | **int**|  | [optional] 
 **district** | **str**|  | [optional] 
 **state** | **str**|  | [optional] 
 **lgd_district_code** | **int**|  | [optional] 
 **soi_code** | **str**|  | [optional] 
...
Get single feature from Locations of major towns in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MajorTownsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MajorTownsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
