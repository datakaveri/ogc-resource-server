# openapi_client.CoastlineOfTamilNaduIn2019Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CoastlineOfTamilNaduIn2019Api.md#get_features) | **GET** /collections/74aeae5f-9b9b-43fa-b605-074610c8f1a7/items | Get features from Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2019
[**get_specific_collection**](CoastlineOfTamilNaduIn2019Api.md#get_specific_collection) | **GET** /collections/74aeae5f-9b9b-43fa-b605-074610c8f1a7 | Metadata about Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2019
[**get_specific_feature**](CoastlineOfTamilNaduIn2019Api.md#get_specific_feature) | **GET** /collections/74aeae5f-9b9b-43fa-b605-074610c8f1a7/items/{featureId} | Get single feature from Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2019
...
Get features from Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2019
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CoastlineOfTamilNaduIn2019Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoastlineOfTamilNaduIn2019Api->get_features: %s\n" % e)
```
...
Get single feature from Coastline of Tamil Nadu mapped from Landsat 8 satellite data acquired in the year 2019
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CoastlineOfTamilNaduIn2019Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoastlineOfTamilNaduIn2019Api->get_specific_feature: %s\n" % e)
```
