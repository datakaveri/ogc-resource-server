# openapi_client.CanalsInVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CanalsInVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/f6287b81-2b9d-442a-92ba-a34519b85a2b/items | Get features from Line features representing canals in Varanasi distrcit of Uttar Pradesh
[**get_specific_collection**](CanalsInVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/f6287b81-2b9d-442a-92ba-a34519b85a2b | Metadata about Line features representing canals in Varanasi distrcit of Uttar Pradesh
[**get_specific_feature**](CanalsInVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/f6287b81-2b9d-442a-92ba-a34519b85a2b/items/{featureId} | Get single feature from Line features representing canals in Varanasi distrcit of Uttar Pradesh


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, gid=gid, name=name)

Get features from Line features representing canals in Varanasi distrcit of Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Line features representing canals in Varanasi distrcit of Uttar Pradesh
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, gid=gid, name=name)
        print("The response of CanalsInVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CanalsInVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing canals in Varanasi distrcit of Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CanalsInVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CanalsInVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
