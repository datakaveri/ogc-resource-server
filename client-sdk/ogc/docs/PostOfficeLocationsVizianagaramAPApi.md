# openapi_client.PostOfficeLocationsVizianagaramAPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PostOfficeLocationsVizianagaramAPApi.md#get_features) | **GET** /collections/176ad1f4-d466-43ef-a72a-ed10124e0138/items | Get features from Point features of post offices in Vizianagaram District, Andhra Pradesh
[**get_specific_collection**](PostOfficeLocationsVizianagaramAPApi.md#get_specific_collection) | **GET** /collections/176ad1f4-d466-43ef-a72a-ed10124e0138 | Metadata about Point features of post offices in Vizianagaram District, Andhra Pradesh
[**get_specific_feature**](PostOfficeLocationsVizianagaramAPApi.md#get_specific_feature) | **GET** /collections/176ad1f4-d466-43ef-a72a-ed10124e0138/items/{featureId} | Get single feature from Point features of post offices in Vizianagaram District, Andhra Pradesh
...
Get features from Point features of post offices in Vizianagaram District, Andhra Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficeLocationsVizianagaramAPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficeLocationsVizianagaramAPApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of post offices in Vizianagaram District, Andhra Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PostOfficeLocationsVizianagaramAPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostOfficeLocationsVizianagaramAPApi->get_specific_feature: %s\n" % e)
```
