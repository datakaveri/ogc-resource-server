# openapi_client.CulvertsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CulvertsVaranasiUPApi.md#get_features) | **GET** /collections/0888918f-7173-48d8-a368-1c677e979781/items | Get features from Locations of culverts in Varanasi, UP
[**get_specific_collection**](CulvertsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/0888918f-7173-48d8-a368-1c677e979781 | Metadata about Locations of culverts in Varanasi, UP
[**get_specific_feature**](CulvertsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/0888918f-7173-48d8-a368-1c677e979781/items/{featureId} | Get single feature from Locations of culverts in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, addl_info=addl_info, unique_id=unique_id)

Get features from Locations of culverts in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Locations of culverts in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, addl_info=addl_info, unique_id=unique_id)
        print("The response of CulvertsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CulvertsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of culverts in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CulvertsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CulvertsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
