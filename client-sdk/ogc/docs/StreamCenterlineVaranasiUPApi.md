# openapi_client.StreamCenterlineVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](StreamCenterlineVaranasiUPApi.md#get_features) | **GET** /collections/0292a70e-efa6-4ec3-b65a-e8c6af89bfb3/items | Get features from Centerlines of linear waterbodies with attribute information in Varanasi, UP
[**get_specific_collection**](StreamCenterlineVaranasiUPApi.md#get_specific_collection) | **GET** /collections/0292a70e-efa6-4ec3-b65a-e8c6af89bfb3 | Metadata about Centerlines of linear waterbodies with attribute information in Varanasi, UP
[**get_specific_feature**](StreamCenterlineVaranasiUPApi.md#get_specific_feature) | **GET** /collections/0292a70e-efa6-4ec3-b65a-e8c6af89bfb3/items/{featureId} | Get single feature from Centerlines of linear waterbodies with attribute information in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, gradutn=gradutn, tidal=tidal, perinlty=perinlty, course=course, name=name)

Get features from Centerlines of linear waterbodies with attribute information in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    gradutn = 'gradutn_example' # str |  (optional)
    tidal = 'tidal_example' # str |  (optional)
    ...
    try:
        # Get features from Centerlines of linear waterbodies with attribute information in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, gradutn=gradutn, tidal=tidal, perinlty=perinlty, course=course, name=name)
        print("The response of StreamCenterlineVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamCenterlineVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Centerlines of linear waterbodies with attribute information in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StreamCenterlineVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamCenterlineVaranasiUPApi->get_specific_feature: %s\n" % e)
```
