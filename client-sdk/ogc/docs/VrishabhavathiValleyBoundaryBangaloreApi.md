# openapi_client.VrishabhavathiValleyBoundaryBangaloreApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](VrishabhavathiValleyBoundaryBangaloreApi.md#get_features) | **GET** /collections/4fddb02a-643b-43c2-b245-d0be76e3b7c6/items | Get features from Polygon boundary of Vrishabhavathi Valley in Bangalore
[**get_specific_collection**](VrishabhavathiValleyBoundaryBangaloreApi.md#get_specific_collection) | **GET** /collections/4fddb02a-643b-43c2-b245-d0be76e3b7c6 | Metadata about Polygon boundary of Vrishabhavathi Valley in Bangalore
[**get_specific_feature**](VrishabhavathiValleyBoundaryBangaloreApi.md#get_specific_feature) | **GET** /collections/4fddb02a-643b-43c2-b245-d0be76e3b7c6/items/{featureId} | Get single feature from Polygon boundary of Vrishabhavathi Valley in Bangalore
...
Get features from Polygon boundary of Vrishabhavathi Valley in Bangalore
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VrishabhavathiValleyBoundaryBangaloreApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VrishabhavathiValleyBoundaryBangaloreApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon boundary of Vrishabhavathi Valley in Bangalore
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VrishabhavathiValleyBoundaryBangaloreApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VrishabhavathiValleyBoundaryBangaloreApi->get_specific_feature: %s\n" % e)
```
