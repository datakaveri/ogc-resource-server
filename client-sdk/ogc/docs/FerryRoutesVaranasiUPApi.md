# openapi_client.FerryRoutesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](FerryRoutesVaranasiUPApi.md#get_features) | **GET** /collections/bccc1787-79c4-4de9-9d8e-a20ef2fe2d66/items | Get features from Line features representing ferry routes in Varanasi, UP
[**get_specific_collection**](FerryRoutesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/bccc1787-79c4-4de9-9d8e-a20ef2fe2d66 | Metadata about Line features representing ferry routes in Varanasi, UP
[**get_specific_feature**](FerryRoutesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/bccc1787-79c4-4de9-9d8e-a20ef2fe2d66/items/{featureId} | Get single feature from Line features representing ferry routes in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, addl_info=addl_info)

Get features from Line features representing ferry routes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Line features representing ferry routes in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, addl_info=addl_info)
        print("The response of FerryRoutesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FerryRoutesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features representing ferry routes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FerryRoutesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FerryRoutesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
