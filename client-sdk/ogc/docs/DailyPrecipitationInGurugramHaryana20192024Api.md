# openapi_client.DailyPrecipitationInGurugramHaryana20192024Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DailyPrecipitationInGurugramHaryana20192024Api.md#get_features) | **GET** /collections/1b2af9b5-6fd4-4ea4-a143-156d20b62696/items | Get features from Village wise daily precipitation data for Gurugram district in Haryana from 01-01-2019 to 30-09-2024
[**get_specific_collection**](DailyPrecipitationInGurugramHaryana20192024Api.md#get_specific_collection) | **GET** /collections/1b2af9b5-6fd4-4ea4-a143-156d20b62696 | Metadata about Village wise daily precipitation data for Gurugram district in Haryana from 01-01-2019 to 30-09-2024
[**get_specific_feature**](DailyPrecipitationInGurugramHaryana20192024Api.md#get_specific_feature) | **GET** /collections/1b2af9b5-6fd4-4ea4-a143-156d20b62696/items/{featureId} | Get single feature from Village wise daily precipitation data for Gurugram district in Haryana from 01-01-2019 to 30-09-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, precipitation=precipitation, value_name=value_name, state=state, dates=dates, tehsil=tehsil)

Get features from Village wise daily precipitation data for Gurugram district in Haryana from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Village wise daily precipitation data for Gurugram district in Haryana from 01-01-2019 to 30-09-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, precipitation=precipitation, value_name=value_name, state=state, dates=dates, tehsil=tehsil)
        print("The response of DailyPrecipitationInGurugramHaryana20192024Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipitationInGurugramHaryana20192024Api->get_features: %s\n" % e)
```
...
Get single feature from Village wise daily precipitation data for Gurugram district in Haryana from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DailyPrecipitationInGurugramHaryana20192024Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipitationInGurugramHaryana20192024Api->get_specific_feature: %s\n" % e)
```
