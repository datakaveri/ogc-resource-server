# openapi_client.ImportantBuildingsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ImportantBuildingsVaranasiUPApi.md#get_features) | **GET** /collections/f8919899-fddb-446d-b299-b08e56fadfb9/items | Get features from Point locations of important buildings in Varanasi, UP
[**get_specific_collection**](ImportantBuildingsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/f8919899-fddb-446d-b299-b08e56fadfb9 | Metadata about Point locations of important buildings in Varanasi, UP
[**get_specific_feature**](ImportantBuildingsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/f8919899-fddb-446d-b299-b08e56fadfb9/items/{featureId} | Get single feature from Point locations of important buildings in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, category=category, ownershp=ownershp)

Get features from Point locations of important buildings in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Point locations of important buildings in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, category=category, ownershp=ownershp)
        print("The response of ImportantBuildingsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImportantBuildingsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of important buildings in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ImportantBuildingsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ImportantBuildingsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
