# openapi_client.SurveyedWaterTanksVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SurveyedWaterTanksVaranasiUPApi.md#get_features) | **GET** /collections/9191759e-6263-4f77-88a2-c84dedc499e9/items | Get features from Polygon features representing surveyed water tanks in in Varanasi, UP
[**get_specific_collection**](SurveyedWaterTanksVaranasiUPApi.md#get_specific_collection) | **GET** /collections/9191759e-6263-4f77-88a2-c84dedc499e9 | Metadata about Polygon features representing surveyed water tanks in in Varanasi, UP
[**get_specific_feature**](SurveyedWaterTanksVaranasiUPApi.md#get_specific_feature) | **GET** /collections/9191759e-6263-4f77-88a2-c84dedc499e9/items/{featureId} | Get single feature from Polygon features representing surveyed water tanks in in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, loc_name=loc_name, unique_id=unique_id)

Get features from Polygon features representing surveyed water tanks in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Polygon features representing surveyed water tanks in in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, loc_name=loc_name, unique_id=unique_id)
        print("The response of SurveyedWaterTanksVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SurveyedWaterTanksVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features representing surveyed water tanks in in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SurveyedWaterTanksVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SurveyedWaterTanksVaranasiUPApi->get_specific_feature: %s\n" % e)
```
