# openapi_client.BankBranchLocationsGurugramHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](BankBranchLocationsGurugramHaryanaApi.md#get_features) | **GET** /collections/b26cfbcf-1f4d-408f-bd9a-aebb7a747ec0/items | Get features from Point features of bank branches in Gurugram District, Haryana
[**get_specific_collection**](BankBranchLocationsGurugramHaryanaApi.md#get_specific_collection) | **GET** /collections/b26cfbcf-1f4d-408f-bd9a-aebb7a747ec0 | Metadata about Point features of bank branches in Gurugram District, Haryana
[**get_specific_feature**](BankBranchLocationsGurugramHaryanaApi.md#get_specific_feature) | **GET** /collections/b26cfbcf-1f4d-408f-bd9a-aebb7a747ec0/items/{featureId} | Get single feature from Point features of bank branches in Gurugram District, Haryana
...
Get features from Point features of bank branches in Gurugram District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BankBranchLocationsGurugramHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BankBranchLocationsGurugramHaryanaApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of bank branches in Gurugram District, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BankBranchLocationsGurugramHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BankBranchLocationsGurugramHaryanaApi->get_specific_feature: %s\n" % e)
```
