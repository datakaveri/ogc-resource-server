# openapi_client.EmbankmentOneSideLocationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](EmbankmentOneSideLocationsVaranasiUPApi.md#get_features) | **GET** /collections/d6f7e3c9-8f4b-4c87-bfa4-9d2a2a689d91/items | Get features from Geographic locations of areas with embankments on one side in Varanasi, UP
[**get_specific_collection**](EmbankmentOneSideLocationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/d6f7e3c9-8f4b-4c87-bfa4-9d2a2a689d91 | Metadata about Geographic locations of areas with embankments on one side in Varanasi, UP
[**get_specific_feature**](EmbankmentOneSideLocationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/d6f7e3c9-8f4b-4c87-bfa4-9d2a2a689d91/items/{featureId} | Get single feature from Geographic locations of areas with embankments on one side in Varanasi, UP
...
Get features from Geographic locations of areas with embankments on one side in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EmbankmentOneSideLocationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentOneSideLocationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Geographic locations of areas with embankments on one side in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EmbankmentOneSideLocationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentOneSideLocationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
