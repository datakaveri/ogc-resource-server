# openapi_client.LocationOfBuildingBlocksVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LocationOfBuildingBlocksVaranasiUPApi.md#get_features) | **GET** /collections/63a3d408-43d6-4687-8ada-4604966ba7b8/items | Get features from Polygon features of building blocks in Varanasi, UP
[**get_specific_collection**](LocationOfBuildingBlocksVaranasiUPApi.md#get_specific_collection) | **GET** /collections/63a3d408-43d6-4687-8ada-4604966ba7b8 | Metadata about Polygon features of building blocks in Varanasi, UP
[**get_specific_feature**](LocationOfBuildingBlocksVaranasiUPApi.md#get_specific_feature) | **GET** /collections/63a3d408-43d6-4687-8ada-4604966ba7b8/items/{featureId} | Get single feature from Polygon features of building blocks in Varanasi, UP
...
Get features from Polygon features of building blocks in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationOfBuildingBlocksVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfBuildingBlocksVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of building blocks in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationOfBuildingBlocksVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfBuildingBlocksVaranasiUPApi->get_specific_feature: %s\n" % e)
```
