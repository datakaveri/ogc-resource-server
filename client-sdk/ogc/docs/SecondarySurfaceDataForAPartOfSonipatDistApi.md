# openapi_client.SecondarySurfaceDataForAPartOfSonipatDistApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SecondarySurfaceDataForAPartOfSonipatDistApi.md#get_features) | **GET** /collections/9716ef80-5324-4d18-bf7f-ed21baee09e0/items | Get features from Polygon features representing secondary surface data for a part of Sonipat district, Haryana
[**get_specific_collection**](SecondarySurfaceDataForAPartOfSonipatDistApi.md#get_specific_collection) | **GET** /collections/9716ef80-5324-4d18-bf7f-ed21baee09e0 | Metadata about Polygon features representing secondary surface data for a part of Sonipat district, Haryana
[**get_specific_feature**](SecondarySurfaceDataForAPartOfSonipatDistApi.md#get_specific_feature) | **GET** /collections/9716ef80-5324-4d18-bf7f-ed21baee09e0/items/{featureId} | Get single feature from Polygon features representing secondary surface data for a part of Sonipat district, Haryana


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, toposheet_=toposheet_, manifestat=manifestat)

Get features from Polygon features representing secondary surface data for a part of Sonipat district, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    manifestat = 'manifestat_example' # str |  (optional)

    try:
        # Get features from Polygon features representing secondary surface data for a part of Sonipat district, Haryana
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, toposheet_=toposheet_, manifestat=manifestat)
        print("The response of SecondarySurfaceDataForAPartOfSonipatDistApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SecondarySurfaceDataForAPartOfSonipatDistApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features representing secondary surface data for a part of Sonipat district, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SecondarySurfaceDataForAPartOfSonipatDistApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SecondarySurfaceDataForAPartOfSonipatDistApi->get_specific_feature: %s\n" % e)
```
