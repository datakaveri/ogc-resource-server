# openapi_client.LiftStationLocationsInSomeDistrictsHaryanaApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LiftStationLocationsInSomeDistrictsHaryanaApi.md#get_features) | **GET** /collections/75377c4c-e0be-432a-8d29-4787d1a6d175/items | Get features from Point features representing lift station locations in selected districts of Haryana
[**get_specific_collection**](LiftStationLocationsInSomeDistrictsHaryanaApi.md#get_specific_collection) | **GET** /collections/75377c4c-e0be-432a-8d29-4787d1a6d175 | Metadata about Point features representing lift station locations in selected districts of Haryana
[**get_specific_feature**](LiftStationLocationsInSomeDistrictsHaryanaApi.md#get_specific_feature) | **GET** /collections/75377c4c-e0be-432a-8d29-4787d1a6d175/items/{featureId} | Get single feature from Point features representing lift station locations in selected districts of Haryana


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, stcode=stcode, lft_ph_lat=lft_ph_lat, lft_opt=lft_opt, lift_ht=lift_ht, lft_ph_lon=lft_ph_lon, lft_name_a=lft_name_a, lftcode=lftcode, lft_name=lft_name, bacode=bacode, lft_disc=lft_disc)

Get features from Point features representing lift station locations in selected districts of Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    lft_ph_lat = 3.4 # float |  (optional)
    lft_opt = 'lft_opt_example' # str |  (optional)
    lift_ht = 'lift_ht_example' # str |  (optional)
    lft_ph_lon = 3.4 # float |  (optional)
    lft_name_a = 'lft_name_a_example' # str |  (optional)
    lftcode = 'lftcode_example' # str |  (optional)
    lft_name = 'lft_name_example' # str |  (optional)
    bacode = 'bacode_example' # str |  (optional)
    lft_disc = 'lft_disc_example' # str |  (optional)

    try:
        # Get features from Point features representing lift station locations in selected districts of Haryana
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, stcode=stcode, lft_ph_lat=lft_ph_lat, lft_opt=lft_opt, lift_ht=lift_ht, lft_ph_lon=lft_ph_lon, lft_name_a=lft_name_a, lftcode=lftcode, lft_name=lft_name, bacode=bacode, lft_disc=lft_disc)
        print("The response of LiftStationLocationsInSomeDistrictsHaryanaApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LiftStationLocationsInSomeDistrictsHaryanaApi->get_features: %s\n" % e)
```
 ...
 **stcode** | **str**|  | [optional] 
 **lft_ph_lat** | **float**|  | [optional] 
 **lft_opt** | **str**|  | [optional] 
 **lift_ht** | **str**|  | [optional] 
 **lft_ph_lon** | **float**|  | [optional] 
 **lft_name_a** | **str**|  | [optional] 
 **lftcode** | **str**|  | [optional] 
 **lft_name** | **str**|  | [optional] 
 **bacode** | **str**|  | [optional] 
 **lft_disc** | **str**|  | [optional] 
...
Get single feature from Point features representing lift station locations in selected districts of Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LiftStationLocationsInSomeDistrictsHaryanaApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LiftStationLocationsInSomeDistrictsHaryanaApi->get_specific_feature: %s\n" % e)
```
