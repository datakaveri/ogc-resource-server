# openapi_client.SchoolLocationsWashimMaharashtraApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](SchoolLocationsWashimMaharashtraApi.md#get_features) | **GET** /collections/9c65a5f1-1100-4cd9-a9d7-d5706e10e0d3/items | Get features from Point features of schools in Washim District, Maharashtra
[**get_specific_collection**](SchoolLocationsWashimMaharashtraApi.md#get_specific_collection) | **GET** /collections/9c65a5f1-1100-4cd9-a9d7-d5706e10e0d3 | Metadata about Point features of schools in Washim District, Maharashtra
[**get_specific_feature**](SchoolLocationsWashimMaharashtraApi.md#get_specific_feature) | **GET** /collections/9c65a5f1-1100-4cd9-a9d7-d5706e10e0d3/items/{featureId} | Get single feature from Point features of schools in Washim District, Maharashtra
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SchoolLocationsWashimMaharashtraApi->get_features: %s\n" % e)
```
...
Get single feature from Point features of schools in Washim District, Maharashtra
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of SchoolLocationsWashimMaharashtraApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchoolLocationsWashimMaharashtraApi->get_specific_feature: %s\n" % e)
```
