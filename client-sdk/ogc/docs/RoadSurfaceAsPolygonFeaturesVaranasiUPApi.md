# openapi_client.RoadSurfaceAsPolygonFeaturesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RoadSurfaceAsPolygonFeaturesVaranasiUPApi.md#get_features) | **GET** /collections/e9264ed8-4089-4e9c-9c87-87ed16c6e0a6/items | Get features from Geographical extent of the major roads as polygon features  with attributes in Varanasi, UP
[**get_specific_collection**](RoadSurfaceAsPolygonFeaturesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/e9264ed8-4089-4e9c-9c87-87ed16c6e0a6 | Metadata about Geographical extent of the major roads as polygon features  with attributes in Varanasi, UP
[**get_specific_feature**](RoadSurfaceAsPolygonFeaturesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/e9264ed8-4089-4e9c-9c87-87ed16c6e0a6/items/{featureId} | Get single feature from Geographical extent of the major roads as polygon features  with attributes in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, crrg_way=crrg_way, adl_info=adl_info, category=category, srfc_typ=srfc_typ, subcat=subcat, pavement=pavement, bult_on=bult_on, name=name)

Get features from Geographical extent of the major roads as polygon features  with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    crrg_way = 'crrg_way_example' # str |  (optional)
    adl_info = 'adl_info_example' # str |  (optional)
    category = 56 # int |  (optional)
    srfc_typ = 'srfc_typ_example' # str |  (optional)
    subcat = 'subcat_example' # str |  (optional)
    pavement = 'pavement_example' # str |  (optional)
    bult_on = 'bult_on_example' # str |  (optional)
    name = 'name_example' # str |  (optional)

    try:
        # Get features from Geographical extent of the major roads as polygon features  with attributes in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, crrg_way=crrg_way, adl_info=adl_info, category=category, srfc_typ=srfc_typ, subcat=subcat, pavement=pavement, bult_on=bult_on, name=name)
        print("The response of RoadSurfaceAsPolygonFeaturesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadSurfaceAsPolygonFeaturesVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **status** | **str**|  | [optional] 
 **crrg_way** | **str**|  | [optional] 
 **adl_info** | **str**|  | [optional] 
 **category** | **int**|  | [optional] 
 **srfc_typ** | **str**|  | [optional] 
 **subcat** | **str**|  | [optional] 
 **pavement** | **str**|  | [optional] 
 **bult_on** | **str**|  | [optional] 
 **name** | **str**|  | [optional] 
...
Get single feature from Geographical extent of the major roads as polygon features  with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadSurfaceAsPolygonFeaturesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadSurfaceAsPolygonFeaturesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
