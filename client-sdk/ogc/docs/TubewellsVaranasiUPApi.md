# openapi_client.TubewellsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](TubewellsVaranasiUPApi.md#get_features) | **GET** /collections/ea00f099-db86-4baa-9a05-a71d05ac85e3/items | Get features from Locations of tubewells in Varanasi, UP
[**get_specific_collection**](TubewellsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/ea00f099-db86-4baa-9a05-a71d05ac85e3 | Metadata about Locations of tubewells in Varanasi, UP
[**get_specific_feature**](TubewellsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/ea00f099-db86-4baa-9a05-a71d05ac85e3/items/{featureId} | Get single feature from Locations of tubewells in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, type=type, svy_date=svy_date, gmrotation=gmrotation, addl_info=addl_info, unique_id=unique_id)

Get features from Locations of tubewells in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Locations of tubewells in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, orig_fid=orig_fid, type=type, svy_date=svy_date, gmrotation=gmrotation, addl_info=addl_info, unique_id=unique_id)
        print("The response of TubewellsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TubewellsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of tubewells in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TubewellsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TubewellsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
