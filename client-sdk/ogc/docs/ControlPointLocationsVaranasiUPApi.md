# openapi_client.ControlPointLocationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ControlPointLocationsVaranasiUPApi.md#get_features) | **GET** /collections/62290511-0ec3-44aa-a6a7-ddfa92e43289/items | Get features from Control point locations in Varanasi, UP
[**get_specific_collection**](ControlPointLocationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/62290511-0ec3-44aa-a6a7-ddfa92e43289 | Metadata about Control point locations in Varanasi, UP
[**get_specific_feature**](ControlPointLocationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/62290511-0ec3-44aa-a6a7-ddfa92e43289/items/{featureId} | Get single feature from Control point locations in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, v_datum=v_datum, subcat=subcat, type=type)

Get features from Control point locations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    v_datum = 'v_datum_example' # str |  (optional)
    subcat = 'subcat_example' # str |  (optional)
    type = 'type_example' # str |  (optional)

    try:
        # Get features from Control point locations in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, adl_info=adl_info, category=category, v_datum=v_datum, subcat=subcat, type=type)
        print("The response of ControlPointLocationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ControlPointLocationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Control point locations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ControlPointLocationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ControlPointLocationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
