# openapi_client.MosquesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MosquesVaranasiUPApi.md#get_features) | **GET** /collections/5dcce867-0fcb-4aa1-b710-9f1d3b2d5623/items | Get features from Locations of mosques in Varanasi, UP
[**get_specific_collection**](MosquesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/5dcce867-0fcb-4aa1-b710-9f1d3b2d5623 | Metadata about Locations of mosques in Varanasi, UP
[**get_specific_feature**](MosquesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/5dcce867-0fcb-4aa1-b710-9f1d3b2d5623/items/{featureId} | Get single feature from Locations of mosques in Varanasi, UP
...
Get features from Locations of mosques in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MosquesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MosquesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of mosques in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MosquesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MosquesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
