# openapi_client.DailyPrecipitationInVaranasiUP20192024Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DailyPrecipitationInVaranasiUP20192024Api.md#get_features) | **GET** /collections/4db58374-3181-491c-9a3f-59e7a980ff5c/items | Get features from Village wise daily precipitation data for Varanasi district, UP from 01-01-2019 to 30-09-2024
[**get_specific_collection**](DailyPrecipitationInVaranasiUP20192024Api.md#get_specific_collection) | **GET** /collections/4db58374-3181-491c-9a3f-59e7a980ff5c | Metadata about Village wise daily precipitation data for Varanasi district, UP from 01-01-2019 to 30-09-2024
[**get_specific_feature**](DailyPrecipitationInVaranasiUP20192024Api.md#get_specific_feature) | **GET** /collections/4db58374-3181-491c-9a3f-59e7a980ff5c/items/{featureId} | Get single feature from Village wise daily precipitation data for Varanasi district, UP from 01-01-2019 to 30-09-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, district=district, precipitation=precipitation, value_name=value_name, tahsil=tahsil, dates=dates, vill_name=vill_name, vill_code=vill_code)

Get features from Village wise daily precipitation data for Varanasi district, UP from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    precipitation = 'precipitation_example' # str |  (optional)
    value_name = 'value_name_example' # str |  (optional)
    tahsil = 'tahsil_example' # str |  (optional)
    dates = 'dates_example' # str |  (optional)
    vill_name = 'vill_name_example' # str |  (optional)
    vill_code = 56 # int |  (optional)

    try:
        # Get features from Village wise daily precipitation data for Varanasi district, UP from 01-01-2019 to 30-09-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, district=district, precipitation=precipitation, value_name=value_name, tahsil=tahsil, dates=dates, vill_name=vill_name, vill_code=vill_code)
        print("The response of DailyPrecipitationInVaranasiUP20192024Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipitationInVaranasiUP20192024Api->get_features: %s\n" % e)
```
 ...
 **tahsil** | **str**|  | [optional] 
 **dates** | **str**|  | [optional] 
 **vill_name** | **str**|  | [optional] 
 **vill_code** | **int**|  | [optional] 
...
Get single feature from Village wise daily precipitation data for Varanasi district, UP from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DailyPrecipitationInVaranasiUP20192024Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DailyPrecipitationInVaranasiUP20192024Api->get_specific_feature: %s\n" % e)
```
