...
------------- | ------------- | -------------
[**get_features**](ForestCoverWashimDistrict2021Api.md#get_features) | **GET** /collections/f09f6dc9-9c9d-472d-aec7-c0b6bf149c29/items | Get features from Boundaries of forest cover based on canopy density in Washim distirict, Maharashtra
[**get_specific_collection**](ForestCoverWashimDistrict2021Api.md#get_specific_collection) | **GET** /collections/f09f6dc9-9c9d-472d-aec7-c0b6bf149c29 | Metadata about Boundaries of forest cover based on canopy density in Washim distirict, Maharashtra
[**get_specific_feature**](ForestCoverWashimDistrict2021Api.md#get_specific_feature) | **GET** /collections/f09f6dc9-9c9d-472d-aec7-c0b6bf149c29/items/{featureId} | Get single feature from Boundaries of forest cover based on canopy density in Washim distirict, Maharashtra
...
Get features from Boundaries of forest cover based on canopy density in Washim distirict, Maharashtra
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ForestCoverWashimDistrict2021Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ForestCoverWashimDistrict2021Api->get_features: %s\n" % e)
```
...
Get single feature from Boundaries of forest cover based on canopy density in Washim distirict, Maharashtra
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ForestCoverWashimDistrict2021Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ForestCoverWashimDistrict2021Api->get_specific_feature: %s\n" % e)
```
