# openapi_client.RoadsWithinLandslideZoneWayanadApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RoadsWithinLandslideZoneWayanadApi.md#get_features) | **GET** /collections/8eecedf1-a9a8-4300-9b03-8049351665df/items | Get features from Line features of roads that were damaged in the event of landslide in Wayanad, Kerala
[**get_specific_collection**](RoadsWithinLandslideZoneWayanadApi.md#get_specific_collection) | **GET** /collections/8eecedf1-a9a8-4300-9b03-8049351665df | Metadata about Line features of roads that were damaged in the event of landslide in Wayanad, Kerala
[**get_specific_feature**](RoadsWithinLandslideZoneWayanadApi.md#get_specific_feature) | **GET** /collections/8eecedf1-a9a8-4300-9b03-8049351665df/items/{featureId} | Get single feature from Line features of roads that were damaged in the event of landslide in Wayanad, Kerala


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, fclass=fclass)

Get features from Line features of roads that were damaged in the event of landslide in Wayanad, Kerala
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    fclass = 'fclass_example' # str |  (optional)

    try:
        # Get features from Line features of roads that were damaged in the event of landslide in Wayanad, Kerala
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, fclass=fclass)
        print("The response of RoadsWithinLandslideZoneWayanadApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadsWithinLandslideZoneWayanadApi->get_features: %s\n" % e)
```
...
Get single feature from Line features of roads that were damaged in the event of landslide in Wayanad, Kerala
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadsWithinLandslideZoneWayanadApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadsWithinLandslideZoneWayanadApi->get_specific_feature: %s\n" % e)
```
