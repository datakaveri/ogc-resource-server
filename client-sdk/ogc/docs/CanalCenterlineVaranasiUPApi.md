# openapi_client.CanalCenterlineVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CanalCenterlineVaranasiUPApi.md#get_features) | **GET** /collections/10020c52-5651-4f1c-8331-26920c5e821b/items | Get features from Centerline of canals with its attributes in Varanasi, UP
[**get_specific_collection**](CanalCenterlineVaranasiUPApi.md#get_specific_collection) | **GET** /collections/10020c52-5651-4f1c-8331-26920c5e821b | Metadata about Centerline of canals with its attributes in Varanasi, UP
[**get_specific_feature**](CanalCenterlineVaranasiUPApi.md#get_specific_feature) | **GET** /collections/10020c52-5651-4f1c-8331-26920c5e821b/items/{featureId} | Get single feature from Centerline of canals with its attributes in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, perinlty1=perinlty1, adl_info=adl_info, cat=cat, status_1=status_1, name=name)

Get features from Centerline of canals with its attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    status_1 = 'status_1_example' # str |  (optional)
    name = 'name_example' # str |  (optional)

    try:
        # Get features from Centerline of canals with its attributes in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, perinlty1=perinlty1, adl_info=adl_info, cat=cat, status_1=status_1, name=name)
        print("The response of CanalCenterlineVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CanalCenterlineVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Centerline of canals with its attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CanalCenterlineVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CanalCenterlineVaranasiUPApi->get_specific_feature: %s\n" % e)
```
