# openapi_client.MonthlyNDVIInSonipatHaryana20192024Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MonthlyNDVIInSonipatHaryana20192024Api.md#get_features) | **GET** /collections/eac1dfe4-d232-406c-aae6-61f0cbd2af70/items | Get features from village wise monthly NDVI data for Sonipat district, Haryana from 01-01-2019 to 30-09-2024
[**get_specific_collection**](MonthlyNDVIInSonipatHaryana20192024Api.md#get_specific_collection) | **GET** /collections/eac1dfe4-d232-406c-aae6-61f0cbd2af70 | Metadata about village wise monthly NDVI data for Sonipat district, Haryana from 01-01-2019 to 30-09-2024
[**get_specific_feature**](MonthlyNDVIInSonipatHaryana20192024Api.md#get_specific_feature) | **GET** /collections/eac1dfe4-d232-406c-aae6-61f0cbd2af70/items/{featureId} | Get single feature from village wise monthly NDVI data for Sonipat district, Haryana from 01-01-2019 to 30-09-2024
...
Get features from village wise monthly NDVI data for Sonipat district, Haryana from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonthlyNDVIInSonipatHaryana20192024Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInSonipatHaryana20192024Api->get_features: %s\n" % e)
```
...
Get single feature from village wise monthly NDVI data for Sonipat district, Haryana from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonthlyNDVIInSonipatHaryana20192024Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInSonipatHaryana20192024Api->get_specific_feature: %s\n" % e)
```
