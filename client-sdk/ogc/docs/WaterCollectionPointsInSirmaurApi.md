# openapi_client.WaterCollectionPointsInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterCollectionPointsInSirmaurApi.md#get_features) | **GET** /collections/e9dfa215-c663-4571-b843-8693c5e299f9/items | Get features from Point locations of water collection utilities in Sirmaur
[**get_specific_collection**](WaterCollectionPointsInSirmaurApi.md#get_specific_collection) | **GET** /collections/e9dfa215-c663-4571-b843-8693c5e299f9 | Metadata about Point locations of water collection utilities in Sirmaur
[**get_specific_feature**](WaterCollectionPointsInSirmaurApi.md#get_specific_feature) | **GET** /collections/e9dfa215-c663-4571-b843-8693c5e299f9/items/{featureId} | Get single feature from Point locations of water collection utilities in Sirmaur
...
Get features from Point locations of water collection utilities in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterCollectionPointsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterCollectionPointsInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of water collection utilities in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterCollectionPointsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterCollectionPointsInSirmaurApi->get_specific_feature: %s\n" % e)
```
