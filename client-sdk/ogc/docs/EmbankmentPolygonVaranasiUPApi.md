# openapi_client.EmbankmentPolygonVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](EmbankmentPolygonVaranasiUPApi.md#get_features) | **GET** /collections/174a26aa-84c0-48fc-82a4-d972fd7a5a0f/items | Get features from Polygon features of embankment in Varanasi, UP
[**get_specific_collection**](EmbankmentPolygonVaranasiUPApi.md#get_specific_collection) | **GET** /collections/174a26aa-84c0-48fc-82a4-d972fd7a5a0f | Metadata about Polygon features of embankment in Varanasi, UP
[**get_specific_feature**](EmbankmentPolygonVaranasiUPApi.md#get_specific_feature) | **GET** /collections/174a26aa-84c0-48fc-82a4-d972fd7a5a0f/items/{featureId} | Get single feature from Polygon features of embankment in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, slope_at=slope_at, category=category, af_cat=af_cat)

Get features from Polygon features of embankment in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    slope_at = 'slope_at_example' # str |  (optional)
    category = 'category_example' # str |  (optional)
    af_cat = 'af_cat_example' # str |  (optional)

    try:
        # Get features from Polygon features of embankment in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, slope_at=slope_at, category=category, af_cat=af_cat)
        print("The response of EmbankmentPolygonVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentPolygonVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of embankment in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EmbankmentPolygonVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentPolygonVaranasiUPApi->get_specific_feature: %s\n" % e)
```
