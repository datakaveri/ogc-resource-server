# openapi_client.EventsOfLargeForestFireKamrupMetroDistrictApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](EventsOfLargeForestFireKamrupMetroDistrictApi.md#get_features) | **GET** /collections/a215170c-25d5-44d4-a801-ef7065ade1ae/items | Get features from Polygon layer delineating the extent of large forest fire including attributes
[**get_specific_collection**](EventsOfLargeForestFireKamrupMetroDistrictApi.md#get_specific_collection) | **GET** /collections/a215170c-25d5-44d4-a801-ef7065ade1ae | Metadata about Polygon layer delineating the extent of large forest fire including attributes
[**get_specific_feature**](EventsOfLargeForestFireKamrupMetroDistrictApi.md#get_specific_feature) | **GET** /collections/a215170c-25d5-44d4-a801-ef7065ade1ae/items/{featureId} | Get single feature from Polygon layer delineating the extent of large forest fire including attributes


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, l_t_dic=l_t_dic, first_rang=first_rang, f_s_time=f_s_time, fire_name=fire_name, first_stat=first_stat, first_divi=first_divi, first_circ=first_circ, first_dist=first_dist)

Get features from Polygon layer delineating the extent of large forest fire including attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    l_t_dic = 'l_t_dic_example' # str |  (optional)
    first_rang = 'first_rang_example' # str |  (optional)
    f_s_time = 'f_s_time_example' # str |  (optional)
    fire_name = 'fire_name_example' # str |  (optional)
    first_stat = 'first_stat_example' # str |  (optional)
    first_divi = 'first_divi_example' # str |  (optional)
    first_circ = 'first_circ_example' # str |  (optional)
    first_dist = 'first_dist_example' # str |  (optional)

    try:
        # Get features from Polygon layer delineating the extent of large forest fire including attributes
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, l_t_dic=l_t_dic, first_rang=first_rang, f_s_time=f_s_time, fire_name=fire_name, first_stat=first_stat, first_divi=first_divi, first_circ=first_circ, first_dist=first_dist)
        print("The response of EventsOfLargeForestFireKamrupMetroDistrictApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EventsOfLargeForestFireKamrupMetroDistrictApi->get_features: %s\n" % e)
```
 ...
 **l_t_dic** | **str**|  | [optional] 
 **first_rang** | **str**|  | [optional] 
 **f_s_time** | **str**|  | [optional] 
 **fire_name** | **str**|  | [optional] 
 **first_stat** | **str**|  | [optional] 
 **first_divi** | **str**|  | [optional] 
 **first_circ** | **str**|  | [optional] 
 **first_dist** | **str**|  | [optional] 
...
Get single feature from Polygon layer delineating the extent of large forest fire including attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EventsOfLargeForestFireKamrupMetroDistrictApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EventsOfLargeForestFireKamrupMetroDistrictApi->get_specific_feature: %s\n" % e)
```
