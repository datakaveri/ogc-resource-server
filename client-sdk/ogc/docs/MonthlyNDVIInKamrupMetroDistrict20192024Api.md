# openapi_client.MonthlyNDVIInKamrupMetroDistrict20192024Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MonthlyNDVIInKamrupMetroDistrict20192024Api.md#get_features) | **GET** /collections/00a473b2-c482-4d8d-b2e8-23ca0a9dd143/items | Get features from Village wise monthly NDVI data for Kamrup metropolitan district, Assam from 01-01-2019 to 30-09-2024
[**get_specific_collection**](MonthlyNDVIInKamrupMetroDistrict20192024Api.md#get_specific_collection) | **GET** /collections/00a473b2-c482-4d8d-b2e8-23ca0a9dd143 | Metadata about Village wise monthly NDVI data for Kamrup metropolitan district, Assam from 01-01-2019 to 30-09-2024
[**get_specific_feature**](MonthlyNDVIInKamrupMetroDistrict20192024Api.md#get_specific_feature) | **GET** /collections/00a473b2-c482-4d8d-b2e8-23ca0a9dd143/items/{featureId} | Get single feature from Village wise monthly NDVI data for Kamrup metropolitan district, Assam from 01-01-2019 to 30-09-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, soi_name=soi_name, value_name=value_name, state=state, dates=dates, tehsil=tehsil, ndvi=ndvi)

Get features from Village wise monthly NDVI data for Kamrup metropolitan district, Assam from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    ndvi = 'ndvi_example' # str |  (optional)

    try:
        # Get features from Village wise monthly NDVI data for Kamrup metropolitan district, Assam from 01-01-2019 to 30-09-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, soi_name=soi_name, value_name=value_name, state=state, dates=dates, tehsil=tehsil, ndvi=ndvi)
        print("The response of MonthlyNDVIInKamrupMetroDistrict20192024Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInKamrupMetroDistrict20192024Api->get_features: %s\n" % e)
```
...
Get single feature from Village wise monthly NDVI data for Kamrup metropolitan district, Assam from 01-01-2019 to 30-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonthlyNDVIInKamrupMetroDistrict20192024Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInKamrupMetroDistrict20192024Api->get_specific_feature: %s\n" % e)
```
