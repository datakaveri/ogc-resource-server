# openapi_client.LocationOfUnclassifiedBuildingsInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](LocationOfUnclassifiedBuildingsInSirmaurApi.md#get_features) | **GET** /collections/8170e2fd-6884-491c-89b4-db882d5b05ee/items | Get features from Point locations of buildings that are not classified based on its purpose
[**get_specific_collection**](LocationOfUnclassifiedBuildingsInSirmaurApi.md#get_specific_collection) | **GET** /collections/8170e2fd-6884-491c-89b4-db882d5b05ee | Metadata about Point locations of buildings that are not classified based on its purpose
[**get_specific_feature**](LocationOfUnclassifiedBuildingsInSirmaurApi.md#get_specific_feature) | **GET** /collections/8170e2fd-6884-491c-89b4-db882d5b05ee/items/{featureId} | Get single feature from Point locations of buildings that are not classified based on its purpose


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bldg_typ=bldg_typ)

Get features from Point locations of buildings that are not classified based on its purpose
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Point locations of buildings that are not classified based on its purpose
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, bldg_typ=bldg_typ)
        print("The response of LocationOfUnclassifiedBuildingsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfUnclassifiedBuildingsInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of buildings that are not classified based on its purpose
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LocationOfUnclassifiedBuildingsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LocationOfUnclassifiedBuildingsInSirmaurApi->get_specific_feature: %s\n" % e)
```
