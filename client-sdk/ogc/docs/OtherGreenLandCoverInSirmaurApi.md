# openapi_client.OtherGreenLandCoverInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](OtherGreenLandCoverInSirmaurApi.md#get_features) | **GET** /collections/8e12b30b-f274-4137-af2c-a5fe8c295cf0/items | Get features from Polygon features of green cover like grass, scrub, jungle, meadow and pastures
[**get_specific_collection**](OtherGreenLandCoverInSirmaurApi.md#get_specific_collection) | **GET** /collections/8e12b30b-f274-4137-af2c-a5fe8c295cf0 | Metadata about Polygon features of green cover like grass, scrub, jungle, meadow and pastures
[**get_specific_feature**](OtherGreenLandCoverInSirmaurApi.md#get_specific_feature) | **GET** /collections/8e12b30b-f274-4137-af2c-a5fe8c295cf0/items/{featureId} | Get single feature from Polygon features of green cover like grass, scrub, jungle, meadow and pastures
...
Get features from Polygon features of green cover like grass, scrub, jungle, meadow and pastures
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OtherGreenLandCoverInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherGreenLandCoverInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of green cover like grass, scrub, jungle, meadow and pastures
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of OtherGreenLandCoverInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling OtherGreenLandCoverInSirmaurApi->get_specific_feature: %s\n" % e)
```
