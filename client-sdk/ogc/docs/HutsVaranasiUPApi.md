# openapi_client.HutsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](HutsVaranasiUPApi.md#get_features) | **GET** /collections/4149aa4c-2530-435a-b3d8-bfa7c9376348/items | Get features from Locations of huts in Varanasi, UP
[**get_specific_collection**](HutsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/4149aa4c-2530-435a-b3d8-bfa7c9376348 | Metadata about Locations of huts in Varanasi, UP
[**get_specific_feature**](HutsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/4149aa4c-2530-435a-b3d8-bfa7c9376348/items/{featureId} | Get single feature from Locations of huts in Varanasi, UP
...
Get features from Locations of huts in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HutsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HutsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of huts in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HutsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HutsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
