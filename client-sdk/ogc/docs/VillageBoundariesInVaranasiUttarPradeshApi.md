# openapi_client.VillageBoundariesInVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](VillageBoundariesInVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/1e050089-92bc-41b4-9cef-5f686496b86a/items | Get features from Village boundary dataset for Varanasi with attributes like village name, subdistrict and district
[**get_specific_collection**](VillageBoundariesInVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/1e050089-92bc-41b4-9cef-5f686496b86a | Metadata about Village boundary dataset for Varanasi with attributes like village name, subdistrict and district
[**get_specific_feature**](VillageBoundariesInVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/1e050089-92bc-41b4-9cef-5f686496b86a/items/{featureId} | Get single feature from Village boundary dataset for Varanasi with attributes like village name, subdistrict and district


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, district=district, tahsil=tahsil, vill_name=vill_name, vill_code=vill_code)

Get features from Village boundary dataset for Varanasi with attributes like village name, subdistrict and district
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Village boundary dataset for Varanasi with attributes like village name, subdistrict and district
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, district=district, tahsil=tahsil, vill_name=vill_name, vill_code=vill_code)
        print("The response of VillageBoundariesInVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VillageBoundariesInVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
...
Get single feature from Village boundary dataset for Varanasi with attributes like village name, subdistrict and district
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of VillageBoundariesInVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling VillageBoundariesInVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
