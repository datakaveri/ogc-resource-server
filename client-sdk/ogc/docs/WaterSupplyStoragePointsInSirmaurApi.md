# openapi_client.WaterSupplyStoragePointsInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterSupplyStoragePointsInSirmaurApi.md#get_features) | **GET** /collections/61443d13-2919-4464-97a9-78deefb92d60/items | Get features from Point locations of water supply storage facilities in Sirmaur
[**get_specific_collection**](WaterSupplyStoragePointsInSirmaurApi.md#get_specific_collection) | **GET** /collections/61443d13-2919-4464-97a9-78deefb92d60 | Metadata about Point locations of water supply storage facilities in Sirmaur
[**get_specific_feature**](WaterSupplyStoragePointsInSirmaurApi.md#get_specific_feature) | **GET** /collections/61443d13-2919-4464-97a9-78deefb92d60/items/{featureId} | Get single feature from Point locations of water supply storage facilities in Sirmaur
...
Get features from Point locations of water supply storage facilities in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterSupplyStoragePointsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterSupplyStoragePointsInSirmaurApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of water supply storage facilities in Sirmaur
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterSupplyStoragePointsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterSupplyStoragePointsInSirmaurApi->get_specific_feature: %s\n" % e)
```
