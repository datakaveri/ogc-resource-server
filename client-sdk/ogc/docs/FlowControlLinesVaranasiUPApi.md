# openapi_client.FlowControlLinesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](FlowControlLinesVaranasiUPApi.md#get_features) | **GET** /collections/d400d4af-f6d3-4279-9943-a5fee5ecc631/items | Get features from Flow control line features with its attributes in Varanasi, UP
[**get_specific_collection**](FlowControlLinesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/d400d4af-f6d3-4279-9943-a5fee5ecc631 | Metadata about Flow control line features with its attributes in Varanasi, UP
[**get_specific_feature**](FlowControlLinesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/d400d4af-f6d3-4279-9943-a5fee5ecc631/items/{featureId} | Get single feature from Flow control line features with its attributes in Varanasi, UP
...
Get features from Flow control line features with its attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowControlLinesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowControlLinesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Flow control line features with its attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowControlLinesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowControlLinesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
