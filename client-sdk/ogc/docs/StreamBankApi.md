# openapi_client.StreamBankApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](StreamBankApi.md#get_features) | **GET** /collections/0083155c-ae24-4dfa-879f-d9fbf4f025b7/items | Get features from Line features with information on category, sub category, periniality, tidal influence
[**get_specific_collection**](StreamBankApi.md#get_specific_collection) | **GET** /collections/0083155c-ae24-4dfa-879f-d9fbf4f025b7 | Metadata about Line features with information on category, sub category, periniality, tidal influence
[**get_specific_feature**](StreamBankApi.md#get_specific_feature) | **GET** /collections/0083155c-ae24-4dfa-879f-d9fbf4f025b7/items/{featureId} | Get single feature from Line features with information on category, sub category, periniality, tidal influence
...
Get features from Line features with information on category, sub category, periniality, tidal influence
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StreamBankApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamBankApi->get_features: %s\n" % e)
```
...
Get single feature from Line features with information on category, sub category, periniality, tidal influence
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StreamBankApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StreamBankApi->get_specific_feature: %s\n" % e)
```
