# openapi_client.HistoricPlacesInVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](HistoricPlacesInVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/e7887aeb-ada2-4cf6-8e9d-325993343c02/items | Get features from Point locations of the places with historical importance in Varanasi district of Uttar Pradesh
[**get_specific_collection**](HistoricPlacesInVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/e7887aeb-ada2-4cf6-8e9d-325993343c02 | Metadata about Point locations of the places with historical importance in Varanasi district of Uttar Pradesh
[**get_specific_feature**](HistoricPlacesInVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/e7887aeb-ada2-4cf6-8e9d-325993343c02/items/{featureId} | Get single feature from Point locations of the places with historical importance in Varanasi district of Uttar Pradesh


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, historic=historic, name=name, name_en=name_en)

Get features from Point locations of the places with historical importance in Varanasi district of Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    historic = 'historic_example' # str |  (optional)
    name = 'name_example' # str |  (optional)
    name_en = 'name_en_example' # str |  (optional)

    try:
        # Get features from Point locations of the places with historical importance in Varanasi district of Uttar Pradesh
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, historic=historic, name=name, name_en=name_en)
        print("The response of HistoricPlacesInVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HistoricPlacesInVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of the places with historical importance in Varanasi district of Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HistoricPlacesInVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HistoricPlacesInVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
