# openapi_client.ReservoirsInWashimMaharashtraApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](ReservoirsInWashimMaharashtraApi.md#get_features) | **GET** /collections/6f1f02c1-3048-427c-a7fa-235439385a1c/items | Get features from Polygon features of reservoirs in Washim district, Maharashtra
[**get_specific_collection**](ReservoirsInWashimMaharashtraApi.md#get_specific_collection) | **GET** /collections/6f1f02c1-3048-427c-a7fa-235439385a1c | Metadata about Polygon features of reservoirs in Washim district, Maharashtra
[**get_specific_feature**](ReservoirsInWashimMaharashtraApi.md#get_specific_feature) | **GET** /collections/6f1f02c1-3048-427c-a7fa-235439385a1c/items/{featureId} | Get single feature from Polygon features of reservoirs in Washim district, Maharashtra
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ReservoirsInWashimMaharashtraApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of reservoirs in Washim district, Maharashtra
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ReservoirsInWashimMaharashtraApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ReservoirsInWashimMaharashtraApi->get_specific_feature: %s\n" % e)
```
