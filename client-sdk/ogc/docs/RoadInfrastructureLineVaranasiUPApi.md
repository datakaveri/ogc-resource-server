...
------------- | ------------- | -------------
[**get_features**](RoadInfrastructureLineVaranasiUPApi.md#get_features) | **GET** /collections/635a7576-0c38-4e70-a461-bf0e13903997/items | Get features from Line features of road infrastructure in Varanasi, UP
[**get_specific_collection**](RoadInfrastructureLineVaranasiUPApi.md#get_specific_collection) | **GET** /collections/635a7576-0c38-4e70-a461-bf0e13903997 | Metadata about Line features of road infrastructure in Varanasi, UP
[**get_specific_feature**](RoadInfrastructureLineVaranasiUPApi.md#get_specific_feature) | **GET** /collections/635a7576-0c38-4e70-a461-bf0e13903997/items/{featureId} | Get single feature from Line features of road infrastructure in Varanasi, UP
...
Get features from Line features of road infrastructure in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadInfrastructureLineVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadInfrastructureLineVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Line features of road infrastructure in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadInfrastructureLineVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadInfrastructureLineVaranasiUPApi->get_specific_feature: %s\n" % e)
```
