# openapi_client.CanalInfrastructurePointLocationsInSirmaurApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CanalInfrastructurePointLocationsInSirmaurApi.md#get_features) | **GET** /collections/6ac2ba97-83f9-4ccd-ae24-73fadb431c84/items | Get features from Point locations of Canal infrastructures like aqueduct, viaduct, siphon, tunnel
[**get_specific_collection**](CanalInfrastructurePointLocationsInSirmaurApi.md#get_specific_collection) | **GET** /collections/6ac2ba97-83f9-4ccd-ae24-73fadb431c84 | Metadata about Point locations of Canal infrastructures like aqueduct, viaduct, siphon, tunnel
[**get_specific_feature**](CanalInfrastructurePointLocationsInSirmaurApi.md#get_specific_feature) | **GET** /collections/6ac2ba97-83f9-4ccd-ae24-73fadb431c84/items/{featureId} | Get single feature from Point locations of Canal infrastructures like aqueduct, viaduct, siphon, tunnel


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, af_prnlt=af_prnlt, category=category, af_cat=af_cat, blt_acrs=blt_acrs)

Get features from Point locations of Canal infrastructures like aqueduct, viaduct, siphon, tunnel
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.CanalInfrastructurePointLocationsInSirmaurApi(api_client)
    ...
    af_prnlt = 'af_prnlt_example' # str |  (optional)
    category = 'category_example' # str |  (optional)
    af_cat = 'af_cat_example' # str |  (optional)
    blt_acrs = 'blt_acrs_example' # str |  (optional)

    try:
        # Get features from Point locations of Canal infrastructures like aqueduct, viaduct, siphon, tunnel
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, af_prnlt=af_prnlt, category=category, af_cat=af_cat, blt_acrs=blt_acrs)
        print("The response of CanalInfrastructurePointLocationsInSirmaurApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CanalInfrastructurePointLocationsInSirmaurApi->get_features: %s\n" % e)
```
 ...
 **af_prnlt** | **str**|  | [optional] 
 **category** | **str**|  | [optional] 
 **af_cat** | **str**|  | [optional] 
 **blt_acrs** | **str**|  | [optional] 
...
Metadata about Point locations of Canal infrastructures like aqueduct, viaduct, siphon, tunnel
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CanalInfrastructurePointLocationsInSirmaurApi->get_specific_collection:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CanalInfrastructurePointLocationsInSirmaurApi->get_specific_collection: %s\n" % e)
```
...
Get single feature from Point locations of Canal infrastructures like aqueduct, viaduct, siphon, tunnel
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CanalInfrastructurePointLocationsInSirmaurApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CanalInfrastructurePointLocationsInSirmaurApi->get_specific_feature: %s\n" % e)
```
