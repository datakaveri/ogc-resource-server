# openapi_client.FuelStationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](FuelStationsVaranasiUPApi.md#get_features) | **GET** /collections/ec809c02-f12c-46d0-932b-93aaad0106cf/items | Get features from Point locations of fuel stations in Varanasi, UP
[**get_specific_collection**](FuelStationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/ec809c02-f12c-46d0-932b-93aaad0106cf | Metadata about Point locations of fuel stations in Varanasi, UP
[**get_specific_feature**](FuelStationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/ec809c02-f12c-46d0-932b-93aaad0106cf/items/{featureId} | Get single feature from Point locations of fuel stations in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, gas_avlt=gas_avlt)

Get features from Point locations of fuel stations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    gas_avlt = 'gas_avlt_example' # str |  (optional)

    try:
        # Get features from Point locations of fuel stations in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, gas_avlt=gas_avlt)
        print("The response of FuelStationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FuelStationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Point locations of fuel stations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FuelStationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FuelStationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
