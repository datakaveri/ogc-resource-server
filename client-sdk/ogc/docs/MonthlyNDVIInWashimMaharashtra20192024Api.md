# openapi_client.MonthlyNDVIInWashimMaharashtra20192024Api

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MonthlyNDVIInWashimMaharashtra20192024Api.md#get_features) | **GET** /collections/7d1fecb9-fff3-4e3a-829e-792d1de6cf9e/items | Get features from Village wise monthly NDVI data for Washim district, Maharashtra from 01-01-2019 to 31-09-2024
[**get_specific_collection**](MonthlyNDVIInWashimMaharashtra20192024Api.md#get_specific_collection) | **GET** /collections/7d1fecb9-fff3-4e3a-829e-792d1de6cf9e | Metadata about Village wise monthly NDVI data for Washim district, Maharashtra from 01-01-2019 to 31-09-2024
[**get_specific_feature**](MonthlyNDVIInWashimMaharashtra20192024Api.md#get_specific_feature) | **GET** /collections/7d1fecb9-fff3-4e3a-829e-792d1de6cf9e/items/{featureId} | Get single feature from Village wise monthly NDVI data for Washim district, Maharashtra from 01-01-2019 to 31-09-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, value_name=value_name, dates=dates, state=state, tehsil=tehsil, ndvi=ndvi)

Get features from Village wise monthly NDVI data for Washim district, Maharashtra from 01-01-2019 to 31-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Village wise monthly NDVI data for Washim district, Maharashtra from 01-01-2019 to 31-09-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, village=village, district=district, value_name=value_name, dates=dates, state=state, tehsil=tehsil, ndvi=ndvi)
        print("The response of MonthlyNDVIInWashimMaharashtra20192024Api->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInWashimMaharashtra20192024Api->get_features: %s\n" % e)
```
...
Get single feature from Village wise monthly NDVI data for Washim district, Maharashtra from 01-01-2019 to 31-09-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonthlyNDVIInWashimMaharashtra20192024Api->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInWashimMaharashtra20192024Api->get_specific_feature: %s\n" % e)
```
