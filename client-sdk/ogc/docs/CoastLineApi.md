# openapi_client.CoastLineApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](CoastLineApi.md#get_features) | **GET** /collections/1c4b81ea-fb76-453b-8350-27b0d60ac36d/items | Get features from Coast Line Data
[**get_specific_collection**](CoastLineApi.md#get_specific_collection) | **GET** /collections/1c4b81ea-fb76-453b-8350-27b0d60ac36d | Metadata about Coast Line Data
[**get_specific_feature**](CoastLineApi.md#get_specific_feature) | **GET** /collections/1c4b81ea-fb76-453b-8350-27b0d60ac36d/items/{featureId} | Get single feature from Coast Line Data


# **get_features**
> FeatureCollectionGeoJSON get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, entity=entity, fid_coast_=fid_coast_, level=level)

Get features from Coast Line Data
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    fid_coast_ = 56 # int |  (optional)
    level = 56 # int |  (optional)

    try:
        # Get features from Coast Line Data
        api_response = api_instance.get_features(token, bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, entity=entity, fid_coast_=fid_coast_, level=level)
        print("The response of CoastLineApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoastLineApi->get_features: %s\n" % e)
```
...
Get single feature from Coast Line Data
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of CoastLineApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoastLineApi->get_specific_feature: %s\n" % e)
```
