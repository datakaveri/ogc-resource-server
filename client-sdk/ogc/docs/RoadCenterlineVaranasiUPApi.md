# openapi_client.RoadCenterlineVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RoadCenterlineVaranasiUPApi.md#get_features) | **GET** /collections/a4395596-14e6-4e17-83c4-989bc23fb3d2/items | Get features from Centerline of roads with attributes in Varanasi, UP
[**get_specific_collection**](RoadCenterlineVaranasiUPApi.md#get_specific_collection) | **GET** /collections/a4395596-14e6-4e17-83c4-989bc23fb3d2 | Metadata about Centerline of roads with attributes in Varanasi, UP
[**get_specific_feature**](RoadCenterlineVaranasiUPApi.md#get_specific_feature) | **GET** /collections/a4395596-14e6-4e17-83c4-989bc23fb3d2/items/{featureId} | Get single feature from Centerline of roads with attributes in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, crrg_way=crrg_way, adl_info=adl_info, category=category, srfc_typ=srfc_typ, subcat=subcat, pavement=pavement, drectn=drectn, o_drectn=o_drectn, bult_on=bult_on, name=name)

Get features from Centerline of roads with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    drectn = 'drectn_example' # str |  (optional)
    o_drectn = 'o_drectn_example' # str |  (optional)
    bult_on = 'bult_on_example' # str |  (optional)
    name = 'name_example' # str |  (optional)

    try:
        # Get features from Centerline of roads with attributes in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, status=status, crrg_way=crrg_way, adl_info=adl_info, category=category, srfc_typ=srfc_typ, subcat=subcat, pavement=pavement, drectn=drectn, o_drectn=o_drectn, bult_on=bult_on, name=name)
        print("The response of RoadCenterlineVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadCenterlineVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Centerline of roads with attributes in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RoadCenterlineVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoadCenterlineVaranasiUPApi->get_specific_feature: %s\n" % e)
```
