# openapi_client.MonthlyNDVIInBengaluruApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](MonthlyNDVIInBengaluruApi.md#get_features) | **GET** /collections/970c8c59-cef8-46da-8bc4-39ac854d8f8b/items | Get features from Wardwise monthly Normalized Difference Vegetation Index (NDVI) data from 01-01-2018 to 30-04-2024
[**get_specific_collection**](MonthlyNDVIInBengaluruApi.md#get_specific_collection) | **GET** /collections/970c8c59-cef8-46da-8bc4-39ac854d8f8b | Metadata about Wardwise monthly Normalized Difference Vegetation Index (NDVI) data from 01-01-2018 to 30-04-2024
[**get_specific_feature**](MonthlyNDVIInBengaluruApi.md#get_specific_feature) | **GET** /collections/970c8c59-cef8-46da-8bc4-39ac854d8f8b/items/{featureId} | Get single feature from Wardwise monthly Normalized Difference Vegetation Index (NDVI) data from 01-01-2018 to 30-04-2024


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, value_name=value_name, dates=dates, ndvi=ndvi, kgis_ward_na=kgis_ward_na)

Get features from Wardwise monthly Normalized Difference Vegetation Index (NDVI) data from 01-01-2018 to 30-04-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Wardwise monthly Normalized Difference Vegetation Index (NDVI) data from 01-01-2018 to 30-04-2024
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, value_name=value_name, dates=dates, ndvi=ndvi, kgis_ward_na=kgis_ward_na)
        print("The response of MonthlyNDVIInBengaluruApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInBengaluruApi->get_features: %s\n" % e)
```
...
Get single feature from Wardwise monthly Normalized Difference Vegetation Index (NDVI) data from 01-01-2018 to 30-04-2024
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MonthlyNDVIInBengaluruApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MonthlyNDVIInBengaluruApi->get_specific_feature: %s\n" % e)
```
