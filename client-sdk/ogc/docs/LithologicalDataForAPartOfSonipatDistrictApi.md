...
------------- | ------------- | -------------
[**get_features**](LithologicalDataForAPartOfSonipatDistrictApi.md#get_features) | **GET** /collections/d129cc1b-c128-400c-a350-c831258e16e3/items | Get features from Polygon features representing lithological data for a part of Sonipat district, Haryana
[**get_specific_collection**](LithologicalDataForAPartOfSonipatDistrictApi.md#get_specific_collection) | **GET** /collections/d129cc1b-c128-400c-a350-c831258e16e3 | Metadata about Polygon features representing lithological data for a part of Sonipat district, Haryana
[**get_specific_feature**](LithologicalDataForAPartOfSonipatDistrictApi.md#get_specific_feature) | **GET** /collections/d129cc1b-c128-400c-a350-c831258e16e3/items/{featureId} | Get single feature from Polygon features representing lithological data for a part of Sonipat district, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling LithologicalDataForAPartOfSonipatDistrictApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features representing lithological data for a part of Sonipat district, Haryana
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of LithologicalDataForAPartOfSonipatDistrictApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling LithologicalDataForAPartOfSonipatDistrictApi->get_specific_feature: %s\n" % e)
```
