# openapi_client.RailwayKmStonesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RailwayKmStonesVaranasiUPApi.md#get_features) | **GET** /collections/d96288ee-acc7-44ef-a577-a20b9d24f8e2/items | Get features from Point locations of railway km stones in Varanasi, UP
[**get_specific_collection**](RailwayKmStonesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/d96288ee-acc7-44ef-a577-a20b9d24f8e2 | Metadata about Point locations of railway km stones in Varanasi, UP
[**get_specific_feature**](RailwayKmStonesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/d96288ee-acc7-44ef-a577-a20b9d24f8e2/items/{featureId} | Get single feature from Point locations of railway km stones in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, gaug_typ=gaug_typ, line_typ=line_typ, adl_info=adl_info, dist_km=dist_km)

Get features from Point locations of railway km stones in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    gaug_typ = 'gaug_typ_example' # str |  (optional)
    line_typ = 'line_typ_example' # str |  (optional)
    adl_info = 'adl_info_example' # str |  (optional)
    dist_km = 3.4 # float |  (optional)

    try:
        # Get features from Point locations of railway km stones in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, gaug_typ=gaug_typ, line_typ=line_typ, adl_info=adl_info, dist_km=dist_km)
        print("The response of RailwayKmStonesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayKmStonesVaranasiUPApi->get_features: %s\n" % e)
```
 ...
 **gaug_typ** | **str**|  | [optional] 
 **line_typ** | **str**|  | [optional] 
...
Get single feature from Point locations of railway km stones in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayKmStonesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayKmStonesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
