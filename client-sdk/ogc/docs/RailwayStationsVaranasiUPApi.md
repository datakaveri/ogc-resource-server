# openapi_client.RailwayStationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](RailwayStationsVaranasiUPApi.md#get_features) | **GET** /collections/504789bc-5357-45a9-a69e-986332249c6a/items | Get features from Locations of railway stations in Varanasi, UP
[**get_specific_collection**](RailwayStationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/504789bc-5357-45a9-a69e-986332249c6a | Metadata about Locations of railway stations in Varanasi, UP
[**get_specific_feature**](RailwayStationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/504789bc-5357-45a9-a69e-986332249c6a/items/{featureId} | Get single feature from Locations of railway stations in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, stn_name=stn_name, unique_id=unique_id)

Get features from Locations of railway stations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    stn_name = 'stn_name_example' # str |  (optional)
    unique_id = 'unique_id_example' # str |  (optional)

    try:
        # Get features from Locations of railway stations in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, stn_name=stn_name, unique_id=unique_id)
        print("The response of RailwayStationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayStationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of railway stations in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RailwayStationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RailwayStationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
