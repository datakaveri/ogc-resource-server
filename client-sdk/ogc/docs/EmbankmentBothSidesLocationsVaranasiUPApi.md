# openapi_client.EmbankmentBothSidesLocationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](EmbankmentBothSidesLocationsVaranasiUPApi.md#get_features) | **GET** /collections/c3b34f2a-9c62-4f4f-8e62-3e5d1e6e87a4/items | Get features from Geographic locations of areas with embankments on both sides in Varanasi, UP
[**get_specific_collection**](EmbankmentBothSidesLocationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/c3b34f2a-9c62-4f4f-8e62-3e5d1e6e87a4 | Metadata about Geographic locations of areas with embankments on both sides in Varanasi, UP
[**get_specific_feature**](EmbankmentBothSidesLocationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/c3b34f2a-9c62-4f4f-8e62-3e5d1e6e87a4/items/{featureId} | Get single feature from Geographic locations of areas with embankments on both sides in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, shape_leng=shape_leng, svy_date=svy_date, addl_info=addl_info, shape_le_1=shape_le_1, rel_ht_m=rel_ht_m, shape_length=shape_length, f_code=f_code, unique_id=unique_id, type=type, type1=type1, entity_on=entity_on)

Get features from Geographic locations of areas with embankments on both sides in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    rel_ht_m = 3.4 # float |  (optional)
    shape_length = 3.4 # float |  (optional)
    f_code = 'f_code_example' # str |  (optional)
    ...
    try:
        # Get features from Geographic locations of areas with embankments on both sides in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, shape_leng=shape_leng, svy_date=svy_date, addl_info=addl_info, shape_le_1=shape_le_1, rel_ht_m=rel_ht_m, shape_length=shape_length, f_code=f_code, unique_id=unique_id, type=type, type1=type1, entity_on=entity_on)
        print("The response of EmbankmentBothSidesLocationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentBothSidesLocationsVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Geographic locations of areas with embankments on both sides in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EmbankmentBothSidesLocationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmbankmentBothSidesLocationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
