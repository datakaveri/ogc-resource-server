# openapi_client.IrrigationCommandAreasVaranasiSelectedDistApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](IrrigationCommandAreasVaranasiSelectedDistApi.md#get_features) | **GET** /collections/4954579f-eae2-4680-82bd-6a2d997e7282/items | Get features from Polygon features of irrigation command areas in Varanasi and selected districts, Uttar Pradesh
[**get_specific_collection**](IrrigationCommandAreasVaranasiSelectedDistApi.md#get_specific_collection) | **GET** /collections/4954579f-eae2-4680-82bd-6a2d997e7282 | Metadata about Polygon features of irrigation command areas in Varanasi and selected districts, Uttar Pradesh
[**get_specific_feature**](IrrigationCommandAreasVaranasiSelectedDistApi.md#get_specific_feature) | **GET** /collections/4954579f-eae2-4680-82bd-6a2d997e7282/items/{featureId} | Get single feature from Polygon features of irrigation command areas in Varanasi and selected districts, Uttar Pradesh


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, prjcode=prjcode, cname=cname, dist_benf=dist_benf, state=state, type=type, cmdcode=cmdcode, status=status)

Get features from Polygon features of irrigation command areas in Varanasi and selected districts, Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Polygon features of irrigation command areas in Varanasi and selected districts, Uttar Pradesh
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, prjcode=prjcode, cname=cname, dist_benf=dist_benf, state=state, type=type, cmdcode=cmdcode, status=status)
        print("The response of IrrigationCommandAreasVaranasiSelectedDistApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IrrigationCommandAreasVaranasiSelectedDistApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon features of irrigation command areas in Varanasi and selected districts, Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IrrigationCommandAreasVaranasiSelectedDistApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IrrigationCommandAreasVaranasiSelectedDistApi->get_specific_feature: %s\n" % e)
```
