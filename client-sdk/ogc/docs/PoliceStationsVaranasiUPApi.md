# openapi_client.PoliceStationsVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](PoliceStationsVaranasiUPApi.md#get_features) | **GET** /collections/9edc5594-1ac6-4105-bdca-d27346f67a56/items | Get features from Locations of culverts in Varanasi, UP
[**get_specific_collection**](PoliceStationsVaranasiUPApi.md#get_specific_collection) | **GET** /collections/9edc5594-1ac6-4105-bdca-d27346f67a56 | Metadata about Locations of culverts in Varanasi, UP
[**get_specific_feature**](PoliceStationsVaranasiUPApi.md#get_specific_feature) | **GET** /collections/9edc5594-1ac6-4105-bdca-d27346f67a56/items/{featureId} | Get single feature from Locations of culverts in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, unique_id=unique_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Locations of culverts in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, type=type, unique_id=unique_id)
        print("The response of PoliceStationsVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PoliceStationsVaranasiUPApi->get_features: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PoliceStationsVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PoliceStationsVaranasiUPApi->get_specific_feature: %s\n" % e)
```
