# openapi_client.KoramangalaChallaghattaValleyBoundaryBangaloreApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](KoramangalaChallaghattaValleyBoundaryBangaloreApi.md#get_features) | **GET** /collections/2fdcf936-e973-43af-a238-8a0ac99500d2/items | Get features from Polygon boundary of Koramangala-Challaghatta Valley in Bangalore
[**get_specific_collection**](KoramangalaChallaghattaValleyBoundaryBangaloreApi.md#get_specific_collection) | **GET** /collections/2fdcf936-e973-43af-a238-8a0ac99500d2 | Metadata about Polygon boundary of Koramangala-Challaghatta Valley in Bangalore
[**get_specific_feature**](KoramangalaChallaghattaValleyBoundaryBangaloreApi.md#get_specific_feature) | **GET** /collections/2fdcf936-e973-43af-a238-8a0ac99500d2/items/{featureId} | Get single feature from Polygon boundary of Koramangala-Challaghatta Valley in Bangalore


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset)

Get features from Polygon boundary of Koramangala-Challaghatta Valley in Bangalore
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KoramangalaChallaghattaValleyBoundaryBangaloreApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KoramangalaChallaghattaValleyBoundaryBangaloreApi->get_features: %s\n" % e)
```
...
Get single feature from Polygon boundary of Koramangala-Challaghatta Valley in Bangalore
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of KoramangalaChallaghattaValleyBoundaryBangaloreApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KoramangalaChallaghattaValleyBoundaryBangaloreApi->get_specific_feature: %s\n" % e)
```
