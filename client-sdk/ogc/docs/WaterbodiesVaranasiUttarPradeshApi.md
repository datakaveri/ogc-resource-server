# openapi_client.WaterbodiesVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](WaterbodiesVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/992002d0-d9ef-46f4-83b2-70c559495994/items | Get features from Waterbodies in Varanasi district of Uttar Pradesh along with attributes
[**get_specific_collection**](WaterbodiesVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/992002d0-d9ef-46f4-83b2-70c559495994 | Metadata about Waterbodies in Varanasi district of Uttar Pradesh along with attributes
[**get_specific_feature**](WaterbodiesVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/992002d0-d9ef-46f4-83b2-70c559495994/items/{featureId} | Get single feature from Waterbodies in Varanasi district of Uttar Pradesh along with attributes


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, uqcode=uqcode, state=state)

Get features from Waterbodies in Varanasi district of Uttar Pradesh along with attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    uqcode = 'uqcode_example' # str |  (optional)
    state = 'state_example' # str |  (optional)

    try:
        # Get features from Waterbodies in Varanasi district of Uttar Pradesh along with attributes
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, uqcode=uqcode, state=state)
        print("The response of WaterbodiesVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodiesVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
...
Get single feature from Waterbodies in Varanasi district of Uttar Pradesh along with attributes
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of WaterbodiesVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WaterbodiesVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
