# openapi_client.BankBranchLocationsVaranasiUttarPradeshApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](BankBranchLocationsVaranasiUttarPradeshApi.md#get_features) | **GET** /collections/42a226b3-6ba9-4a92-aebc-1e8da7bf3c2f/items | Get features from Point features of bank branches in Varanasi District, Uttar Pradesh
[**get_specific_collection**](BankBranchLocationsVaranasiUttarPradeshApi.md#get_specific_collection) | **GET** /collections/42a226b3-6ba9-4a92-aebc-1e8da7bf3c2f | Metadata about Point features of bank branches in Varanasi District, Uttar Pradesh
[**get_specific_feature**](BankBranchLocationsVaranasiUttarPradeshApi.md#get_specific_feature) | **GET** /collections/42a226b3-6ba9-4a92-aebc-1e8da7bf3c2f/items/{featureId} | Get single feature from Point features of bank branches in Varanasi District, Uttar Pradesh
...
Get features from Point features of bank branches in Varanasi District, Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    br_ifsc_cd = 'br_ifsc_cd_example' # str |  (optional)
    br_name = 'br_name_example' # str |  (optional)
    district_n = 'district_n_example' # str |  (optional)
    ...
    try:
        ...
        print("The response of BankBranchLocationsVaranasiUttarPradeshApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BankBranchLocationsVaranasiUttarPradeshApi->get_features: %s\n" % e)
```
 ...
 **br_ifsc_cd** | **str**|  | [optional] 
 **br_name** | **str**|  | [optional] 
 **district_n** | **str**|  | [optional] 
...
Get single feature from Point features of bank branches in Varanasi District, Uttar Pradesh
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of BankBranchLocationsVaranasiUttarPradeshApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BankBranchLocationsVaranasiUttarPradeshApi->get_specific_feature: %s\n" % e)
```
