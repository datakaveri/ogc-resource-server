# openapi_client.DispensariesVaranasiUPApi

All URIs are relative to *https://geoserver.dx.ugix.org.in*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_features**](DispensariesVaranasiUPApi.md#get_features) | **GET** /collections/4bd031ef-e606-494d-9bef-8c3c90ab1ff7/items | Get features from Locations of dispensaries in Varanasi, UP
[**get_specific_collection**](DispensariesVaranasiUPApi.md#get_specific_collection) | **GET** /collections/4bd031ef-e606-494d-9bef-8c3c90ab1ff7 | Metadata about Locations of dispensaries in Varanasi, UP
[**get_specific_feature**](DispensariesVaranasiUPApi.md#get_specific_feature) | **GET** /collections/4bd031ef-e606-494d-9bef-8c3c90ab1ff7/items/{featureId} | Get single feature from Locations of dispensaries in Varanasi, UP


# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, unique_id=unique_id)

Get features from Locations of dispensaries in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from Locations of dispensaries in Varanasi, UP
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, unique_id=unique_id)
        print("The response of DispensariesVaranasiUPApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DispensariesVaranasiUPApi->get_features: %s\n" % e)
```
...
Get single feature from Locations of dispensaries in Varanasi, UP
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DispensariesVaranasiUPApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DispensariesVaranasiUPApi->get_specific_feature: %s\n" % e)
```
