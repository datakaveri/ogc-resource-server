...
------------- | ------------- | -------------
[**get_features**](RiceCultivatedAreasKamrupMetroDistrictApi.md#get_features) | **GET** /collections/692bf58e-24d3-41bd-93d9-67c5964801a1/items | Get features from Boundaries of areas with paddy cultivation during kharif season, Jun-Oct 2020
[**get_specific_collection**](RiceCultivatedAreasKamrupMetroDistrictApi.md#get_specific_collection) | **GET** /collections/692bf58e-24d3-41bd-93d9-67c5964801a1 | Metadata about Boundaries of areas with paddy cultivation during kharif season, Jun-Oct 2020
[**get_specific_feature**](RiceCultivatedAreasKamrupMetroDistrictApi.md#get_specific_feature) | **GET** /collections/692bf58e-24d3-41bd-93d9-67c5964801a1/items/{featureId} | Get single feature from Boundaries of areas with paddy cultivation during kharif season, Jun-Oct 2020
...
Get features from Boundaries of areas with paddy cultivation during kharif season, Jun-Oct 2020
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RiceCultivatedAreasKamrupMetroDistrictApi->get_features:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RiceCultivatedAreasKamrupMetroDistrictApi->get_features: %s\n" % e)
```
...
Get single feature from Boundaries of areas with paddy cultivation during kharif season, Jun-Oct 2020
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of RiceCultivatedAreasKamrupMetroDistrictApi->get_specific_feature:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RiceCultivatedAreasKamrupMetroDistrictApi->get_specific_feature: %s\n" % e)
```
