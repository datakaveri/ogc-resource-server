...
# **get_features**
> FeatureCollectionGeoJSON get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, nh_name=nh_name, descriptio=descriptio, level_=level_)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get features from National Roads and Highways
        api_response = api_instance.get_features(bbox_crs=bbox_crs, crs=crs, bbox=bbox, datetime=datetime, limit=limit, offset=offset, nh_name=nh_name, descriptio=descriptio, level_=level_)
