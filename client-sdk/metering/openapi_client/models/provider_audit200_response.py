...
class ProviderAudit200Response(BaseModel):
    """
    ProviderAudit200Response
    """ # noqa: E501
    type: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    results: Optional[List[Dict[str, Any]]] = Field(default=None, description="An array of objects")
    __properties: ClassVar[List[str]] = ["type", "title", "results"]
