...
public interface DummyService {
    ...
    @GenIgnore
    static DummyService createProxy(Vertx vertx, String address) {
        return new DummyServiceVertxEBProxy(vertx, address);
    }
...
Future<JsonObject> dummyTokenIntrospect(JsonObject request, JsonObject authenticationInfo);
}
