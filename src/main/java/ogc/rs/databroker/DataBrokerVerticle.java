...
public class DataBrokerVerticle extends AbstractVerticle {
  ...
  public void start() throws Exception {
    ...
    rabbitClient =
        new RabbitClient(vertx, iudxInternalRabbitMqClient, iudxRabbitMqClient);
    binder = new ServiceBinder(vertx);

    dataBrokerService =
        new DataBrokerServiceImpl(rabbitClient);

LOGGER.info("Databroker Verticle deployed successfully");
    consumer =
        binder
