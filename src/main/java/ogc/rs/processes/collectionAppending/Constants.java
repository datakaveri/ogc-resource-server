...
public class Constants {
    ...
    public static final String APPEND_PROCESS_COMPLETED_MESSAGE =
            "Merged temp table into collection table. Collection appending has been completed successfully.";
