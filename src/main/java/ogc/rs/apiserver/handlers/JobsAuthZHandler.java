...
public class JobsAuthZHandler implements Handler<RoutingContext> {
    private static final Logger LOGGER = LogManager.getLogger(JobsAuthZHandler.class);

    /**
     * Handles the routing context to authorize access to jobs APIs.
     *
     * @param routingContext the routing context of the request
     */
    @Override
    public void handle(RoutingContext routingContext) {
        LOGGER.debug("Jobs Authorization");
