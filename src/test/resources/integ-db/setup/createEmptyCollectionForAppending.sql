...
CREATE TABLE "61f2187e-affe-4f28-be0e-fe1cd37dbd4e" (postcode varchar, positional_quality_indicator integer, country_code varchar, nhs_regional_ha_code varchar, nhs_ha_code varchar, admin_county_code varchar, admin_district_code varchar, admin_ward_code varchar, geom geometry(Point, 4326));
